...
void test_StringsAndNumbersMatrices(const char *str, float number)
{
    ...
    static const char *expected[] = {
        "String1_-05.00",     "String1_+12.50",     "String,2_-05.00",  "String,2_+12.50",
        "String3_-05.00",     "String3_+12.50",     "String[4]_-05.00", "String[4]_+12.50",
        "String\"5\"_-05.00", "String\"5\"_+12.50",
    };
    char buf[200] = { 0 };
...
TEST_MATRIX([ENUM_A, ENUM_4, ENUM_C], [test_arr[0], 7.8f, test_arr[2]],
            ['a', 'f', '[', ']', '\'', '"'], )
void test_EnumCharAndArrayMatrices(test_enum_t e, float n, char c)
{
    ...
    static const test_enum_t exp_char[] = { 'a', 'f', '[', ']', '\'', '"' };
