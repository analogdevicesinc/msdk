...
LC3_HOT static inline void neon_fft_5(const struct lc3_complex *x, struct lc3_complex *y, int n)
{
    static const union {
        float f[2];
        uint64_t u64;
    } __cos1 = { { 0.3090169944, 0.3090169944 } }, __cos2 = { { -0.8090169944, -0.8090169944 } },
      __sin1 = { { 0.9510565163, -0.9510565163 } }, __sin2 = { { 0.5877852523, -0.5877852523 } };
...
LC3_HOT static inline void neon_fft_bf3(const struct lc3_fft_bf3_twiddles *twiddles,
                                        const struct lc3_complex *x, struct lc3_complex *y, int n)
{
    ...
    for (int j, i = 0; i < n; i++, y0_ptr += 3 * n3, y1_ptr += 3 * n3, y2_ptr += 3 * n3) {
        /* --- Process by pair --- */

        for (j = 0; j < (n3 >> 1); j++, x0_ptr += 2, x1_ptr += 2, x2_ptr += 2) {
...
LC3_HOT static inline void neon_fft_bf2(const struct lc3_fft_bf2_twiddles *twiddles,
                                        const struct lc3_complex *x, struct lc3_complex *y, int n)
{
    int n2 = twiddles->n2;
