...
static inline float fast_exp2f(float x)
{
    ...
    static const float c[] = { 1.27191277e-09, 1.47415221e-07, 1.35510312e-05, 9.38375815e-04,
                               4.33216946e-02 };
...
static inline float fast_log2f(float x)
{
    ...
    static const float c[] = { -1.29479677, 5.11769018, -8.42295281, 8.10557963, -3.50567360 };
