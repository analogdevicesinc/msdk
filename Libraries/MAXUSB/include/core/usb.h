...
// Clock setter mux APIs are currently only supported on the MAX32690 and MAX78002.  It does not exist
...
typedef enum { MXC_USB_CLOCK_0 = 0, MXC_USB_CLOCK_1 = 1, MXC_USB_CLOCK_2 = 2 } mxc_usb_clock_t;
#endif
