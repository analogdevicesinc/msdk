...
#define RDR_to_PC_DataRateAndClockFrequency_Len \
    RDR_to_PC_DataRateAndClockFrequency_dwDataRate_OFFSET + 4
...
#define RDR_to_PC_MAX_Message_Len \
    (PC_to_RDR_XfrBlock_abData_OFFSET + PC_to_RDR_XfrBlock_T0_T1_abData_MAX_LEN)
