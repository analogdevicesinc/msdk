...
typedef enum {
    ...
    MXC_SMON_EXTSENSOR_1 = MXC_F_SMON_EXTSCN_EXTS_EN1,
    MXC_SMON_EXTSENSOR_2 = MXC_F_SMON_EXTSCN_EXTS_EN2,
    MXC_SMON_EXTSENSOR_3 = MXC_F_SMON_EXTSCN_EXTS_EN3,
    MXC_SMON_EXTSENSOR_4 = MXC_F_SMON_EXTSCN_EXTS_EN4,
