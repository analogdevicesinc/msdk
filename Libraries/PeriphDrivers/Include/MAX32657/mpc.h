...
#define MXC_MPC_FLASH_REGION_BASE (MXC_FLASH_MEM_SIZE & ~(1 << 28))
#define MXC_MPC_FLASH_REGION_SIZE (MXC_FLASH_MEM_SIZE)
#define MXC_MPC_SRAM_REGION_BASE (MXC_FLASH_MEM_SIZE & ~(1 << 28))
#define MXC_MPC_FLASH_REGION_SIZE (MXC_FLASH_MEM_SIZE)
#define MXC_MPC_FLASH_REGION_BASE (MXC_FLASH_MEM_SIZE & ~(1 << 28))
#define MXC_MPC_FLASH_REGION_SIZE (MXC_FLASH_MEM_SIZE)
#define MXC_MPC_FLASH_REGION_BASE (MXC_FLASH_MEM_SIZE & ~(1 << 28))
