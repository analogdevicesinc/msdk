...
#ifndef LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32657_DMA_H_
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32657_DMA_H_
...
typedef enum {
    ...
    MXC_DMA_REQUEST_I3CRX_CONT = MXC_S_DMA_CTRL_REQUEST_I3CRX_CONT, ///< I3C Receive Controller DMA Request Selection
    MXC_DMA_REQUEST_I3CRX_TARG = MXC_S_DMA_CTRL_REQUEST_I3CRX_TARG, ///< I3C Receive Target DMA Request Selection
    ...
    MXC_DMA_REQUEST_I3CTX_CONT = MXC_S_DMA_CTRL_REQUEST_I3CTX_CONT, ///< I3C Transmit Controller DMA Request Selection
    MXC_DMA_REQUEST_I3CTX_TARG = MXC_S_DMA_CTRL_REQUEST_I3CTX_TARG, ///< I3C Transmit Target DMA Request Selection
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32657_DMA_H_
