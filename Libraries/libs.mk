...
PROJ_CFLAGS += -DM_SDK -D__arm_m3__ -D__me13
else ifeq ($(TARGET_SEC), MAX32570)
PROJ_CFLAGS += -DM_SDK -DLARGE_MEMORY -D__me13
else ifeq ($(TARGET_SEC), MAX32672)
PROJ_CFLAGS += -DM_SDK -DLARGE_MEMORY
else ifeq ($(TARGET_SEC), MAX32690)
PROJ_CFLAGS += -DM_SDK -DLARGE_MEMORY
else ifeq ($(TARGET_SEC), MAX32650)
PROJ_CFLAGS += -DLP_SDK -DLARGE_MEMORY -D__arm_m4__
else ifeq ($(TARGET_SEC), MAX32651)
PROJ_CFLAGS += -DLP_SDK -DLARGE_MEMORY -D__arm_m4__ -D__max32652
else ifeq ($(TARGET_SEC), MAX32665)
PROJ_CFLAGS += -DLP_SDK -DLARGE_MEMORY
