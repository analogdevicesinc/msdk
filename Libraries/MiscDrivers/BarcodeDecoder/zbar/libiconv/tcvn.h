...
static const unsigned int tcvn_comp_bases[] = { 0x06fdfbbe, 0x06fdfbbe, 0x00000000, 0x00000020,
                                                0x04780404, 0x04780404, 0x0000000c, 0x00000000,
                                                0x00000000, 0x00000300, 0x00000000, 0x00018003 };
...
static int tcvn_mbtowc(conv_t conv, ucs4_t *pwc, const unsigned char *s, size_t n)
{
    unsigned char c = *s;
    unsigned short wc;
