...
#endif // #if 0 static const struct table_entry alias_table[]
...
#if defined __OpenBSD__ || (defined __APPLE__ && defined __MACH__) || defined __sun || \
    defined __CYGWIN__
