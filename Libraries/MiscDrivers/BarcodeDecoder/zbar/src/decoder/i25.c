...
static inline unsigned char i25_decode1(unsigned char enc, unsigned e, unsigned s)
{
...
static inline unsigned char i25_decode10(zbar_decoder_t *dcode, unsigned char offset)
{
...
zbar_symbol_type_t _zbar_decode_i25(zbar_decoder_t *dcode)
{
    ...
    dbprintf(2, "      i25[%c%02d+%x]", (dcode25->direction) ? '<' : '>', dcode25->character,
             dcode25->element);
