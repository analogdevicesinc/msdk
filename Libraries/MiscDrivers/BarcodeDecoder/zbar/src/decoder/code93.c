...
static const signed char code93_hash[0x40] = {
    ...
    0x00, 0x26, 0x23, 0x00, -1,   0x2e, 0x3f, 0x13, 0x2e, 0x36, -1,   0x08, 0x09, -1,   0x15, 0x14,
    -1,   0x00, 0x21, 0x3b, -1,   0x33, 0x00, -1,   0x2d, 0x0c, 0x1b, 0x0a, 0x3f, 0x3f, 0x29, 0x1c,
};
...
static inline int decode6(zbar_decoder_t *dcode)
{
    ...
    zassert(g0 >= 0 && g1 >= 0, -1, "dir=%x sig=%03x g0=%03x g1=%03x %s\n", dcode->code93.direction,
            sig, g0, g1, _zbar_decoder_buf_dump(dcode->buf, dcode->code93.character));
...
zbar_symbol_type_t _zbar_decode_code93(zbar_decoder_t *dcode)
{
    ...
    dbprintf(2, "      code93[%c%02d+%x]:", (dcode93->direction) ? '<' : '>', dcode93->character,
             dcode93->element);
