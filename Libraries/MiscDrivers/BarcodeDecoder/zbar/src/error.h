...
static inline int err_capture(const void *container, errsev_t sev, zbar_error_t type,
...
static inline int err_capture_str(const void *container, errsev_t sev, zbar_error_t type,
                                  const char *func, const char *detail, const char *arg)
{
    errinfo_t *err = (errinfo_t *)container;
    assert(err->magic == ERRINFO_MAGIC);
    if (err->arg_str)
...
static inline int err_capture_int(const void *container, errsev_t sev, zbar_error_t type,
                                  const char *func, const char *detail, int arg)
{
    errinfo_t *err = (errinfo_t *)container;
    assert(err->magic == ERRINFO_MAGIC);
    err->arg_int = arg;
...
static inline int err_capture_num(const void *container, errsev_t sev, zbar_error_t type,
                                  const char *func, const char *detail, int num)
{
    errinfo_t *err = (errinfo_t *)container;
    assert(err->magic == ERRINFO_MAGIC);
    err->errnum = num;
