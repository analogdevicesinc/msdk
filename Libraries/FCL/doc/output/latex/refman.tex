...
\fancyhead[R]{\textbf{\textit{Deeptrust for P\+C\+I security architecture}}}
...
\label{_r_e_l_e_a_s_e__n_o_t_e_s}
\hypertarget{_r_e_l_e_a_s_e__n_o_t_e_s}{}
\input{_r_e_l_e_a_s_e__n_o_t_e_s}
\chapter{References}
\label{_r_e_f_e_r_e_n_c_e_s}
\hypertarget{_r_e_f_e_r_e_n_c_e_s}{}
...
\input{struct__msg__lcd}
\input{struct_certification_authorities}
\input{structdata}
\input{struct_m_e_m_s_e_c___h_a_n_d_l_e}
\input{struct_t_r_a_c_e__log__display}
\input{struct_tracehandlers_config}
\printindex
\end{document}