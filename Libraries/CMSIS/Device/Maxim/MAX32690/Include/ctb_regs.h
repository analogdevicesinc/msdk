...
#define MXC_V_CTB_CIPHER_CTRL_SRC_PUFKEY               ((uint32_t)0x3UL) /**< CIPHER_CTRL_SRC_PUFKEY Value */
#define MXC_S_CTB_CIPHER_CTRL_SRC_PUFKEY               (MXC_V_CTB_CIPHER_CTRL_SRC_PUFKEY << MXC_F_CTB_CIPHER_CTRL_SRC_POS) /**< CIPHER_CTRL_SRC_PUFKEY Setting */
...
#define MXC_F_CTB_CIPHER_CTRL_PUFKEYSEL                ((uint32_t)(0x1UL << MXC_F_CTB_CIPHER_CTRL_PUFKEYSEL_POS)) /**< CIPHER_CTRL_CCML Mask */
#define MXC_V_CTB_CIPHER_CTRL_PUFKEYS_KEY0             ((uint32_t)0x0UL) /**< CIPHER_CTRL_PUFKEYS_KEY0 Value */
#define MXC_S_CTB_CIPHER_CTRL_PUFKEYS_KEY0             (MXC_V_CTB_CIPHER_CTRL_PUFKEYS_KEY0 << MXC_F_CTB_CIPHER_CTRL_PUFKEYSEL_POS) /**< CIPHER_CTRL_PUFKEYS_KEY0 Setting */
#define MXC_V_CTB_CIPHER_CTRL_PUFKEYS_KEY1             ((uint32_t)0x1UL) /**< CIPHER_CTRL_PUFKEYS_KEY1 Value */
#define MXC_S_CTB_CIPHER_CTRL_PUFKEYS_KEY1             (MXC_V_CTB_CIPHER_CTRL_PUFKEYS_KEY1 << MXC_F_CTB_CIPHER_CTRL_PUFKEYSEL_POS) /**< CIPHER_CTRL_PUFKEYS_KEY0 Setting */
