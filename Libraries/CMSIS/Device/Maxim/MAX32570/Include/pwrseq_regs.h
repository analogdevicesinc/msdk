...
#define MXC_F_PWRSEQ_LPPWKFL_DRSEVT_POS                19 /**< LPPWKFL_DRSEVT Position */
#define MXC_F_PWRSEQ_LPPWKFL_DRSEVT                    ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPPWKFL_DRSEVT_POS)) /**< LPPWKFL_DRSEVT Mask */
