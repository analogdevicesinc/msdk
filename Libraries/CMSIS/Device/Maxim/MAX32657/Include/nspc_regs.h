...
#define MXC_V_NSPC_APBPRIV_PERIPH_GPIO0                ((uint32_t)0x40UL) /**< APBPRIV_PERIPH_GPIO0 Value */
...
#define MXC_V_NSPC_APBPRIV_PERIPH_CRC                  ((uint32_t)0x80UL) /**< APBPRIV_PERIPH_CRC Value */
...
#define MXC_V_NSPC_APBPRIV_PERIPH_BBFCR                ((uint32_t)0x800000UL) /**< APBPRIV_PERIPH_BBFCR Value */
#define MXC_S_NSPC_APBPRIV_PERIPH_BBFCR                (MXC_V_NSPC_APBPRIV_PERIPH_BBFCR << MXC_F_NSPC_APBPRIV_PERIPH_POS) /**< APBPRIV_PERIPH_BBFCR Setting */
...
#define MXC_V_NSPC_APBPRIV_PERIPH_ALL                  ((uint32_t)0x1FFFFFFFUL) /**< APBPRIV_PERIPH_ALL Value */
