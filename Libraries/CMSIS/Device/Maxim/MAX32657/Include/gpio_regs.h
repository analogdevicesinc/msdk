...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32657_INCLUDE_GPIO_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32657_INCLUDE_GPIO_REGS_H_
 ...
 * @brief    GPIO Wakeup Enable Register.
 * @{
 */
 ...
 * @brief    GPIO Wakeup Enable Atomic Set Register.
 * @{
 */
 ...
 * @brief    GPIO Wakeup Enable Atomic Clear Register.
 * @{
 */
...
#define MXC_V_GPIO_DUALEDGE_GPIO_DUALEDGE_DIS          ((uint32_t)0x0UL) /**< DUALEDGE_GPIO_DUALEDGE_DIS Value */
#define MXC_S_GPIO_DUALEDGE_GPIO_DUALEDGE_DIS          (MXC_V_GPIO_DUALEDGE_GPIO_DUALEDGE_DIS << MXC_F_GPIO_DUALEDGE_GPIO_DUALEDGE_POS) /**< DUALEDGE_GPIO_DUALEDGE_DIS Setting */
 ...
 * @brief    GPIO Port n Pad Control 0 Register. Each bit in this register enables the weak
 *           pull-up or weak pull-down for the associated GPIO pin in this port.
 * @{
 */
...
#define MXC_V_GPIO_PADCTRL0_GPIO_PADCTRL0_DIS          ((uint32_t)0x0UL) /**< PADCTRL0_GPIO_PADCTRL0_DIS Value */
#define MXC_S_GPIO_PADCTRL0_GPIO_PADCTRL0_DIS          (MXC_V_GPIO_PADCTRL0_GPIO_PADCTRL0_DIS << MXC_F_GPIO_PADCTRL0_GPIO_PADCTRL0_POS) /**< PADCTRL0_GPIO_PADCTRL0_DIS Setting */
#define MXC_V_GPIO_PADCTRL0_GPIO_PADCTRL0_EN           ((uint32_t)0x1UL) /**< PADCTRL0_GPIO_PADCTRL0_EN Value */
#define MXC_S_GPIO_PADCTRL0_GPIO_PADCTRL0_EN           (MXC_V_GPIO_PADCTRL0_GPIO_PADCTRL0_EN << MXC_F_GPIO_PADCTRL0_GPIO_PADCTRL0_POS) /**< PADCTRL0_GPIO_PADCTRL0_EN Setting */
 ...
 * @brief    GPIO Port n Pad Control 1 Register. Each bit in this register enables the weak pull-up for
 ...
 * @brief    GPIO Port n Configuration Enable Bit 1 Register. Each bit in this register
 *           selects between primary/secondary functions for the associated GPIO pin in this
 *           port.
 * @{
 */
...
#define MXC_V_GPIO_HYSEN_GPIO_HYSEN_DIS                ((uint32_t)0x0UL) /**< HYSEN_GPIO_HYSEN_DIS Value */
#define MXC_S_GPIO_HYSEN_GPIO_HYSEN_DIS                (MXC_V_GPIO_HYSEN_GPIO_HYSEN_DIS << MXC_F_GPIO_HYSEN_GPIO_HYSEN_POS) /**< HYSEN_GPIO_HYSEN_DIS Setting */
#define MXC_V_GPIO_HYSEN_GPIO_HYSEN_EN                 ((uint32_t)0x0UL) /**< HYSEN_GPIO_HYSEN_EN Value */
#define MXC_S_GPIO_HYSEN_GPIO_HYSEN_EN                 (MXC_V_GPIO_HYSEN_GPIO_HYSEN_EN << MXC_F_GPIO_HYSEN_GPIO_HYSEN_POS) /**< HYSEN_GPIO_HYSEN_EN Setting */
 ...
 * @brief    GPIO Drive Strength Register. The mode selection is set using the combination
 *           of the GPIOn_DS1 and GPIOn_DS0 bits for the associated GPIO pin. See the GPIO
 *           Drive Strength section for the selection options on these I/O pins.
 * @{
 */
 ...
 * @brief    GPIO Drive Strength 1 Register. The mode selection is set using the combination
 *           of the GPIOn_DS1 and GPIOn_DS0 bits for the associated GPIO pin. See the GPIO
 *           Drive Strength section for the selection options on these I/O pins.
 * @{
 */
 ...
 * @brief    GPIO Pulldown/Pullup Strength Select Register.
 * @{
 */
...
#define MXC_V_GPIO_PS_ALL_PD                           ((uint32_t)0x0UL) /**< PS_ALL_PD Value */
#define MXC_S_GPIO_PS_ALL_PD                           (MXC_V_GPIO_PS_ALL_PD << MXC_F_GPIO_PS_ALL_POS) /**< PS_ALL_PD Setting */
#define MXC_V_GPIO_PS_ALL_PU                           ((uint32_t)0x1UL) /**< PS_ALL_PU Value */
#define MXC_S_GPIO_PS_ALL_PU                           (MXC_V_GPIO_PS_ALL_PU << MXC_F_GPIO_PS_ALL_POS) /**< PS_ALL_PU Setting */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32657_INCLUDE_GPIO_REGS_H_
