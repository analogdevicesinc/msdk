...
#define MXC_V_UART_CTRL_BCLKSRC_CLK0                   ((uint32_t)0x0UL) /**< CTRL_BCLKSRC_CLK0 Value */
#define MXC_S_UART_CTRL_BCLKSRC_CLK0                   (MXC_V_UART_CTRL_BCLKSRC_CLK0 << MXC_F_UART_CTRL_BCLKSRC_POS) /**< CTRL_BCLKSRC_CLK0 Setting */
...
#define MXC_V_UART_OSR_OSR_128                         ((uint32_t)0x0UL) /**< OSR_OSR_128 Value */
#define MXC_S_UART_OSR_OSR_128                         (MXC_V_UART_OSR_OSR_128 << MXC_F_UART_OSR_OSR_POS) /**< OSR_OSR_128 Setting */
#define MXC_V_UART_OSR_OSR_64                          ((uint32_t)0x1UL) /**< OSR_OSR_64 Value */
#define MXC_S_UART_OSR_OSR_64                          (MXC_V_UART_OSR_OSR_64 << MXC_F_UART_OSR_OSR_POS) /**< OSR_OSR_64 Setting */
#define MXC_V_UART_OSR_OSR_32                          ((uint32_t)0x2UL) /**< OSR_OSR_32 Value */
#define MXC_S_UART_OSR_OSR_32                          (MXC_V_UART_OSR_OSR_32 << MXC_F_UART_OSR_OSR_POS) /**< OSR_OSR_32 Setting */
#define MXC_V_UART_OSR_OSR_16                          ((uint32_t)0x3UL) /**< OSR_OSR_16 Value */
#define MXC_S_UART_OSR_OSR_16                          (MXC_V_UART_OSR_OSR_16 << MXC_F_UART_OSR_OSR_POS) /**< OSR_OSR_16 Setting */
#define MXC_V_UART_OSR_OSR_8                           ((uint32_t)0x4UL) /**< OSR_OSR_8 Value */
#define MXC_S_UART_OSR_OSR_8                           (MXC_V_UART_OSR_OSR_8 << MXC_F_UART_OSR_OSR_POS) /**< OSR_OSR_8 Setting */
#define MXC_V_UART_OSR_OSR_4                           ((uint32_t)0x5UL) /**< OSR_OSR_4 Value */
#define MXC_S_UART_OSR_OSR_4                           (MXC_V_UART_OSR_OSR_4 << MXC_F_UART_OSR_OSR_POS) /**< OSR_OSR_4 Setting */
