...
#define MXC_V_SPC_APBSEC_PERIPH_GPIO0                  ((uint32_t)0x40UL) /**< APBSEC_PERIPH_GPIO0 Value */
...
#define MXC_V_SPC_APBSEC_PERIPH_CRC                    ((uint32_t)0x80UL) /**< APBSEC_PERIPH_CRC Value */
...
#define MXC_V_SPC_APBSEC_PERIPH_BBFCR                  ((uint32_t)0x800000UL) /**< APBSEC_PERIPH_BBFCR Value */
#define MXC_S_SPC_APBSEC_PERIPH_BBFCR                  (MXC_V_SPC_APBSEC_PERIPH_BBFCR << MXC_F_SPC_APBSEC_PERIPH_POS) /**< APBSEC_PERIPH_BBFCR Setting */
...
#define MXC_V_SPC_APBSEC_PERIPH_ALL                    ((uint32_t)0x1FFFFFFFUL) /**< APBSEC_PERIPH_ALL Value */
...
#define MXC_V_SPC_APBPRIV_PERIPH_GPIO0                 ((uint32_t)0x40UL) /**< APBPRIV_PERIPH_GPIO0 Value */
...
#define MXC_V_SPC_APBPRIV_PERIPH_CRC                   ((uint32_t)0x80UL) /**< APBPRIV_PERIPH_CRC Value */
...
#define MXC_V_SPC_APBPRIV_PERIPH_BBFCR                 ((uint32_t)0x800000UL) /**< APBPRIV_PERIPH_BBFCR Value */
#define MXC_S_SPC_APBPRIV_PERIPH_BBFCR                 (MXC_V_SPC_APBPRIV_PERIPH_BBFCR << MXC_F_SPC_APBPRIV_PERIPH_POS) /**< APBPRIV_PERIPH_BBFCR Setting */
...
#define MXC_V_SPC_APBPRIV_PERIPH_ALL                   ((uint32_t)0x1FFFFFFFUL) /**< APBPRIV_PERIPH_ALL Value */
