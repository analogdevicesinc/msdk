 ...
 */
void arm_absmin_f16(
    const float16_t* pSrc, uint32_t blockSize, float16_t* pResult, uint32_t* pIndex);
...
float16_t arm_logsumexp_dot_prod_f16(
    const float16_t* pSrcA, const float16_t* pSrcB, uint32_t blockSize, float16_t* pTmpBuffer);
...
float16_t arm_kullback_leibler_f16(
    const float16_t* pSrcA, const float16_t* pSrcB, uint32_t blockSize);
...
void arm_mse_f16(
    const float16_t* pSrcA, const float16_t* pSrcB, uint32_t blockSize, float16_t* pResult);
