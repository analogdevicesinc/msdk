...
void arm_cmplx_mult_real_q15(
    const q15_t* pSrcCmplx, const q15_t* pSrcReal, q15_t* pCmplxDst, uint32_t numSamples);
...
void arm_cmplx_mult_real_q31(
    const q31_t* pSrcCmplx, const q31_t* pSrcReal, q31_t* pCmplxDst, uint32_t numSamples);
...
void arm_cmplx_mult_cmplx_q15(
    const q15_t* pSrcA, const q15_t* pSrcB, q15_t* pDst, uint32_t numSamples);
...
void arm_cmplx_mult_cmplx_q31(
    const q31_t* pSrcA, const q31_t* pSrcB, q31_t* pDst, uint32_t numSamples);
...
void arm_cmplx_mult_cmplx_f32(
    const float32_t* pSrcA, const float32_t* pSrcB, float32_t* pDst, uint32_t numSamples);
...
void arm_cmplx_mult_cmplx_f64(
    const float64_t* pSrcA, const float64_t* pSrcB, float64_t* pDst, uint32_t numSamples);
