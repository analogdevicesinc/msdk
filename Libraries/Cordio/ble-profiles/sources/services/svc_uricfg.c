...
static const uint8_t uriCfgValLockChr[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(URICFG_HANDLE_LOCK),
...
static const uint8_t uriCfgValUnlockChr[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(URICFG_HANDLE_UNLOCK),
...
static uint8_t uriCfgValUriData[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t uriCfgValAdvertisedTxPwrLevelsChr[] = {
    ATT_PROP_READ | ATT_PROP_WRITE, UINT16_TO_BYTES(URICFG_HANDLE_TXPWRLEVELS),
...
static const uint8_t uriCfgUuidAdvertisedTxPwrLevels[] = { URICFG_UUID_BYTES(
    URICFG_UUID_CHR_TXPWRLEVELS) };
...
static const uint16_t uriCfgLenAdvertisedTxPwrLevelsChrUsrDescr =
    sizeof(uriCfgValAdvertisedTxPwrLevelsChrUsrDescr) - 1u;
...
static const uint8_t uriCfgValBeaconPeriodChr[] = {
    ATT_PROP_READ | ATT_PROP_WRITE, UINT16_TO_BYTES(URICFG_HANDLE_BEACONPERIOD),
...
static const uint16_t uriCfgLenBeaconPeriodChrUsrDescr =
    sizeof(uriCfgValBeaconPeriodChrUsrDescr) - 1u;

/* Beacon reset characteristic */
static const uint8_t uriCfgValResetChr[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(URICFG_HANDLE_RESET),
...
static const attsAttr_t uriCfgList[] = {
    /* Service declaration */
    { attPrimSvcUuid, (uint8_t *)uriCfgValSvc, (uint16_t *)&uriCfgLenSvc, sizeof(uriCfgValSvc), 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValLockStateChr, (uint16_t *)&uriCfgLenLockStateChr,
      sizeof(uriCfgValLockStateChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidLockState, (uint8_t *)uriCfgValLockState, (uint16_t *)&uriCfgLenLockState,
      sizeof(uriCfgValLockState), 0, ATTS_PERMIT_READ },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValLockStateChrUsrDescr,
      (uint16_t *)&uriCfgLenLockStateChrUsrDescr, sizeof(uriCfgValLockStateChrUsrDescr) - 1, 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValLockChr, (uint16_t *)&uriCfgLenLockChr,
      sizeof(uriCfgValLockChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidLock, (uint8_t *)uriCfgValLock, (uint16_t *)&uriCfgLenLock, sizeof(uriCfgValLock),
      ATTS_SET_WRITE_CBACK, ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValLockChrUsrDescr, (uint16_t *)&uriCfgLenLockChrUsrDescr,
      sizeof(uriCfgValLockChrUsrDescr) - 1, 0, ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValUnlockChr, (uint16_t *)&uriCfgLenUnlockChr,
      sizeof(uriCfgValUnlockChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidUnlock, (uint8_t *)uriCfgValUnlock, (uint16_t *)&uriCfgLenUnlock,
      sizeof(uriCfgValUnlock), ATTS_SET_WRITE_CBACK, ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValUnlockChrUsrDescr,
      (uint16_t *)&uriCfgLenUnlockChrUsrDescr, sizeof(uriCfgValUnlockChrUsrDescr) - 1, 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValUriDataChr, (uint16_t *)&uriCfgLenUriDataChr,
      sizeof(uriCfgValUriDataChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidUriData, (uint8_t *)uriCfgValUriData, (uint16_t *)&uriCfgLenUriData,
      sizeof(uriCfgValUriData), ATTS_SET_WRITE_CBACK | ATTS_SET_VARIABLE_LEN,
      ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValUriDataChrUsrDescr,
      (uint16_t *)&uriCfgLenUriDataChrUsrDescr, sizeof(uriCfgValUriDataChrUsrDescr) - 1, 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValUriFlagsChr, (uint16_t *)&uriCfgLenUriFlagsChr,
      sizeof(uriCfgValUriFlagsChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidUriFlags, (uint8_t *)uriCfgValUriFlags, (uint16_t *)&uriCfgLenUriFlags,
      sizeof(uriCfgValUriFlags), ATTS_SET_WRITE_CBACK, ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValUriFlagsChrUsrDescr,
      (uint16_t *)&uriCfgLenUriFlagsChrUsrDescr, sizeof(uriCfgValUriFlagsChrUsrDescr) - 1, 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValAdvertisedTxPwrLevelsChr,
      (uint16_t *)&uriCfgLenAdvertisedTxPwrLevelsChr, sizeof(uriCfgValAdvertisedTxPwrLevelsChr), 0,
      ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidAdvertisedTxPwrLevels, (uint8_t *)uriCfgValAdvertisedTxPwrLevels,
      (uint16_t *)&uriCfgLenAdvertisedTxPwrLevels, sizeof(uriCfgValAdvertisedTxPwrLevels),
      ATTS_SET_WRITE_CBACK, ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValAdvertisedTxPwrLevelsChrUsrDescr,
      (uint16_t *)&uriCfgLenAdvertisedTxPwrLevelsChrUsrDescr,
      sizeof(uriCfgValAdvertisedTxPwrLevelsChrUsrDescr) - 1, 0, ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValTxPwrModeChr, (uint16_t *)&uriCfgLenTxPwrModeChr,
      sizeof(uriCfgValTxPwrModeChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidTxPwrMode, (uint8_t *)uriCfgValTxPwrMode, (uint16_t *)&uriCfgLenTxPwrMode,
      sizeof(uriCfgValTxPwrMode), ATTS_SET_WRITE_CBACK, ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValTxPwrModeChrUsrDescr,
      (uint16_t *)&uriCfgLenTxPwrModeChrUsrDescr, sizeof(uriCfgValTxPwrModeChrUsrDescr) - 1, 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValBeaconPeriodChr, (uint16_t *)&uriCfgLenBeaconPeriodChr,
      sizeof(uriCfgValBeaconPeriodChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidBeaconPeriod, (uint8_t *)uriCfgValBeaconPeriod, (uint16_t *)&uriCfgLenBeaconPeriod,
      sizeof(uriCfgValBeaconPeriod), ATTS_SET_WRITE_CBACK, ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValBeaconPeriodChrUsrDescr,
      (uint16_t *)&uriCfgLenBeaconPeriodChrUsrDescr, sizeof(uriCfgValBeaconPeriodChrUsrDescr) - 1,
      0, ATTS_PERMIT_READ },
    /* Characteristic declaration */
    { attChUuid, (uint8_t *)uriCfgValResetChr, (uint16_t *)&uriCfgLenResetChr,
      sizeof(uriCfgValResetChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value */
    { uriCfgUuidReset, (uint8_t *)uriCfgValReset, (uint16_t *)&uriCfgLenReset,
      sizeof(uriCfgValReset), ATTS_SET_WRITE_CBACK, ATTS_PERMIT_WRITE },
    /* Characteristic user description */
    { attChUserDescUuid, (uint8_t *)uriCfgValResetChrUsrDescr,
      (uint16_t *)&uriCfgLenResetChrUsrDescr, sizeof(uriCfgValResetChrUsrDescr) - 1, 0,
      ATTS_PERMIT_READ },
};

/* UriCfg group structure */
static attsGroup_t uriCfgGroup = { NULL, (attsAttr_t *)uriCfgList, NULL,
                                   NULL, URICFG_HANDLE_START,      URICFG_HANDLE_END };
