...
#define CPP_WRDS_FEATURE_BIT \
    (1 << 2) /*!< \brief Wheel Revolution Data Supported Feature Mask Bit */
#define CPP_CRDS_FEATURE_BIT \
    (1 << 3) /*!< \brief Crank Revolution Data Supported Feature Mask Bit */
...
#define CPP_TABDSAS_FEATURE_BIT \
    (1 << 6) /*!< \brief Top and Bottom Dead Spot Angles Supported Feature Mask Bit */
#define CPP_AES_FEATURE_BIT (1 << 7) /*!< \brief Accumulated Energy Supported Feature Mask Bit */
#define CPP_OCIS_FEATURE_BIT \
    (1 << 8) /*!< \brief Offset Compensation Indicator Supported Feature Mask Bit */
#define CPP_OCS_FEATURE_BIT (1 << 9) /*!< \brief Offset Compensation Supported Feature Mask Bit */
#define CPP_CPMCCM_FEATURE_BIT \
    (1                         \
     << 10) /*!< \brief Cycling Power Measurement Characteristic Content Masking Supported  Offset Compensation Supported  Feature Mask Bit */
#define CPP_MSLS_FEATURE_BIT \
    (1 << 11) /*!< \brief Multiple Sensor Locations Supported Feature Mask Bit */
#define CPP_CLAS_FEATURE_BIT \
    (1 << 12) /*!< \brief Crank Length Adjustment Supported Feature Mask Bit */
#define CPP_CHLAS_FEATURE_BIT \
    (1 << 13) /*!< \brief Chain Length Adjustment Supported Feature Mask Bit */
#define CPP_CHWAS_FEATURE_BIT \
    (1 << 14) /*!< \brief Chain Weight Adjustment Supported Feature Mask Bit */
#define CPP_SLAS_FEATURE_BIT \
    (1 << 15) /*!< \brief Span Length Adjustment Supported Feature Mask Bit */
...
#define CPP_FCDS_FEATURE_BIT \
    (1 << 18) /*!< \brief Factory Calibration Date Supported Feature Mask Bit */
#define CPP_EOCS_FEATURE_BIT \
    (1 << 19) /*!< \brief Enhanced Offset Compensation Supported Feature Mask Bit */
