...
#define GLS_SEC_PERMIT_WRITE_AUTH \
...
static const uint8_t glsValGlmCh[] = { ATT_PROP_NOTIFY, UINT16_TO_BYTES(GLS_GLM_HDL),
                                       UINT16_TO_BYTES(ATT_UUID_GLUCOSE_MEAS) };
...
static const uint8_t glsValGlmcCh[] = { ATT_PROP_NOTIFY, UINT16_TO_BYTES(GLS_GLMC_HDL),
                                        UINT16_TO_BYTES(ATT_UUID_GLUCOSE_MEAS_CONTEXT) };
...
static const uint8_t glsValGlfCh[] = { ATT_PROP_READ, UINT16_TO_BYTES(GLS_GLF_HDL),
                                       UINT16_TO_BYTES(ATT_UUID_GLUCOSE_FEATURE) };
...
static const uint8_t glsValRacpCh[] = { (ATT_PROP_INDICATE | ATT_PROP_WRITE),
                                        UINT16_TO_BYTES(GLS_RACP_HDL),
...
static const attsAttr_t glsList[] = {
    /* Service declaration */
    { attPrimSvcUuid, (uint8_t *)glsValSvc, (uint16_t *)&glsLenSvc, sizeof(glsValSvc), 0,
      ATTS_PERMIT_READ },
    /* Glucose measurement characteristic declaration */
    { attChUuid, (uint8_t *)glsValGlmCh, (uint16_t *)&glsLenGlmCh, sizeof(glsValGlmCh), 0,
      ATTS_PERMIT_READ },
    /* Characteristic value */
    { attGlmChUuid, (uint8_t *)glsValGlm, (uint16_t *)&glsLenGlm, sizeof(glsValGlm), 0, 0 },
    /* Client characteristic configuration descriptor */
    { attCliChCfgUuid, (uint8_t *)glsValGlmChCcc, (uint16_t *)&glsLenGlmChCcc,
      sizeof(glsValGlmChCcc), ATTS_SET_CCC, (ATTS_PERMIT_READ | GLS_SEC_PERMIT_WRITE) },
    /* Glucose measurement context characteristic declaration */
    { attChUuid, (uint8_t *)glsValGlmcCh, (uint16_t *)&glsLenGlmcCh, sizeof(glsValGlmcCh), 0,
      ATTS_PERMIT_READ },
    /* Characteristic value */
    { attGlmcChUuid, (uint8_t *)glsValGlmc, (uint16_t *)&glsLenGlmc, sizeof(glsValGlmc), 0, 0 },
    /* Client characteristic configuration descriptor */
    { attCliChCfgUuid, (uint8_t *)glsValGlmcChCcc, (uint16_t *)&glsLenGlmcChCcc,
      sizeof(glsValGlmcChCcc), ATTS_SET_CCC, (ATTS_PERMIT_READ | GLS_SEC_PERMIT_WRITE) },
    /* Glucose feature characteristic declaration */
    { attChUuid, (uint8_t *)glsValGlfCh, (uint16_t *)&glsLenGlfCh, sizeof(glsValGlfCh), 0,
      ATTS_PERMIT_READ },
    /* Characteristic value */
    { attGlfChUuid, glsValGlf, (uint16_t *)&glsLenGlf, sizeof(glsValGlf), 0, GLS_SEC_PERMIT_READ },
    /* Record access control point characteristic delclaration */
    { attChUuid, (uint8_t *)glsValRacpCh, (uint16_t *)&glsLenRacpCh, sizeof(glsValRacpCh), 0,
      ATTS_PERMIT_READ },
    /* Characteristic value */
    { attRacpChUuid, (uint8_t *)glsValRacp, (uint16_t *)&glsLenRacp, ATT_DEFAULT_PAYLOAD_LEN,
      (ATTS_SET_VARIABLE_LEN | ATTS_SET_WRITE_CBACK), GLS_SEC_PERMIT_WRITE_AUTH },
    /* Client characteristic configuration descriptor */
    { attCliChCfgUuid, (uint8_t *)glsValRacpChCcc, (uint16_t *)&glsLenRacpChCcc,
      sizeof(glsValRacpChCcc), ATTS_SET_CCC, (ATTS_PERMIT_READ | GLS_SEC_PERMIT_WRITE) },
};

/* GLS group structure */
static attsGroup_t svcGlsGroup = { NULL, (attsAttr_t *)glsList, NULL,
                                   NULL, GLS_START_HDL,         GLS_END_HDL };
