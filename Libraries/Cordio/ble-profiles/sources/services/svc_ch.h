...
#define CH_HRM_FLAGS_SENSOR_NOT_DET \
    0x04 /*!< \brief Sensor Contact feature is supported, but contact is not detected */
#define CH_HRM_FLAGS_SENSOR_DET \
    0x06 /*!< \brief Sensor Contact feature is supported and contact is detected */
...
#define CH_ALERT_CAT_ID_ALERT \
    8 /*!< \brief High Prioritized Alert: Alert that should be handled as high priority */
 ...
 */
/**@{*/
#define CH_ALERT_CAT_MASK_SIMPLE \
    0x0001 /*!< \brief Simple Alert: General text alert or non-text alert */
...
#define CH_ALERT_CAT_MASK_ALERT \
    0x0100 /*!< \brief High Prioritized Alert: Alert that should be handled as high priority */
#define CH_ALERT_CAT_MASK_IM \
    0x0200 /*!< \brief Instant Message: Alert for incoming instant messages */
/**@}*/
...
#define CH_GLM_FLAG_CONC_TYPE_LOC \
    0x02 /*!< \brief Glucose Concentration, Type, and Sample Location Present */
...
#define CH_GLM_STATUS_SENSOR_FAULT \
    0x0002 /*!< \brief Sensor malfunction or faulting at time of measurement */
#define CH_GLM_STATUS_SAMPLE_SIZE \
    0x0004 /*!< \brief Sample size for blood or control solution insufficient at time of measurement */
...
#define CH_GLM_STATUS_RESULT_HIGH \
    0x0020 /*!< \brief Sensor result higher than the device can process */
#define CH_GLM_STATUS_RESULT_LOW \
    0x0040 /*!< \brief Sensor result lower than the device can process */
#define CH_GLM_STATUS_TEMP_HIGH \
    0x0080 /*!< \brief Sensor temperature too high for valid test/result at time of measurement */
#define CH_GLM_STATUS_TEMP_LOW \
    0x0100 /*!< \brief Sensor temperature too low for valid test/result at time of measurement */
#define CH_GLM_STATUS_STRIP_PULL \
    0x0200 /*!< \brief Sensor read interrupted because strip was pulled too soon at time of measurement */
#define CH_GLM_STATUS_GENERAL_FAULT \
    0x0400 /*!< \brief General device fault has occurred in the sensor */
#define CH_GLM_STATUS_TIME_FAULT \
    0x0800 /*!< \brief Time fault has occurred in the sensor and time may be inaccurate */
/**@}*/
...
#define CH_GLM_CONC_TYPE_LOC_LEN \
    3 /*!< \brief Glucose measurement concentration type location length. */
...
#define CH_GLMC_CARB_LEN \
    3 /*!< \brief Glucose measurement context carbohydrate ID a d carbohydrate length. */
...
#define CH_GLMC_EXERCISE_LEN \
    3 /*!< \brief Glucose measurement context exercise duration and exercise intensity length. */
 ...
 */
/**@{*/
#define CH_PLXSC_TIMESTAMP_LEN \
    7 /*!< \brief Pulse oximiter spot check measurement timestamp length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_PLXC_SPO2PR_FAST_LEN \
    2 /*!< \brief Pulse oximiter continuous measurement SPO2PR fast length. */
#define CH_PLXC_SPO2PR_SLOW_LEN \
    2 /*!< \brief Pulse oximiter continuous measurement SPO2PR slow length. */
/**@}*/
...
#define CH_PLXF_MEASUREMENT_SUPPORT_LEN \
    2 /*!< \brief Pulse oximeter measurement suppported length. */
/**@}*/
...
#define CH_PLF_FLAG_SENSOR_STATUS_SUP \
    0x02 /*!< \brief Device and Sensor Status support is present */
#define CH_PLF_FLAG_SPOT_CHECK_STORAGE_SUP \
    0x04 /*!< \brief Measurement Storage for Spot-check measurements is supported */
#define CH_PLF_FLAG_SPOT_CHECK_SUP \
    0x08 /*!< \brief Timestamp for Spot-check measurements is supported */
