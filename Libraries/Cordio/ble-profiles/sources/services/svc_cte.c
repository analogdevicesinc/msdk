...
static const uint8_t cteValEnableCh[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(CTE_ENABLE_HDL),
                                          UINT16_TO_BYTES(ATT_UUID_CTE_ENABLE) };
...
static const uint8_t cteValMinLenCh[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(CTE_MIN_LEN_HDL),
                                          UINT16_TO_BYTES(ATT_UUID_CTE_MIN_LEN) };
...
static const uint8_t cteValMinTxCntCh[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(CTE_ADV_MIN_TX_CNT_HDL),
                                            UINT16_TO_BYTES(ATT_UUID_CTE_TX_CNT) };
...
static const uint8_t cteValTxDurCh[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(CTE_ADV_TX_DURATION_HDL),
                                         UINT16_TO_BYTES(ATT_UUID_CTE_TX_DURATION) };
...
static const uint8_t cteValIntervalCh[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(CTE_ADV_INTERVAL_HDL),
                                            UINT16_TO_BYTES(ATT_UUID_CTE_INTERVAL) };
...
static const uint8_t cteValPhyCh[] = { ATT_PROP_WRITE, UINT16_TO_BYTES(CTE_ADV_EXT_PHY_HDL),
                                       UINT16_TO_BYTES(ATT_UUID_CTE_PHY) };
...
static const attsAttr_t cteList[] = {
    /* Constant Tone Extension service declaration. */
    { attPrimSvcUuid, (uint8_t *)cteValSvc, (uint16_t *)&cteLenSvc, sizeof(cteValSvc), 0,
      ATTS_PERMIT_READ },
    { attChUuid, (uint8_t *)cteValEnableCh, (uint16_t *)&cteLenEnableCh, sizeof(cteValEnableCh), 0,
      ATTS_PERMIT_READ },
    { attCteEnChUuid, (uint8_t *)cteValEnable, (uint16_t *)&cteLenEnable, sizeof(cteValEnable),
      ATTS_SET_WRITE_CBACK, SVC_SEC_PERMIT_WRITE },
    { attChUuid, (uint8_t *)cteValMinLenCh, (uint16_t *)&cteLenMinLenCh, sizeof(cteValMinLenCh), 0,
      ATTS_PERMIT_READ },
    { attCteMinLenChUuid, (uint8_t *)cteValMinLen, (uint16_t *)&cteLenMinLen, sizeof(cteValMinLen),
      ATTS_SET_WRITE_CBACK, SVC_SEC_PERMIT_WRITE },
    { attChUuid, (uint8_t *)cteValMinTxCntCh, (uint16_t *)&cteLenMinTxCntCh,
      sizeof(cteValMinTxCntCh), 0, ATTS_PERMIT_READ },
    { attCteTxCntChUuid, (uint8_t *)cteValMinTxCnt, (uint16_t *)&cteLenMinTxCnt,
      sizeof(cteValMinTxCnt), ATTS_SET_WRITE_CBACK, SVC_SEC_PERMIT_WRITE },
    { attChUuid, (uint8_t *)cteValTxDurCh, (uint16_t *)&cteLenTxDurCh, sizeof(cteValTxDurCh), 0,
      ATTS_PERMIT_READ },
    { attCteTxDurChUuid, (uint8_t *)cteValTxDur, (uint16_t *)&cteLenTxDur, sizeof(cteValTxDur),
      ATTS_SET_WRITE_CBACK, SVC_SEC_PERMIT_WRITE },
    { attChUuid, (uint8_t *)cteValIntervalCh, (uint16_t *)&cteLenIntervalCh,
      sizeof(cteValIntervalCh), 0, ATTS_PERMIT_READ },
    { attCteIntChUuid, (uint8_t *)cteValInterval, (uint16_t *)&cteLenInterval,
      sizeof(cteValInterval), ATTS_SET_WRITE_CBACK, SVC_SEC_PERMIT_WRITE },
    { attChUuid, (uint8_t *)cteValPhyCh, (uint16_t *)&cteLenPhyCh, sizeof(cteValPhyCh), 0,
      ATTS_PERMIT_READ },
    { attCtePhyChUuid, (uint8_t *)cteValPhy, (uint16_t *)&cteLenPhy, sizeof(cteValPhy),
      ATTS_SET_WRITE_CBACK, SVC_SEC_PERMIT_WRITE },
};

/*! CTE group structure. */
static attsGroup_t svcCteGroup = { NULL, (attsAttr_t *)cteList, NULL,
                                   NULL, CTE_START_HDL,         CTE_END_HDL };
