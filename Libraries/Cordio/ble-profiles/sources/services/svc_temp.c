...
static const attsAttr_t tempList[] = {
    /* Service declaration. */
    { attPrimSvcUuid, (uint8_t *)tempValSvc, (uint16_t *)&tempLenSvc, sizeof(tempValSvc), 0,
      ATTS_PERMIT_READ },
    /* Characteristic declaration. */
    { attChUuid, (uint8_t *)tempValDataChr, (uint16_t *)&tempLenDataChr, sizeof(tempValDataChr), 0,
      ATTS_PERMIT_READ },
    /* Characteristic value. */
    { tempUuidData, (uint8_t *)tempValData, (uint16_t *)&tempLenData, sizeof(tempValData), 0,
      ATTS_PERMIT_READ },
    /* Client characteristic configuration. */
    { attCliChCfgUuid, (uint8_t *)tempValDataClientChrConfig,
      (uint16_t *)&tempLenDataClientChrConfig, sizeof(tempValDataClientChrConfig), ATTS_SET_CCC,
      ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description. */
    { attChUserDescUuid, (uint8_t *)tempValDataChrUsrDescr, (uint16_t *)&tempLenDataChrUsrDescr,
      sizeof(tempValDataChrUsrDescr) - 1, 0, ATTS_PERMIT_READ },
    /* Characteristic declaration. */
    { attChUuid, (uint8_t *)tempValConfigChr, (uint16_t *)&tempLenConfigChr,
      sizeof(tempValConfigChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value. */
    { tempUuidConfig, (uint8_t *)tempValConfig, (uint16_t *)&tempLenConfig, sizeof(tempValConfig),
      ATTS_SET_WRITE_CBACK, ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description. */
    { attChUserDescUuid, (uint8_t *)tempValConfigChrUsrDescr, (uint16_t *)&tempLenConfigChrUsrDescr,
      sizeof(tempValConfigChrUsrDescr), 0, ATTS_PERMIT_READ },
    /* Characteristic declaration. */
    { attChUuid, (uint8_t *)tempValPeriodChr, (uint16_t *)&tempLenPeriodChr,
      sizeof(tempValPeriodChr), 0, ATTS_PERMIT_READ },
    /* Characteristic value. */
    { tempUuidPeriod, (uint8_t *)tempValPeriod, (uint16_t *)&tempLenPeriod, sizeof(tempValPeriod),
      ATTS_SET_WRITE_CBACK, ATTS_PERMIT_READ | ATTS_PERMIT_WRITE },
    /* Characteristic user description. */
    { attChUserDescUuid, (uint8_t *)tempValPeriodChrUsrDescr, (uint16_t *)&tempLenPeriodChrUsrDescr,
      sizeof(tempValPeriodChrUsrDescr), 0, ATTS_PERMIT_READ }
};

/* Gyro group structure. */
static attsGroup_t tempGroup = { NULL, (attsAttr_t *)tempList, NULL,
                                 NULL, TEMP_HANDLE_START,      TEMP_HANDLE_END };
