...
static const uint8_t hidInfoCh[] = { ATT_PROP_READ, UINT16_TO_BYTES(HID_INFO_HDL),
                                     UINT16_TO_BYTES(ATT_UUID_HID_INFORMATION) };
...
static const uint8_t hidRmCh[] = { ATT_PROP_READ, UINT16_TO_BYTES(HID_REPORT_MAP_HDL),
                                   UINT16_TO_BYTES(ATT_UUID_HID_REPORT_MAP) };
...
static const uint8_t hidCpCh[] = { ATT_PROP_WRITE_NO_RSP, UINT16_TO_BYTES(HID_CONTROL_POINT_HDL),
                                   UINT16_TO_BYTES(ATT_UUID_HID_CONTROL_POINT) };
...
static const uint8_t hidBkiCh[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
...
static const uint8_t hidBkoCh[] = { ATT_PROP_READ | ATT_PROP_WRITE | ATT_PROP_WRITE_NO_RSP,
...
static const uint8_t hidBmiCh[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
                                    UINT16_TO_BYTES(HID_MOUSE_BOOT_IN_HDL),
                                    UINT16_TO_BYTES(ATT_UUID_HID_BOOT_MOUSE_IN) };
...
static const uint8_t hidIRep1Ch[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
...
static const uint8_t hidIRep2Ch[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
...
static const uint8_t hidIRep3Ch[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
                                      UINT16_TO_BYTES(HID_INPUT_REPORT_3_HDL),
                                      UINT16_TO_BYTES(ATT_UUID_HID_REPORT) };
...
static const uint8_t hidORepCh[] = { ATT_PROP_READ | ATT_PROP_WRITE | ATT_PROP_WRITE_NO_RSP,
                                     UINT16_TO_BYTES(HID_OUTPUT_REPORT_HDL),
                                     UINT16_TO_BYTES(ATT_UUID_HID_REPORT) };
...
static const uint8_t hidFRepCh[] = { ATT_PROP_READ | ATT_PROP_WRITE,
                                     UINT16_TO_BYTES(HID_FEATURE_REPORT_HDL),
                                     UINT16_TO_BYTES(ATT_UUID_HID_REPORT) };
...
static const uint8_t hidPmCh[] = { ATT_PROP_READ | ATT_PROP_WRITE_NO_RSP,
...
static const attsAttr_t hidList[] = {
    /* Service Delcaration */
    { attPrimSvcUuid, (uint8_t *)hidValSvc, (uint16_t *)&hidLenSvc, sizeof(hidValSvc), 0,
      ATTS_PERMIT_READ },

    { attChUuid, (uint8_t *)hidInfoCh, (uint16_t *)&hidLenInfoCh, sizeof(hidInfoCh), 0,
      ATTS_PERMIT_READ },
    { attHidiChUuid, (uint8_t *)hidInfoVal, (uint16_t *)&hidLenInfoVal, sizeof(hidInfoVal), 0,
      HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidRmCh, (uint16_t *)&hidLenRmCh, sizeof(hidRmCh), 0,
      ATTS_PERMIT_READ },
    { attHidRmChUuid, (uint8_t *)hidReportMap, (uint16_t *)&hidReportMapLen, HID_MAX_REPORT_MAP_LEN,
      ATTS_SET_VARIABLE_LEN, HID_SEC_PERMIT_READ },
    { attHidErmUuid, (uint8_t *)hidExtReport, (uint16_t *)&hidLenExtReport, sizeof(hidExtReport), 0,
      HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidCpCh, (uint16_t *)&hidLenCpCh, sizeof(hidCpCh), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidCpVal, (uint16_t *)&hidLenCpVal, sizeof(hidCpVal),
      ATTS_SET_WRITE_CBACK, HID_SEC_PERMIT_WRITE },

    { attChUuid, (uint8_t *)hidBkiCh, (uint16_t *)&hidLenBkiCh, sizeof(hidBkiCh), 0,
      ATTS_PERMIT_READ },
    { attHidBkiChUuid, (uint8_t *)hidBkiVal, (uint16_t *)&hidLenBkiVal, sizeof(hidBkiVal),
      ATTS_SET_VARIABLE_LEN, HID_SEC_PERMIT_READ },
    { attCliChCfgUuid, (uint8_t *)hidValBkiChCcc, (uint16_t *)&hidLenBkiChCcc,
      sizeof(hidValBkiChCcc), ATTS_SET_CCC, (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },

    { attChUuid, (uint8_t *)hidBkoCh, (uint16_t *)&hidLenBkoCh, sizeof(hidBkoCh), 0,
      ATTS_PERMIT_READ },
    { attHidBkoChUuid, (uint8_t *)hidBkoVal, (uint16_t *)&hidLenBkoVal, sizeof(hidBkoVal),
      (ATTS_SET_WRITE_CBACK | ATTS_SET_VARIABLE_LEN),
      (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },

    { attChUuid, (uint8_t *)hidBmiCh, (uint16_t *)&hidLenBmiCh, sizeof(hidBmiCh), 0,
      ATTS_PERMIT_READ },
    { attHidBmiChUuid, (uint8_t *)hidBmiVal, (uint16_t *)&hidLenBmiVal, sizeof(hidBmiVal),
      ATTS_SET_VARIABLE_LEN, HID_SEC_PERMIT_READ },
    { attCliChCfgUuid, (uint8_t *)hidValBmiChCcc, (uint16_t *)&hidLenBmiChCcc,
      sizeof(hidValBmiChCcc), ATTS_SET_CCC, (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },

    { attChUuid, (uint8_t *)hidIRep1Ch, (uint16_t *)&hidLenIRep1Ch, sizeof(hidIRep1Ch), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidIRep1Val, (uint16_t *)&hidLenIRep1Val, sizeof(hidIRep1Val),
      ATTS_SET_VARIABLE_LEN, HID_SEC_PERMIT_READ },
    { attCliChCfgUuid, (uint8_t *)hidValIRep1ChCcc, (uint16_t *)&hidLenIRep1ChCcc,
      sizeof(hidValIRep1ChCcc), ATTS_SET_CCC, (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },
    { attHidRimUuid, (uint8_t *)hidValIRep1IdMap, (uint16_t *)&hidLenIRep1IdMap,
      sizeof(hidValIRep1IdMap), 0, HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidIRep2Ch, (uint16_t *)&hidLenIRep2Ch, sizeof(hidIRep2Ch), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidIRep2Val, (uint16_t *)&hidLenIRep2Val, sizeof(hidIRep2Val),
      ATTS_SET_VARIABLE_LEN, HID_SEC_PERMIT_READ },
    { attCliChCfgUuid, (uint8_t *)hidValIRep2ChCcc, (uint16_t *)&hidLenIRep2ChCcc,
      sizeof(hidValIRep2ChCcc), ATTS_SET_CCC, (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },
    { attHidRimUuid, (uint8_t *)hidValIRep2IdMap, (uint16_t *)&hidLenIRep2IdMap,
      sizeof(hidValIRep2IdMap), 0, HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidIRep3Ch, (uint16_t *)&hidLenIRep3Ch, sizeof(hidIRep3Ch), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidIRep3Val, (uint16_t *)&hidLenIRep3Val, sizeof(hidIRep3Val),
      ATTS_SET_VARIABLE_LEN, HID_SEC_PERMIT_READ },
    { attCliChCfgUuid, (uint8_t *)hidValIRep3ChCcc, (uint16_t *)&hidLenIRep3ChCcc,
      sizeof(hidValIRep3ChCcc), ATTS_SET_CCC, (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },
    { attHidRimUuid, (uint8_t *)hidValIRep3IdMap, (uint16_t *)&hidLenIRep3IdMap,
      sizeof(hidValIRep3IdMap), 0, HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidORepCh, (uint16_t *)&hidLenORepCh, sizeof(hidORepCh), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidORepVal, (uint16_t *)&hidLenORepVal, sizeof(hidORepVal),
      (ATTS_SET_WRITE_CBACK | ATTS_SET_VARIABLE_LEN),
      (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },
    { attHidRimUuid, (uint8_t *)hidValORepIdMap, (uint16_t *)&hidLenORepIdMap,
      sizeof(hidValORepIdMap), 0, HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidFRepCh, (uint16_t *)&hidLenFRepCh, sizeof(hidFRepCh), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidFRepVal, (uint16_t *)&hidLenFRepVal, sizeof(hidFRepVal),
      (ATTS_SET_WRITE_CBACK | ATTS_SET_VARIABLE_LEN),
      (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) },
    { attHidRimUuid, (uint8_t *)hidValFRepIdMap, (uint16_t *)&hidLenFRepIdMap,
      sizeof(hidValFRepIdMap), 0, HID_SEC_PERMIT_READ },

    { attChUuid, (uint8_t *)hidPmCh, (uint16_t *)&hidLenPmCh, sizeof(hidPmCh), 0,
      ATTS_PERMIT_READ },
    { attHidRepChUuid, (uint8_t *)hidPmVal, (uint16_t *)&hidLenPmVal, sizeof(hidPmVal),
      ATTS_SET_WRITE_CBACK, (HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE) }
};

/* HID group structure */
static attsGroup_t svcHidkbGroup = { NULL, (attsAttr_t *)hidList, NULL,
                                     NULL, HID_START_HDL,         HID_END_HDL };
...
void *SvcHidAddGroupDyn()
{
    ...
    if (pSHdl != NULL) {
        /* Primary service */
        AttsDynAddAttrConst(pSHdl, attPrimSvcUuid, hidValSvc, sizeof(hidValSvc), 0,
                            ATTS_PERMIT_READ);

        /* HID Info */
        AttsDynAddAttrConst(pSHdl, attChUuid, hidInfoCh, sizeof(hidInfoCh), 0, ATTS_PERMIT_READ);
        AttsDynAddAttrConst(pSHdl, attHidiChUuid, hidInfoVal, sizeof(hidInfoVal), 0,
                            HID_SEC_PERMIT_READ);

        /* HID Report Map */
        AttsDynAddAttrConst(pSHdl, attChUuid, hidRmCh, sizeof(hidRmCh), 0, ATTS_PERMIT_READ);
        AttsDynAddAttrConst(pSHdl, attHidRmChUuid, hidReportMap, hidReportMapLen, 0,
                            HID_SEC_PERMIT_READ);

        /* HID External Report Reference */
        AttsDynAddAttrConst(pSHdl, attHidErmUuid, hidExtReport, sizeof(hidExtReport), 0,
                            HID_SEC_PERMIT_READ);

        /* HID Control Point */
        AttsDynAddAttrConst(pSHdl, attChUuid, hidCpCh, sizeof(hidCpCh), 0, ATTS_PERMIT_READ);
        AttsDynAddAttr(pSHdl, attHidRepChUuid, NULL, 1, 1, ATTS_SET_WRITE_CBACK,
        ...
        AttsDynAddAttr(pSHdl, attCliChCfgUuid, initCcc, sizeof(uint16_t), sizeof(uint16_t),
                       ATTS_SET_CCC, HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE);
        AttsDynAddAttrConst(pSHdl, attHidRimUuid, hidValIRep1IdMap, sizeof(hidValIRep1IdMap), 0,
                            HID_SEC_PERMIT_READ);
        ...
        AttsDynAddAttr(pSHdl, attCliChCfgUuid, initCcc, sizeof(uint16_t), sizeof(uint16_t),
                       ATTS_SET_CCC, HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE);
        AttsDynAddAttrConst(pSHdl, attHidRimUuid, hidValIRep2IdMap, sizeof(hidValIRep2IdMap), 0,
                            HID_SEC_PERMIT_READ);
        ...
        AttsDynAddAttr(pSHdl, attCliChCfgUuid, initCcc, sizeof(uint16_t), sizeof(uint16_t),
                       ATTS_SET_CCC, HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE);
        AttsDynAddAttrConst(pSHdl, attHidRimUuid, hidValIRep3IdMap, sizeof(hidValIRep3IdMap), 0,
                            HID_SEC_PERMIT_READ);
        ...
        AttsDynAddAttr(pSHdl, attHidRepChUuid, NULL, HID_MAX_REPORT_LEN, HID_MAX_REPORT_LEN,
                       ATTS_SET_WRITE_CBACK | ATTS_SET_VARIABLE_LEN,
                       HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE);
        AttsDynAddAttrConst(pSHdl, attHidRimUuid, hidValORepIdMap, sizeof(hidValORepIdMap), 0,
                            HID_SEC_PERMIT_READ);
        ...
        AttsDynAddAttr(pSHdl, attHidRepChUuid, NULL, HID_MAX_REPORT_LEN, HID_MAX_REPORT_LEN,
                       ATTS_SET_WRITE_CBACK | ATTS_SET_VARIABLE_LEN,
                       HID_SEC_PERMIT_READ | HID_SEC_PERMIT_WRITE);
        AttsDynAddAttrConst(pSHdl, attHidRimUuid, hidValFRepIdMap, sizeof(hidValFRepIdMap), 0,
                            HID_SEC_PERMIT_READ);
