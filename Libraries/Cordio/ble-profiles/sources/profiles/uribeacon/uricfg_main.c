                                      ...
                                      attsAttr_t *pAttr)
{
    ...
    case URICFG_HANDLE_RESET: {
        ...
        if (resetValue != 0) {
            ...
            if (uriCfgAttWriteCback != NULL) {
                uriCfgAttWriteCback(URICFG_HANDLE_URIDATA, sizeof(uriCfgDataResetValue),
                                    uriCfgDataResetValue);
            }
            ...
            if (uriCfgAttWriteCback != NULL) {
                uriCfgAttWriteCback(URICFG_HANDLE_BEACONPERIOD, sizeof(beaconPeriod),
