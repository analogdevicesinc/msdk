...
static const attcDiscChar_t disMfns = { attMfnsChUuid, 0 };

/*! Model number string */
static const attcDiscChar_t disMns = { attMnsChUuid, 0 };

/*! Serial number string */
static const attcDiscChar_t disSns = { attSnsChUuid, 0 };

/*! Hardware revision string */
static const attcDiscChar_t disHrs = { attHrsChUuid, 0 };

/*! Firmware revision string */
static const attcDiscChar_t disFrs = { attFrsChUuid, 0 };

/*! Software revision string */
static const attcDiscChar_t disSrs = { attSrsChUuid, 0 };

/*! System ID */
static const attcDiscChar_t disSid = { attSidChUuid, 0 };

/*! IEEE 11073-20601 regulatory certificate data  */
static const attcDiscChar_t disRcd = { attIeeeChUuid, 0 };

/*! PnP ID */
static const attcDiscChar_t disPnpId = { attPnpChUuid, 0 };
...
{
    AppDiscFindService(connId, ATT_16_UUID_LEN, (uint8_t *)attDisSvcUuid, DIS_HDL_LIST_LEN,
                       (attcDiscChar_t **)disDiscCharList, pHdlList);
}
