...
static glpsRec_t glpsDb[GLPS_DB_NUM_RECORDS] = {
    /* record 1 */
    {
        ...
        /* context */
        {
            CH_GLMC_FLAG_CARB | CH_GLMC_FLAG_MEAL | /* Flags */
                CH_GLMC_FLAG_TESTER | CH_GLMC_FLAG_EXERCISE | CH_GLMC_FLAG_MED |
                CH_GLMC_FLAG_MED_KG | CH_GLMC_FLAG_HBA1C,
            0x0001, /* Sequence number */
            0, /* Extended Flags */
    ...
    /* record 2 */
    {
        ...
        /* context */
        {
            CH_GLMC_FLAG_CARB | CH_GLMC_FLAG_MEAL | /* Flags */
                CH_GLMC_FLAG_TESTER | CH_GLMC_FLAG_EXERCISE | CH_GLMC_FLAG_MED |
                CH_GLMC_FLAG_MED_L | CH_GLMC_FLAG_HBA1C,
            0x0002, /* Sequence number */
            0, /* Extended Flags */
    ...
    /* record 3 */
    {
        ...
        /* context */
        {
            CH_GLMC_FLAG_TESTER | CH_GLMC_FLAG_EXERCISE | /* Flags */
                CH_GLMC_FLAG_MED | CH_GLMC_FLAG_MED_L | CH_GLMC_FLAG_HBA1C,
            0x0003, /* Sequence number */
            0, /* Extended Flags */
            0, /* Carbohydrate ID */
...
uint8_t glpsDbGetNumRecords(uint8_t oper, uint8_t *pFilter, uint8_t *pNumRec)
{
    ...
    *pNumRec = 0;
    while ((status = glpsDbGetNextRecord(oper, pFilter, pCurrRec, &pCurrRec)) ==
           CH_RACP_RSP_SUCCESS) {
        (*pNumRec)++;
    }
