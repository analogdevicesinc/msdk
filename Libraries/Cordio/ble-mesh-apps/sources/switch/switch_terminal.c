        ...
        if (((argc < 4) && (cmd != SWITCH_TERMINAL_MMDL_GET)) ||
            ...
            for (uint8_t i = 2; i < argc; i++) {
                if (strstr(argv[i], "elemid=") != NULL) {
                    ...
                    if (elementId >= SWITCH_ELEMENT_COUNT) {
                        TerminalTxPrint("genlvl_cnf invalid_value %s" TERMINAL_STRING_NEW_LINE,
                                        argv[i]);
                    ...
                    TerminalTxPrint("genlvl_cnf invalid_argument %s" TERMINAL_STRING_NEW_LINE,
                                    argv[i]);
        ...
        if (((argc < 4) && (cmd != SWITCH_TERMINAL_MMDL_GET)) ||
            ...
            for (uint8_t i = 2; i < argc; i++) {
                if (strstr(argv[i], "elemid=") != NULL) {
                    ...
                    if (elementId >= SWITCH_ELEMENT_COUNT) {
                        TerminalTxPrint("genonpowup_cnf invalid_value %s" TERMINAL_STRING_NEW_LINE,
                                        argv[i]);
                    ...
                    TerminalTxPrint("genonpowup_cnf invalid_argument %s" TERMINAL_STRING_NEW_LINE,
                                    argv[i]);
        ...
        if (((argc < 4) && (cmd != SWITCH_TERMINAL_MMDL_GET)) ||
            ...
            for (uint8_t i = 2; i < argc; i++) {
                if (strstr(argv[i], "elemid=") != NULL) {
                    ...
                    if (elementId >= SWITCH_ELEMENT_COUNT) {
                        TerminalTxPrint("lighth_cnf invalid_value %s" TERMINAL_STRING_NEW_LINE,
                                        argv[i]);
                    ...
                    TerminalTxPrint("lighth_cnf invalid_argument %s" TERMINAL_STRING_NEW_LINE,
                                    argv[i]);
        ...
        if (((argc < 4) && (cmd != SWITCH_TERMINAL_MMDL_GET)) ||
            ...
            for (uint8_t i = 2; i < argc; i++) {
                if (strstr(argv[i], "elemid=") != NULL) {
                    ...
                    if (elementId >= SWITCH_ELEMENT_COUNT) {
                        TerminalTxPrint("lights_cnf invalid_value %s" TERMINAL_STRING_NEW_LINE,
                                        argv[i]);
                    ...
                    TerminalTxPrint("lights_cnf invalid_argument %s" TERMINAL_STRING_NEW_LINE,
                                    argv[i]);
        ...
        if (((argc < 4) && (cmd != SWITCH_TERMINAL_MMDL_GET)) ||
            ...
            for (uint8_t i = 2; i < argc; i++) {
                if (strstr(argv[i], "elemid=") != NULL) {
                    ...
                    if (elementId >= SWITCH_ELEMENT_COUNT) {
                        TerminalTxPrint("lightl_cnf invalid_value %s" TERMINAL_STRING_NEW_LINE,
                                        argv[i]);
                    ...
                    TerminalTxPrint("lightl_cnf invalid_argument %s" TERMINAL_STRING_NEW_LINE,
                                    argv[i]);
...
static uint8_t switchTerminalLpnHandler(uint32_t argc, char **argv)
{
    ...
    if (argc < 2) {
        ...
        if (((argc < 9) && (est == TRUE)) || ((argc < 3) && (term == TRUE))) {
            ...
            for (i = 2; i < argc; i++) {
                if (strstr(argv[i], "nidx=") != NULL) {
                    ...
                    criteria.recvWinFactor =
                        (meshFriendshipRecvWinFactor_t)strtol(pChar + 1, NULL, 0);
                } else if (strstr(argv[i], "minqszlog=") != NULL) {
                    /* Found MinQueueSize Log field. */
                    pChar = strchr(argv[i], '=');

                    criteria.minQueueSizeLog =
                        (meshFriendshipMinQueueSizeLog_t)strtol(pChar + 1, NULL, 0);
                    ...
                    TerminalTxPrint("lpn_cnf invalid_argument %s" TERMINAL_STRING_NEW_LINE,
                                    argv[i]);
        ...
        if (est == TRUE) {
            if (MeshLpnEstablishFriendship(netKeyIndex, &criteria, sleepDurationMs, recvDelayMs,
                                           retryCount) == FALSE) {
                TerminalTxPrint("lpn_cnf est_failed nidx=0x%x" TERMINAL_STRING_NEW_LINE,
                                netKeyIndex);
