...
static uint8_t provisionerPrvClNetKey[MESH_KEY_SIZE_128] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05,
...
static meshPrvOobPublicKey_t provisionerPrvClPeerOobPublicKey = {
    provisionerPrvClPeerOobPublicKeyX, provisionerPrvClPeerOobPublicKeyY
};
