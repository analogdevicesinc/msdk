...
/*! Parameter location */
#define MESH_PRV_PDU_PARAM_INDEX (MESH_PRV_PDU_OPCODE_INDEX + MESH_PRV_PDU_OPCODE_SIZE)
...
#define MESH_PRV_PDU_INVITE_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_INVITE_PARAM_SIZE)
...
#define MESH_PRV_PDU_CAPAB_ALGORITHMS_INDEX \
    (MESH_PRV_PDU_CAPAB_NUM_ELEM_INDEX + MESH_PRV_PDU_CAPAB_NUM_ELEM_SIZE)
...
#define MESH_PRV_PDU_CAPAB_PUB_KEY_TYPE_INDEX \
    (MESH_PRV_PDU_CAPAB_ALGORITHMS_INDEX + MESH_PRV_PDU_CAPAB_ALGORITHMS_SIZE)
...
#define MESH_PRV_PDU_CAPAB_STATIC_OOB_INDEX \
    (MESH_PRV_PDU_CAPAB_PUB_KEY_TYPE_INDEX + MESH_PRV_PDU_CAPAB_PUB_KEY_TYPE_SIZE)
...
#define MESH_PRV_PDU_CAPAB_OUT_OOB_SIZE_INDEX \
    (MESH_PRV_PDU_CAPAB_STATIC_OOB_INDEX + MESH_PRV_PDU_CAPAB_STATIC_OOB_SIZE)
...
#define MESH_PRV_PDU_CAPAB_OUT_OOB_ACT_INDEX \
    (MESH_PRV_PDU_CAPAB_OUT_OOB_SIZE_INDEX + MESH_PRV_PDU_CAPAB_OUT_OOB_SIZE_SIZE)
...
#define MESH_PRV_PDU_CAPAB_IN_OOB_SIZE_INDEX \
    (MESH_PRV_PDU_CAPAB_OUT_OOB_ACT_INDEX + MESH_PRV_PDU_CAPAB_OUT_OOB_ACT_SIZE)
...
#define MESH_PRV_PDU_CAPAB_IN_OOB_ACT_INDEX \
    (MESH_PRV_PDU_CAPAB_IN_OOB_SIZE_INDEX + MESH_PRV_PDU_CAPAB_IN_OOB_SIZE_SIZE)
...
#define MESH_PRV_PDU_CAPAB_PARAM_SIZE                                             \
    (MESH_PRV_PDU_CAPAB_NUM_ELEM_SIZE + MESH_PRV_PDU_CAPAB_ALGORITHMS_SIZE +      \
     MESH_PRV_PDU_CAPAB_PUB_KEY_TYPE_SIZE + MESH_PRV_PDU_CAPAB_STATIC_OOB_SIZE +  \
     MESH_PRV_PDU_CAPAB_OUT_OOB_SIZE_SIZE + MESH_PRV_PDU_CAPAB_OUT_OOB_ACT_SIZE + \
     MESH_PRV_PDU_CAPAB_IN_OOB_SIZE_SIZE + MESH_PRV_PDU_CAPAB_IN_OOB_ACT_SIZE)
/*! Capabilitites PDU: Total PDU size */
#define MESH_PRV_PDU_CAPAB_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_CAPAB_PARAM_SIZE)
...
#define MESH_PRV_PDU_START_PUB_KEY_INDEX \
    (MESH_PRV_PDU_START_ALGORITHM_INDEX + MESH_PRV_PDU_START_ALGORITHM_SIZE)
...
#define MESH_PRV_PDU_START_AUTH_METHOD_INDEX \
    (MESH_PRV_PDU_START_PUB_KEY_INDEX + MESH_PRV_PDU_START_PUB_KEY_SIZE)
...
#define MESH_PRV_PDU_START_AUTH_ACTION_INDEX \
    (MESH_PRV_PDU_START_AUTH_METHOD_INDEX + MESH_PRV_PDU_START_AUTH_METHOD_SIZE)
...
#define MESH_PRV_PDU_START_AUTH_SIZE_INDEX \
    (MESH_PRV_PDU_START_AUTH_ACTION_INDEX + MESH_PRV_PDU_START_AUTH_ACTION_SIZE)
/*! Start PDU: Authentication Size parameter size */
#define MESH_PRV_PDU_START_AUTH_SIZE_SIZE 1
/*! Start PDU: Total parameter size */
#define MESH_PRV_PDU_START_PARAM_SIZE                                            \
    (MESH_PRV_PDU_START_ALGORITHM_SIZE + MESH_PRV_PDU_START_PUB_KEY_SIZE +       \
     MESH_PRV_PDU_START_AUTH_METHOD_SIZE + MESH_PRV_PDU_START_AUTH_ACTION_SIZE + \
     MESH_PRV_PDU_START_AUTH_SIZE_SIZE)
/*! Start PDU: Total PDU size */
#define MESH_PRV_PDU_START_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_START_PARAM_SIZE)
...
#define MESH_PRV_PDU_PUB_KEY_Y_INDEX (MESH_PRV_PDU_PUB_KEY_X_INDEX + MESH_PRV_PDU_PUB_KEY_X_SIZE)
/*! Public Key PDU: Public Key Y parameter size */
#define MESH_PRV_PDU_PUB_KEY_Y_SIZE 32
/*! Public Key PDU: Total parameter size */
#define MESH_PRV_PDU_PUB_KEY_PARAM_SIZE (MESH_PRV_PDU_PUB_KEY_X_SIZE + MESH_PRV_PDU_PUB_KEY_Y_SIZE)
/*! Public Key PDU: Total PDU size */
#define MESH_PRV_PDU_PUB_KEY_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_PUB_KEY_PARAM_SIZE)

/*! Input Complete PDU: Total parameter size */
#define MESH_PRV_PDU_INPUT_COMPLETE_PARAM_SIZE 0
/*! Input Complete PDU: Total PDU size */
#define MESH_PRV_PDU_INPUT_COMPLETE_PDU_SIZE \
    (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_INPUT_COMPLETE_PARAM_SIZE)
...
#define MESH_PRV_PDU_CONFIRM_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_CONFIRM_PARAM_SIZE)
...
#define MESH_PRV_PDU_RANDOM_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_RANDOM_PARAM_SIZE)
...
#define MESH_PRV_PDU_DATA_MIC_INDEX \
    (MESH_PRV_PDU_DATA_ENC_DATA_INDEX + MESH_PRV_PDU_DATA_ENC_DATA_SIZE)
/*! Data PDU: Provisioning Data MIC parameter size */
#define MESH_PRV_PDU_DATA_MIC_SIZE 8
/*! Data PDU: Total parameter size */
#define MESH_PRV_PDU_DATA_PARAM_SIZE (MESH_PRV_PDU_DATA_ENC_DATA_SIZE + MESH_PRV_PDU_DATA_MIC_SIZE)
/*! Data PDU: Total PDU size */
#define MESH_PRV_PDU_DATA_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_DATA_PARAM_SIZE)
...
#define MESH_PRV_DECRYPTED_DATA_NETKEYIDX_INDEX \
    (MESH_PRV_DECRYPTED_DATA_NETKEY_INDEX + MESH_PRV_DECRYPTED_DATA_NETKEY_SIZE)
...
#define MESH_PRV_DECRYPTED_DATA_FLAGS_INDEX \
    (MESH_PRV_DECRYPTED_DATA_NETKEYIDX_INDEX + MESH_PRV_DECRYPTED_DATA_NETKEYIDX_SIZE)
/*! Decrypted Data: Flags parameter size */
#define MESH_PRV_DECRYPTED_DATA_FLAGS_SIZE 1
/*! Decrypted Data: IV Index parameter index */
#define MESH_PRV_DECRYPTED_DATA_IVIDX_INDEX \
    (MESH_PRV_DECRYPTED_DATA_FLAGS_INDEX + MESH_PRV_DECRYPTED_DATA_FLAGS_SIZE)
/*! Decrypted Data: IV Index parameter size */
#define MESH_PRV_DECRYPTED_DATA_IVIDX_SIZE 4
/*! Decrypted Data: Address parameter index */
#define MESH_PRV_DECRYPTED_DATA_ADDRESS_INDEX \
    (MESH_PRV_DECRYPTED_DATA_IVIDX_INDEX + MESH_PRV_DECRYPTED_DATA_IVIDX_SIZE)
...
#define MESH_PRV_PDU_COMPLETE_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_COMPLETE_PARAM_SIZE)
...
#define MESH_PRV_PDU_FAILED_PDU_SIZE (MESH_PRV_PDU_OPCODE_SIZE + MESH_PRV_PDU_FAILED_PARAM_SIZE)

/* Provisioning crypto constants */

/*! Size of the ConfirmationInputs array */
#define MESH_PRV_CONFIRMATION_INPUTS_SIZE                             \
    (MESH_PRV_PDU_INVITE_PARAM_SIZE + MESH_PRV_PDU_CAPAB_PARAM_SIZE + \
     MESH_PRV_PDU_START_PARAM_SIZE + 2 * MESH_PRV_PDU_PUB_KEY_PARAM_SIZE)
...
enum meshPrvPduStartPubKeyValues_tag {
    ...
    MESH_PRV_START_PUB_KEY_PROHIBITED_START =
        0x02, /*!< All numbers above this value are Prohibited */
};
...
enum meshPrvPduStartAuthMethodValues_tag {
    ...
    MESH_PRV_START_AUTH_METHOD_PROHIBITED_START =
        0x04, /*!< All numbers above this value are Prohibited */
};
