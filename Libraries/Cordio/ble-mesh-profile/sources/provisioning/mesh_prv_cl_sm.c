...
static const meshPrvClTblEntry_t prvClStateTblSendInvite[] = {
    ...
    { PRV_CL_EVT_RECV_CAPABILITIES, PRV_CL_ST_WAIT_SELECT_AUTH,
      PRV_CL_ACT_WAIT_SELECT_AUTH }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvClTblEntry_t prvClStateTblSendPublicKey[] = {
    ...
    /* This action will simulate the
                                                                 ...
                                                                 */
    { PRV_CL_EVT_RECV_PUBLIC_KEY, PRV_CL_ST_VALIDATE_PUBLIC_KEY,
      PRV_CL_ACT_VALIDATE_PUBLIC_KEY }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvClTblEntry_t prvClStateTblSendConfirmation[] = {
    ...
    { PRV_CL_EVT_RECV_CONFIRMATION, PRV_CL_ST_SEND_RANDOM,
      PRV_CL_ACT_SEND_RANDOM }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvClTblEntry_t prvClStateTblSendRandom[] = {
    ...
    { PRV_CL_EVT_RECV_RANDOM, PRV_CL_ST_CHECK_CONFIRMATION,
      PRV_CL_ACT_CHECK_CONFIRMATION }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvClTblEntry_t prvClStateTblSendData[] = {
    ...
    { PRV_CL_EVT_RECV_COMPLETE, PRV_CL_ST_IDLE,
      PRV_CL_ACT_SUCCESS }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
const meshPrvClSmIf_t meshPrvClSmIf = { prvClStateTbl, prvClActionTbl, prvClStateTblCommon };
...
static uint8_t *meshPrvClStateStr(meshPrvClSmState_t state)
{
    ...
    case PRV_CL_ST_IDLE:
        return (uint8_t *)"IDLE";
    case PRV_CL_ST_WAIT_LINK:
        return (uint8_t *)"WAIT_LINK";
    case PRV_CL_ST_SEND_INVITE:
        return (uint8_t *)"SEND_INVITE";
    case PRV_CL_ST_WAIT_CAPABILITIES:
        return (uint8_t *)"WAIT_CAPABILITIES";
    case PRV_CL_ST_WAIT_SELECT_AUTH:
        return (uint8_t *)"WAIT_SELECT_AUTH";
    case PRV_CL_ST_SEND_START:
        return (uint8_t *)"SEND_START";
    case PRV_CL_ST_SEND_PUBLIC_KEY:
        return (uint8_t *)"SEND_PUBLIC_KEY";
    case PRV_CL_ST_WAIT_PUBLIC_KEY:
        return (uint8_t *)"WAIT_PUBLIC_KEY";
    case PRV_CL_ST_VALIDATE_PUBLIC_KEY:
        return (uint8_t *)"VALIDATE_PUBLIC_KEY";
    case PRV_CL_ST_GENERATE_PUBLIC_KEY:
        return (uint8_t *)"GENERATE_PUBLIC_KEY";
    case PRV_CL_ST_PREPARE_OOB_ACTION:
        return (uint8_t *)"PREPARE_OOB_ACTION";
    case PRV_CL_ST_WAIT_INPUT:
        return (uint8_t *)"WAIT_INPUT";
    case PRV_CL_ST_WAIT_INPUT_COMPLETE:
        return (uint8_t *)"WAIT_INPUT_COMPLETE";
    case PRV_CL_ST_CALC_CONFIRMATION:
        return (uint8_t *)"CALC_CONFIRMATION";
    case PRV_CL_ST_SEND_CONFIRMATION:
        return (uint8_t *)"SEND_CONFIRMATION";
    case PRV_CL_ST_WAIT_CONFIRMATION:
        return (uint8_t *)"WAIT_CONFIRMATION";
    case PRV_CL_ST_SEND_RANDOM:
        return (uint8_t *)"SEND_RANDOM";
    case PRV_CL_ST_WAIT_RANDOM:
        return (uint8_t *)"WAIT_RANDOM";
    case PRV_CL_ST_CHECK_CONFIRMATION:
        return (uint8_t *)"CHECK_CONFIRMATION";
    case PRV_CL_ST_CALC_SESSION_KEY:
        return (uint8_t *)"CALC_SESSION_KEY";
    case PRV_CL_ST_ENCRYPT_DATA:
        return (uint8_t *)"ENCRYPT_DATA";
    case PRV_CL_ST_SEND_DATA:
        return (uint8_t *)"SEND_DATA";
    case PRV_CL_ST_WAIT_COMPLETE:
        return (uint8_t *)"WAIT_COMPLETE";
...
{
    switch (evt) {
    case PRV_CL_EVT_BEGIN_NO_LINK:
        return (uint8_t *)"BEGIN_NO_LINK";
    case PRV_CL_EVT_BEGIN_LINK_OPEN:
        return (uint8_t *)"BEGIN_LINK_OPEN";
    case PRV_CL_EVT_LINK_OPENED:
        return (uint8_t *)"LINK_OPENED";
    case PRV_CL_EVT_LINK_FAILED:
        return (uint8_t *)"LINK_FAILED";
    case PRV_CL_EVT_LINK_CLOSED_FAIL:
        return (uint8_t *)"LINK_CLOSED_FAIL";
    case PRV_CL_EVT_BAD_PDU:
        return (uint8_t *)"BAD_PDU";
    case PRV_CL_EVT_LINK_CLOSED_SUCCESS:
        return (uint8_t *)"LINK_CLOSED_SUCCESS";
    case PRV_CL_EVT_RECV_TIMEOUT:
        return (uint8_t *)"RECV_TIMEOUT";
    case PRV_CL_EVT_SEND_TIMEOUT:
        return (uint8_t *)"SEND_TIMEOUT";
    case PRV_CL_EVT_SENT_INVITE:
        return (uint8_t *)"SENT_INVITE";
    case PRV_CL_EVT_SENT_START:
        return (uint8_t *)"SENT_START";
    case PRV_CL_EVT_SENT_PUBLIC_KEY:
        return (uint8_t *)"SENT_PUBLIC_KEY";
    case PRV_CL_EVT_SENT_CONFIRMATION:
        return (uint8_t *)"SENT_CONFIRMATION";
    case PRV_CL_EVT_SENT_RANDOM:
        return (uint8_t *)"SENT_RANDOM";
    case PRV_CL_EVT_SENT_DATA:
        return (uint8_t *)"SENT_DATA";
    case PRV_CL_EVT_GOTO_WAIT_INPUT:
        return (uint8_t *)"GOTO_WAIT_INPUT";
    case PRV_CL_EVT_GOTO_WAIT_IC:
        return (uint8_t *)"GOTO_WAIT_INPUT_COMPLETE";
    case PRV_CL_EVT_GOTO_CONFIRMATION:
        return (uint8_t *)"GOTO_CONFIRMATION";
    case PRV_CL_EVT_INPUT_READY:
        return (uint8_t *)"INPUT_READY";
    case PRV_CL_EVT_AUTH_SELECTED:
        return (uint8_t *)"AUTH_SELECTED";
    case PRV_CL_EVT_CONFIRMATION_READY:
        return (uint8_t *)"CONFIRMATION_READY";
    case PRV_CL_EVT_CONFIRMATION_VERIFIED:
        return (uint8_t *)"CONFIRMATION_VERIFIED";
    case PRV_CL_EVT_CONFIRMATION_FAILED:
        return (uint8_t *)"CONFIRMATION_FAILED";
    case PRV_CL_EVT_SESSION_KEY_READY:
        return (uint8_t *)"SESSION_KEY_READY";
    case PRV_CL_EVT_RECV_CAPABILITIES:
        return (uint8_t *)"RECV_CAPABILITIES";
    case PRV_CL_EVT_RECV_PUBLIC_KEY:
        return (uint8_t *)"RECV_PUBLIC_KEY";
    case PRV_CL_EVT_PUBLIC_KEY_VALID:
        return (uint8_t *)"PUBLIC_KEY_VALID";
    case PRV_CL_EVT_PUBLIC_KEY_INVALID:
        return (uint8_t *)"PUBLIC_KEY_INVALID";
    case PRV_CL_EVT_PUBLIC_KEY_GENERATED:
        return (uint8_t *)"PUBLIC_KEY_GENERATED";
    case PRV_CL_EVT_RECV_CONFIRMATION:
        return (uint8_t *)"RECV_CONFIRMATION";
    case PRV_CL_EVT_RECV_RANDOM:
        return (uint8_t *)"RECV_RANDOM";
    case PRV_CL_EVT_RECV_COMPLETE:
        return (uint8_t *)"RECV_COMPLETE";
    case PRV_CL_EVT_DATA_ENCRYPTED:
        return (uint8_t *)"DATA_ENCRYPTED";
    case PRV_CL_EVT_CANCEL:
        return (uint8_t *)"CANCEL";
...
void meshPrvClSmExecute(meshPrvClCb_t *pCcb, meshPrvClSmMsg_t *pMsg)
{
    ...
    MESH_TRACE_INFO2("MESH_PRV_CL_SM Event Handler: state=%s event=%s",
                     meshPrvClStateStr(pCcb->state), meshPrvClEvtStr(pMsg->hdr.event));
        ...
        do {
            ...
            if ((*pTblEntry)[MESH_PRV_CL_SM_POS_EVENT] == pMsg->hdr.event) {
                ...
                MESH_TRACE_INFO2("MESH_PRV_CL_SM State Change: old=%s new=%s",
                                 meshPrvClStateStr(oldState), meshPrvClStateStr(pCcb->state));
