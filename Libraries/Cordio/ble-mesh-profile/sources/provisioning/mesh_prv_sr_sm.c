...
static const meshPrvSrTblEntry_t prvSrStateTblSendCapabilities[] = {
    ...
    { PRV_SR_EVT_RECV_START, PRV_SR_ST_WAIT_PUBLIC_KEY,
      PRV_SR_ACT_WAIT_PUBLIC_KEY }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvSrTblEntry_t prvSrStateTblGeneratePublicKey[] = {
    /* Event                              Next state                     Action  */
    { PRV_SR_EVT_PUBLIC_KEY_GENERATED, PRV_SR_ST_VALIDATE_PUBLIC_KEY,
      PRV_SR_ACT_VALIDATE_PUBLIC_KEY },
...
static const meshPrvSrTblEntry_t prvSrStateTblSendPublicKey[] = {
    ...
    /* This action will generate the
                                                                  ...
                                                                  */
    { PRV_SR_EVT_RECV_CONFIRMATION, PRV_SR_ST_CALC_CONFIRMATION,
      PRV_SR_ACT_CALC_CONFIRMATION }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvSrTblEntry_t prvSrStateTblSendConfirmation[] = {
    ...
    { PRV_SR_EVT_RECV_RANDOM, PRV_SR_ST_CHECK_CONFIRMATION,
      PRV_SR_ACT_CHECK_CONFIRMATION }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
static const meshPrvSrTblEntry_t prvSrStateTblSendRandom[] = {
    ...
    { PRV_SR_EVT_RECV_DATA, PRV_SR_ST_DECRYPT_DATA,
      PRV_SR_ACT_DECRYPT_DATA }, /* Only if device missed ACKs */
    { 0, 0, 0 }
};
...
const meshPrvSrTblEntry_t *const prvSrStateTbl[] = { prvSrStateTblIdle,
...
const meshPrvSrSmIf_t meshPrvSrSmIf = { prvSrStateTbl, prvSrActionTbl, prvSrStateTblCommon };
...
static uint8_t *meshPrvSrStateStr(meshPrvSrSmState_t state)
{
    ...
    case PRV_SR_ST_IDLE:
        return (uint8_t *)"IDLE";
    case PRV_SR_ST_WAIT_LINK:
        return (uint8_t *)"WAIT_LINK";
    case PRV_SR_ST_WAIT_INVITE:
        return (uint8_t *)"WAIT_INVITE";
    case PRV_SR_ST_SEND_CAPABILITIES:
        return (uint8_t *)"SEND_CAPABILITIES";
    case PRV_SR_ST_WAIT_START:
        return (uint8_t *)"WAIT_START";
    case PRV_SR_ST_WAIT_PUBLIC_KEY:
        return (uint8_t *)"WAIT_PUBLIC_KEY";
    case PRV_SR_ST_VALIDATE_PUBLIC_KEY:
        return (uint8_t *)"VALIDATE_PUBLIC_KEY";
    case PRV_SR_ST_GENERATE_PUBLIC_KEY:
        return (uint8_t *)"GENERATE_PUBLIC_KEY";
    case PRV_SR_ST_SEND_PUBLIC_KEY:
        return (uint8_t *)"SEND_PUBLIC_KEY";
    case PRV_SR_ST_PREPARE_OOB_ACTION:
        return (uint8_t *)"PREPARE_OOB_ACTION";
    case PRV_SR_ST_WAIT_INPUT:
        return (uint8_t *)"WAIT_INPUT";
    case PRV_SR_ST_SEND_INPUT_COMPLETE:
        return (uint8_t *)"SEND_INPUT_COMPLETE";
    case PRV_SR_ST_WAIT_CONFIRMATION:
        return (uint8_t *)"WAIT_CONFIRMATION";
    case PRV_SR_ST_CALC_CONFIRMATION:
        return (uint8_t *)"CALC_CONFIRMATION";
    case PRV_SR_ST_SEND_CONFIRMATION:
        return (uint8_t *)"SEND_CONFIRMATION";
    case PRV_SR_ST_WAIT_RANDOM:
        return (uint8_t *)"WAIT_RANDOM";
    case PRV_SR_ST_CHECK_CONFIRMATION:
        return (uint8_t *)"CHECK_CONFIRMATION";
    case PRV_SR_ST_CALC_SESSION_KEY:
        return (uint8_t *)"CALC_SESSION_KEY";
    case PRV_SR_ST_SEND_RANDOM:
        return (uint8_t *)"SEND_RANDOM";
    case PRV_SR_ST_WAIT_DATA:
        return (uint8_t *)"WAIT_DATA";
    case PRV_SR_ST_DECRYPT_DATA:
        return (uint8_t *)"DECRYPT_DATA";
    case PRV_SR_ST_SEND_COMPLETE:
        return (uint8_t *)"SEND_COMPLETE";

    case PRV_SR_ST_NO_STATE_CHANGE:
        return (uint8_t *)"NO_STATE_CHANGE";
...
{
    switch (evt) {
    case PRV_SR_EVT_BEGIN_NO_LINK:
        return (uint8_t *)"BEGIN_NO_LINK";
    case PRV_SR_EVT_BEGIN_LINK_OPEN:
        return (uint8_t *)"BEGIN_LINK_OPEN";
    case PRV_SR_EVT_LINK_OPENED:
        return (uint8_t *)"LINK_OPENED";
    case PRV_SR_EVT_LINK_CLOSED_FAIL:
        return (uint8_t *)"LINK_CLOSED_FAIL";
    case PRV_SR_EVT_LINK_CLOSED_SUCCESS:
        return (uint8_t *)"LINK_CLOSED_SUCCESS";
    case PRV_SR_EVT_RECV_TIMEOUT:
        return (uint8_t *)"RECV_TIMEOUT";
    case PRV_SR_EVT_SEND_TIMEOUT:
        return (uint8_t *)"SEND_TIMEOUT";
    case PRV_SR_EVT_SENT_CAPABILITIES:
        return (uint8_t *)"SENT_CAPABILITIES";
    case PRV_SR_EVT_SENT_PUBLIC_KEY:
        return (uint8_t *)"SENT_PUBLIC_KEY";
    case PRV_SR_EVT_SENT_INPUT_COMPLETE:
        return (uint8_t *)"SENT_INPUT_COMPLETE";
    case PRV_SR_EVT_SENT_CONFIRMATION:
        return (uint8_t *)"SENT_CONFIRMATION";
    case PRV_SR_EVT_SENT_RANDOM:
        return (uint8_t *)"SENT_RANDOM";
    case PRV_SR_EVT_SENT_COMPLETE:
        return (uint8_t *)"SENT_COMPLETE";
    case PRV_SR_EVT_GOTO_INPUT:
        return (uint8_t *)"GOTO_INPUT";
    case PRV_SR_EVT_GOTO_CONFIRMATION:
        return (uint8_t *)"GOTO_CONFIRMATION";
    case PRV_SR_EVT_INPUT_READY:
        return (uint8_t *)"INPUT_READY";
    case PRV_SR_EVT_CONFIRMATION_READY:
        return (uint8_t *)"CONFIRMATION_READY";
    case PRV_SR_EVT_CONFIRMATION_VERIFIED:
        return (uint8_t *)"CONFIRMATION_VERIFIED";
    case PRV_SR_EVT_CONFIRMATION_FAILED:
        return (uint8_t *)"CONFIRMATION_FAILED";
    case PRV_SR_EVT_SESSION_KEY_READY:
        return (uint8_t *)"SESSION_KEY_READY";
    case PRV_SR_EVT_RECV_INVITE:
        return (uint8_t *)"RECV_INVITE";
    case PRV_SR_EVT_RECV_START:
        return (uint8_t *)"RECV_START";
    case PRV_SR_EVT_RECV_PUBLIC_KEY:
        return (uint8_t *)"RECV_PUBLIC_KEY";
    case PRV_SR_EVT_PUBLIC_KEY_VALID:
        return (uint8_t *)"PUBLIC_KEY_VALID";
    case PRV_SR_EVT_PUBLIC_KEY_INVALID:
        return (uint8_t *)"PUBLIC_KEY_INVALID";
    case PRV_SR_EVT_PUBLIC_KEY_GENERATED:
        return (uint8_t *)"PUBLIC_KEY_GENERATED";
    case PRV_SR_EVT_RECV_CONFIRMATION:
        return (uint8_t *)"RECV_CONFIRMATION";
    case PRV_SR_EVT_RECV_RANDOM:
        return (uint8_t *)"RECV_RANDOM";
    case PRV_SR_EVT_RECV_DATA:
        return (uint8_t *)"RECV_DATA";
    case PRV_SR_EVT_DATA_DECRYPTED:
        return (uint8_t *)"DATA_DECRYPTED";
    case PRV_SR_EVT_DATA_NOT_DECRYPTED:
        return (uint8_t *)"DATA_NOT_DECRYPTED";
    case PRV_SR_EVT_RECV_BAD_PDU:
        return (uint8_t *)"RECV_BAD_PDU";
...
void meshPrvSrSmExecute(meshPrvSrCb_t *pCcb, meshPrvSrSmMsg_t *pMsg)
{
    ...
    MESH_TRACE_INFO2("MESH_PRV_SR_SM Event Handler: state=%s event=%s",
                     meshPrvSrStateStr(pCcb->state), meshPrvSrEvtStr(pMsg->hdr.event));
            ...
            if ((*pTblEntry)[MESH_PRV_SR_SM_POS_EVENT] == pMsg->hdr.event) {
                if ((*pTblEntry)[MESH_PRV_SR_SM_POS_NEXT_STATE] != PRV_SR_ST_NO_STATE_CHANGE) {
                    ...
                    MESH_TRACE_INFO2("MESH_PRV_SR_SM State Change: old=%s new=%s",
                                     meshPrvSrStateStr(oldState), meshPrvSrStateStr(pCcb->state));
                } else {
