...
#define MESH_FRIEND_QUEUE_MAX_LTR_PDU \
    (MESH_NWK_MAX_PDU_LEN - MESH_NWK_HEADER_LEN - MESH_NETMIC_SIZE_ACC_PDU)
...
enum meshFriendFsmMasks { FRIEND_FSN_CRT_SHIFT, FRIEND_FSN_NEXT_SHIFT };
