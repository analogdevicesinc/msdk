...
static const meshFriendTblEntry_t *const friendStateTbl[] = {
    friendStateTblIdle,         friendStateTblWaitReq,     friendStateTblStartKeyDeriv,
    friendStateTblKeyDerivLate, friendStateTblRecvTimeout, friendStateTblWaitPoll,
    friendStateTblEstab,
};
...
const meshFriendSmIf_t meshFriendSrSmIf = { friendStateTbl, friendActionTbl, friendStateTblCommon };
...
static uint8_t *meshFriendStateStr(meshFriendSmState_t state)
{
    ...
    case FRIEND_ST_IDLE:
        return (uint8_t *)"IDLE";
    case FRIEND_ST_WAIT_REQ:
        return (uint8_t *)"WAIT_FRIEND_REQ";
    case FRIEND_ST_START_KEY_DERIV:
        return (uint8_t *)"START_KEY_DERIV";
    case FRIEND_ST_KEY_DERIV_LATE:
        return (uint8_t *)"KEY_DERIV_LATE";
    case FRIEND_ST_WAIT_RECV_TIMEOUT:
        return (uint8_t *)"RECV_TIMEOUT";
    case FRIEND_ST_WAIT_POLL:
        return (uint8_t *)"WAIT_FRIEND_POLL";
    case FRIEND_ST_ESTAB:
        return (uint8_t *)"ESTAB_COMPLETE";

    default:
        return (uint8_t *)"UNKNOWN_STATE";
    }
}
...
static uint8_t *meshFriendEvtStr(uint8_t evt)
{
    ...
    case MESH_FRIEND_MSG_STATE_ENABLED:
        return (uint8_t *)"FRIEND_STATE_ENABLED";
    case MESH_FRIEND_MSG_STATE_DISABLED:
        return (uint8_t *)"FRIEND_STATE_DISABLED";
    case MESH_FRIEND_MSG_FRIEND_REQ_RECV:
        return (uint8_t *)"FRIEND_REQ_RECEIVED";
    case MESH_FRIEND_MSG_POLL_RECV:
        return (uint8_t *)"FRIEND_POLL_RECEIVED";
    case MESH_FRIEND_MSG_FRIEND_CLEAR_RECV:
        return (uint8_t *)"FRIEND_CLEAR_RECEIVED";
    case MESH_FRIEND_MSG_FRIEND_CLEAR_CNF_RECV:
        return (uint8_t *)"FRIEND_CLEAR_CNF_RECEIVED";
    case MESH_FRIEND_MSG_KEY_DERIV_SUCCESS:
        return (uint8_t *)"FRIEND_KEY_DERIVATION_SUCCESS";
    case MESH_FRIEND_MSG_KEY_DERIV_FAILED:
        return (uint8_t *)"FRIEND_KEY_DERIVATION_FAILED";
    case MESH_FRIEND_MSG_RECV_DELAY:
        return (uint8_t *)"FRIEND_RECEIVE_DELAY_TMR";
    case MESH_FRIEND_MSG_SUBSCR_CNF_DELAY:
        return (uint8_t *)"FRIEND_SUBSCR_CNF_TMR";
    case MESH_FRIEND_MSG_CLEAR_SEND_TIMEOUT:
        return (uint8_t *)"FRIEND_CLEAR_SEND_TMR";
    case MESH_FRIEND_MSG_TIMEOUT:
        return (uint8_t *)"FRIEND_TIMEOUT";
    case MESH_FRIEND_MSG_SUBSCR_LIST_ADD:
        return (uint8_t *)"FRIEND_SUBSCRIPTION_ADD";
    case MESH_FRIEND_MSG_SUBSCR_LIST_REM:
        return (uint8_t *)"FRIEND_SUBSCRIPTION_REMOVE";
    case MESH_FRIEND_MSG_NETKEY_DEL:
        return (uint8_t *)"FRIEND_NETKEY_DEL";
...
void meshFriendSmExecute(meshFriendLpnCtx_t *pCtx, meshFriendSmMsg_t *pMsg)
{
    ...
    MESH_TRACE_INFO2("MESH_FRIEND_SM Event Handler: state=%s event=%s\r\n",
                     meshFriendStateStr(pCtx->friendSmState), meshFriendEvtStr(pMsg->hdr.event));
