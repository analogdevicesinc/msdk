...
#define MESH_FRIEND_MIN_QUEUE_SIZE_VALID(size)            \
    (((size) != MESH_FRIEND_MIN_QUEUE_SIZE_PROHIBITED) && \
...
#define MESH_FRIEND_POLL_TIMEOUT_MS_VALID(timeout)                                       \
    ((((timeout) / MESH_FRIEND_POLL_TIMEOUT_STEP_MS) >= MESH_FRIEND_POLL_TIMEOUT_MIN) && \
     (((timeout) / MESH_FRIEND_POLL_TIMEOUT_STEP_MS) <= MESH_FRIEND_POLL_TIMEOUT_MAX))
