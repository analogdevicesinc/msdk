...
static const meshLpnTblEntry_t lpnStateTblWaitFriendUpdate[] = {
    ...
    { MESH_LPN_MSG_SEND_FRIEND_POLL, LPN_SM_ST_WAIT_FRIEND_UPDATE, LPN_ACT_SEND_FRIEND_POLL },
    { MESH_LPN_MSG_SEND_FRIEND_REQ, LPN_SM_ST_WAIT_FRIEND_OFFER, LPN_ACT_SEND_FRIEND_REQ },
    { MESH_LPN_MSG_FRIEND_UPDATE, LPN_SM_ST_FRIENDSHIP_ESTABLISHED,
      LPN_ACT_FRIENDSHIP_ESTABLISHED },
    { 0, 0, 0 }
};
...
static const meshLpnTblEntry_t lpnStateTblFriendshipEstablished[] = {
    ...
    { MESH_LPN_MSG_SEND_FRIEND_SUBSCR_ADD_RM, LPN_SM_ST_WAIT_FRIEND_SUBSCR_CNF,
      LPN_ACT_SEND_FRIEND_SUBSCR_ADD_RM },
...
static const meshLpnTblEntry_t lpnStateTblWaitFriendMessage[] = {
    ...
    { MESH_LPN_MSG_POLL_TIMEOUT, LPN_SM_ST_WAIT_FRIEND_MESSAGE, LPN_ACT_SEND_FRIEND_POLL },
    { MESH_LPN_MSG_FRIEND_UPDATE, LPN_SM_ST_FRIENDSHIP_ESTABLISHED, LPN_ACT_PROCESS_FRIEND_UPDATE },
    { MESH_LPN_MSG_FRIEND_MESSAGE, LPN_SM_ST_FRIENDSHIP_ESTABLISHED,
      LPN_ACT_PROCESS_FRIEND_MESSAGE },
    { 0, 0, 0 }
};
...
static const meshLpnTblEntry_t lpnStateTblWaitFriendSubscrCnf[] = {
    ...
    { MESH_LPN_MSG_SEND_FRIEND_SUBSCR_ADD_RM, LPN_SM_ST_WAIT_FRIEND_SUBSCR_CNF,
      LPN_ACT_SEND_FRIEND_SUBSCR_ADD_RM },
    { MESH_LPN_MSG_RECV_DELAY_TIMEOUT, LPN_SM_ST_WAIT_FRIEND_SUBSCR_CNF,
      LPN_ACT_WAIT_FRIEND_SUBSCR_CNF },
    { MESH_LPN_MSG_RECV_WIN_TIMEOUT, LPN_SM_ST_FRIENDSHIP_ESTABLISHED,
      LPN_ACT_RESEND_FRIEND_SUBSCR_ADD_RM },
    { MESH_LPN_MSG_RESEND_FRIEND_SUBSCR_ADD_RM, LPN_SM_ST_FRIENDSHIP_ESTABLISHED,
      LPN_ACT_RESEND_FRIEND_SUBSCR_ADD_RM },
    { MESH_LPN_MSG_FRIEND_SUBSCR_CNF, LPN_SM_ST_WAIT_FRIEND_SUBSCR_CNF,
      LPN_ACT_PROCESS_FRIEND_SUBSCR_CNF },
    { MESH_LPN_MSG_POLL_TIMEOUT, LPN_SM_ST_WAIT_FRIEND_MESSAGE, LPN_ACT_SEND_FRIEND_POLL },
    { MESH_LPN_MSG_SEND_FRIEND_POLL, LPN_SM_ST_WAIT_FRIEND_MESSAGE, LPN_ACT_SEND_FRIEND_POLL },
    { 0, 0, 0 }
};
...
const meshLpnTblEntry_t *const lpnStateTbl[] = { lpnStateTblIdle,
...
const meshLpnSmIf_t meshLpnSmIf = { lpnStateTbl, lpnActionTbl, lpnStateTblCommon };
...
static uint8_t *meshLpnStateStr(uint8_t state)
{
    ...
    case LPN_SM_ST_IDLE:
        return (uint8_t *)"IDLE";
    case LPN_SM_ST_WAIT_FRIEND_OFFER:
        return (uint8_t *)"WAIT_FRIEND_OFFER";
    case LPN_SM_ST_WAIT_FRIEND_UPDATE:
        return (uint8_t *)"WAIT_FRIEND_UPDATE";
    case LPN_SM_ST_FRIENDSHIP_ESTABLISHED:
        return (uint8_t *)"FRIENDSHIP_ESTABLISHED";
    case LPN_SM_ST_WAIT_FRIEND_MESSAGE:
        return (uint8_t *)"WAIT_FRIEND_MESSAGE";
    case LPN_SM_ST_WAIT_FRIEND_SUBSCR_CNF:
        return (uint8_t *)"WAIT_FRIEND_SUBSCR_CNF";

    default:
        return (uint8_t *)"UNKNOWN_EVENT";
    }
}
...
{
    switch (eventId) {
    case MESH_LPN_MSG_ESTABLISH:
        return (uint8_t *)"FRIENDSHIP_ESTABLISH";
    case MESH_LPN_MSG_TERMINATE:
        return (uint8_t *)"FRIENDSHIP_TERMINATE";
    case MESH_LPN_MSG_SEND_FRIEND_REQ:
        return (uint8_t *)"SEND_FRIEND_REQ";
    case MESH_LPN_MSG_SEND_FRIEND_POLL:
        return (uint8_t *)"SEND_FRIEND_POLL";
    case MESH_LPN_MSG_SEND_FRIEND_CLEAR:
        return (uint8_t *)"SEND_FRIEND_CLEAR";
    case MESH_LPN_MSG_SEND_FRIEND_SUBSCR_ADD_RM:
        return (uint8_t *)"SEND_FRIEND_SUBSCR_ADD_RM";
    case MESH_LPN_MSG_RESEND_FRIEND_SUBSCR_ADD_RM:
        return (uint8_t *)"RESEND_FRIEND_SUBSCR_ADD_RM";
    case MESH_LPN_MSG_FRIEND_OFFER:
        return (uint8_t *)"FRIEND_OFFER";
    case MESH_LPN_MSG_FRIEND_UPDATE:
        return (uint8_t *)"FRIEND_UPDATE";
    case MESH_LPN_MSG_FRIEND_MESSAGE:
        return (uint8_t *)"FRIEND_MESSAGE";
    case MESH_LPN_MSG_FRIEND_SUBSCR_CNF:
        return (uint8_t *)"FRIEND_SUBSCR_CNF";
    case MESH_LPN_MSG_RECV_DELAY_TIMEOUT:
        return (uint8_t *)"RECV_DELAY_TIMEOUT";
    case MESH_LPN_MSG_RECV_WIN_TIMEOUT:
        return (uint8_t *)"RECV_WIN_TIMEOUT";
    case MESH_LPN_MSG_POLL_TIMEOUT:
        return (uint8_t *)"POLL_TIMEOUT";
...
void meshLpnSmExecute(meshLpnCtx_t *pLpnCtx, meshLpnSmMsg_t *pMsg)
{
    ...
    MESH_TRACE_INFO2("MESH_LPN_SM Event Handler: state=%s event=%s",
                     meshLpnStateStr(pLpnCtx->state), meshLpnEvtStr(pMsg->hdr.event));
