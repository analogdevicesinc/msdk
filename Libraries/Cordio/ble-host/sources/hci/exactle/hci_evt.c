...
void hciEvtProcessMsg(uint8_t *pEvt)
{
    ...
    case LL_RESET_CNF:
        ...
        LlGetVersion(&hciCoreCb.locVerInfo.manufacturerName, &hciCoreCb.locVerInfo.hciVersion,
                     &hciCoreCb.locVerInfo.hciRevision);
    ...
    case LL_BIG_INFO_ADV_REPORT_IND:
        ...
        /* Copy the event code in case it is change in the callback */
        ...
        } else if (event == HCI_CIS_DISCONNECT_CMPL_CBACK_EVT) {
