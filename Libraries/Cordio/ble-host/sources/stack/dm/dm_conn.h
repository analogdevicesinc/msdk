...
enum {
    ...
    DM_CONN_MSG_API_UPDATE_MASTER =
        DM_MSG_START(DM_ID_CONN_UPD), /*!< Master Connection Parameter Update */
...
enum { DM_CONN_ACT_SET_MAIN, DM_CONN_ACT_SET_MASTER, DM_CONN_ACT_SET_SLAVE, DM_CONN_NUM_ACT_SETS };
...
enum {
    ...
    DM_CONN_SM_ACT_OPEN =
        DM_CONN_ACT_SET_INIT(DM_CONN_ACT_SET_MASTER), /*!< Process Master Connection Open */
    DM_CONN_SM_ACT_CANCEL_OPEN, /*!< Process Master Cancel Connection Open */

    DM_CONN_SM_ACT_ACCEPT =
        DM_CONN_ACT_SET_INIT(DM_CONN_ACT_SET_SLAVE), /*!< Process Slave Connection Accept */
...
enum {
    ...
    DM_CONN_UPD_ACT_UPDATE_MASTER = DM_CONN_ACT_SET_INIT(
        DM_CONN_ACT_SET_MASTER), /*!< Process Master Connection Parameter Update */
    DM_CONN_UPD_ACT_L2C_UPDATE_IND, /*!< Process Master L2CAP Connection Parameter Update Indication */

    DM_CONN_UPD_ACT_UPDATE_SLAVE =
        DM_CONN_ACT_SET_INIT(DM_CONN_ACT_SET_SLAVE), /*!< Process Slave Connection Update */
