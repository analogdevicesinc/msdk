...
static const smpAct_t smpiActionTbl[] = { smpActNone,
                                          smpActCleanup,
                                          smpActPairingFailed,
                                          smpActPairingCancel,
                                          smpActPairCnfCalc1,
...
static const smpTblEntry_t *const smpiStateTbl[] = {
    smpiStateTblIdle,        smpiStateTblPairRsp, smpiStateTblPin,      smpiStateTblCnfCalc1,
    smpiStateTblCnfCalc2,    smpiStateTblPairCnf, smpiStateTblPairRand, smpiStateTblCnfVerCalc1,
    smpiStateTblCnfVerCalc2, smpiStateTblStkCalc, smpiStateTblEncrypt,  smpiStateTblKeyDist,
    smpiStateTblAttempts,    smpiStateTblRspTo
};
...
const smpSmIf_t smpiSmIf = { smpiStateTbl, smpiActionTbl, smpiStateTblCommon };
