...
static const smpAct_t smprActionTbl[] = { smpActNone,
                                          smpActCleanup,
                                          smpActPairingFailed,
                                          smpActSecReqTimeout,
                                          smpActPairingCancel,
...
const smpTblEntry_t *const smprStateTbl[] = {
    smprStateTblIdle,        smprStateTblApiPairReq,  smprStateTblApiPairRsp, smprStateTblPinPair1,
    smprStateTblPinPair2,    smprStateTblCnfCalc1,    smprStateTblCnfCalc2,   smprStateTblPairRand,
    smprStateTblCnfVerCalc1, smprStateTblCnfVerCalc2, smprStateTblStkCalc,    smprStateTblEncrypt,
    smprStateTblKeyDist,     smprStateTblAttempts,    smprStateTblRspTo
};
...
const smpSmIf_t smprSmIf = { smprStateTbl, smprActionTbl, smprStateTblCommon };
