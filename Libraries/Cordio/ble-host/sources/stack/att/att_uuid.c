...
const uint8_t attIasSvcUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_IMMEDIATE_ALERT_SERVICE) };
...
const uint8_t attRtusSvcUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_REF_TIME_UPDATE_SERVICE) };
...
const uint8_t attPlxsSvcUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_PULSE_OXIMITER_SERVICE) };
...
const uint8_t attHidBkoChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_HID_BOOT_KEYBOARD_OUT) };
...
const uint8_t attRsmChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
...
const uint8_t attCpmChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
...
const uint8_t attCsmChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
...
const uint8_t attMprxDoutChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_MESH_PROXY_DATA_OUT) };
...
const uint8_t attGattCsfChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_CLIENT_SUPPORTED_FEATURES) };
...
const uint8_t attSsfChUuid[ATT_16_UUID_LEN] = { UINT16_TO_BYTES(
    ATT_UUID_SERVER_SUPPORTED_FEATURES) };
