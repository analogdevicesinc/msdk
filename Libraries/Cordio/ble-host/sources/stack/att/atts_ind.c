...
/* Interface to ATT */
static const attFcnIf_t attsIndFcnIf = { attEmptyDataCback, attsIndCtrlCback,
                                         (attMsgHandler_t)attsIndMsgCback, attsIndConnCback };
...
{
    attsHandleValueIndNtf(connId, handle, ATT_BEARER_SLOT_ID, valueLen, pValue, ATT_PDU_VALUE_NTF,
                          FALSE);
}
