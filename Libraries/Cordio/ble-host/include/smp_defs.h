...
#define SMP_ERR_CROSS_TRANSPORT \
    0x0E /*!< \brief BR/EDR cross transport key generation not allowed. */
/**@}*/
...
#define SMP_DHKEY_CHECK_MSG_LEN \
    (1 + SMP_DHKEY_CHECK_LEN) /*!< \brief Diffie-Hellman key check message length. */
