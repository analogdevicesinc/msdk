...
#define HCI_LE_CREATE_CONN_CANCEL_CMD_CMPL_CBACK_EVT \
    5 /*!< \brief LE create connection cancel command complete */
...
#define HCI_LE_READ_CHAN_MAP_CMD_CMPL_CBACK_EVT \
    8 /*!< \brief LE Read channel map command complete */
#define HCI_READ_TX_PWR_LVL_CMD_CMPL_CBACK_EVT \
    9 /*!< \brief Read transmit power level command complete */
#define HCI_READ_REMOTE_VER_INFO_CMPL_CBACK_EVT \
    10 /*!< \brief Read remote version information complete */
#define HCI_LE_READ_REMOTE_FEAT_CMPL_CBACK_EVT 11 /*!< \brief LE read remote features complete */
#define HCI_LE_LTK_REQ_REPL_CMD_CMPL_CBACK_EVT \
    12 /*!< \brief LE LTK request reply command complete */
#define HCI_LE_LTK_REQ_NEG_REPL_CMD_CMPL_CBACK_EVT \
    13 /*!< \brief LE LTK request negative reply command complete */
...
#define HCI_LE_ADD_DEV_TO_RES_LIST_CMD_CMPL_CBACK_EVT \
    21 /*!< \brief LE add device to resolving list command complete */
#define HCI_LE_REM_DEV_FROM_RES_LIST_CMD_CMPL_CBACK_EVT \
    22 /*!< \brief LE remove device from resolving command complete */
#define HCI_LE_CLEAR_RES_LIST_CMD_CMPL_CBACK_EVT \
    23 /*!< \brief LE clear resolving list command complete */
#define HCI_LE_READ_PEER_RES_ADDR_CMD_CMPL_CBACK_EVT \
    24 /*!< \brief LE read peer resolving address command complete */
#define HCI_LE_READ_LOCAL_RES_ADDR_CMD_CMPL_CBACK_EVT \
    25 /*!< \brief LE read local resolving address command complete */
#define HCI_LE_SET_ADDR_RES_ENABLE_CMD_CMPL_CBACK_EVT \
    26 /*!< \brief LE set address resolving enable command complete */
...
#define HCI_LE_REM_CONN_PARAM_REP_CMD_CMPL_CBACK_EVT \
    29 /*!< \brief LE remote connection parameter request reply complete */
#define HCI_LE_REM_CONN_PARAM_NEG_REP_CMD_CMPL_CBACK_EVT \
    30 /*!< \brief LE remote connection parameter request negative reply complete */
#define HCI_LE_READ_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT \
    31 /*!< \brief LE read suggested default data length command complete */
#define HCI_LE_WRITE_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT \
    32 /*!< \brief LE write suggested default data length command complete */
#define HCI_LE_SET_DATA_LEN_CMD_CMPL_CBACK_EVT 33 /*!< \brief LE set data length command complete */
#define HCI_LE_READ_MAX_DATA_LEN_CMD_CMPL_CBACK_EVT \
    34 /*!< \brief LE read maximum data length command complete */
...
#define HCI_LE_READ_LOCAL_P256_PUB_KEY_CMPL_CBACK_EVT \
    37 /*!< \brief LE read local P-256 public key */
#define HCI_LE_GENERATE_DHKEY_CMPL_CBACK_EVT 38 /*!< \brief LE generate DHKey complete */
#define HCI_WRITE_AUTH_PAYLOAD_TO_CMD_CMPL_CBACK_EVT \
    39 /*!< \brief Write authenticated payload timeout command complete */
#define HCI_AUTH_PAYLOAD_TO_EXPIRED_CBACK_EVT \
    40 /*!< \brief Authenticated payload timeout expired event */
...
#define HCI_LE_PER_ADV_SYNC_EST_CBACK_EVT \
    48 /*!< \brief LE periodic advertising sync established event */
#define HCI_LE_PER_ADV_REPORT_CBACK_EVT 49 /*!< \brief LE periodic advertising report event */
#define HCI_LE_PER_ADV_SYNC_LOST_CBACK_EVT \
    50 /*!< \brief LE periodic advertising synch lost event */
...
#define HCI_LE_EXT_SCAN_ENABLE_CMD_CMPL_CBACK_EVT \
    54 /*!< \brief LE extended scan enable command complete  */
#define HCI_LE_EXT_ADV_ENABLE_CMD_CMPL_CBACK_EVT \
    55 /*!< \brief LE extended advertise enable command complete  */
#define HCI_LE_PER_ADV_ENABLE_CMD_CMPL_CBACK_EVT \
    56 /*!< \brief LE periodic advertise enable command complete  */
#define HCI_LE_SET_RAND_ADDR_CMD_CMPL_CBACK_EVT \
    57 /*!< \brief LE set random address command complete  */
#define HCI_LE_PER_SYNC_TRSF_RCVD_CBACK_EVT \
    58 /*!< \brief LE periodic advertising sync transfer received event */
#define HCI_LE_PER_ADV_SYNC_TRSF_CMD_CMPL_CBACK_EVT \
    59 /*!< \brief LE periodic advertising sync transfer command complete  */
#define HCI_LE_PER_ADV_SET_INFO_TRSF_CMD_CMPL_CBACK_EVT \
    60 /*!< \brief LE set periodic advertising set info transfer command complete  */
...
#define HCI_LE_SET_CONN_CTE_RX_PARAMS_CMD_CMPL_CBACK_EVT \
    63 /*!< \brief LE set connection CTE receive parameters command complete */
#define HCI_LE_SET_CONN_CTE_TX_PARAMS_CMD_CMPL_CBACK_EVT \
    64 /*!< \brief LE set connection CTE transmit parameters command complete */
#define HCI_LE_CONN_CTE_REQ_ENABLE_CMD_CMPL_CBACK_EVT \
    65 /*!< \brief LE connection CTE request enable command complete */
#define HCI_LE_CONN_CTE_RSP_ENABLE_CMD_CMPL_CBACK_EVT \
    66 /*!< \brief LE connection CTE response enable  command complete */
#define HCI_LE_READ_ANTENNA_INFO_CMD_CMPL_CBACK_EVT \
    67 /*!< \brief LE read antenna information command complete */
...
#define HCI_LE_SET_CIG_PARAMS_CMD_CMPL_CBACK_EVT \
    72 /*!< \brief LE set CIG parameters command complete */
#define HCI_LE_REMOVE_CIG_CMD_CMPL_CBACK_EVT 73 /*!< \brief LE remove CIG command complete */
#define HCI_LE_SETUP_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT \
    74 /*!< \brief LE setup ISO data path command complete */
#define HCI_LE_REMOVE_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT \
    75 /*!< \brief LE remove ISO data path command complete */
#define HCI_CONFIG_DATA_PATH_CMD_CMPL_CBACK_EVT \
    76 /*!< \brief Configure data path command complete */
#define HCI_READ_LOCAL_SUP_CODECS_CMD_CMPL_CBACK_EVT \
    77 /*!< \brief Read local supported codecs command complete */
#define HCI_READ_LOCAL_SUP_CODEC_CAP_CMD_CMPL_CBACK_EVT \
    78 /*!< \brief Read local supported codec capabilities command complete */
#define HCI_READ_LOCAL_SUP_CTR_DLY_CMD_CMPL_CBACK_EVT \
    79 /*!< \brief Read local supported controller delay command complete */
...
typedef struct {
    ...
    uint32_t
        transLatMToSUsec; /*!< \brief The maximum time, in msec, for transmission of SDUs of all CISes from mater to slave. */
    uint32_t
        transLatSToMUsec; /*!< \brief The maximum time, in msec, for transmission of SDUs of all CISes from slave to master. */
...
typedef struct {
    ...
    uint8_t bigHandle; /*!< \brief BIG handle. */
    uint32_t
        transLatUsec; /*!< \brief The maximum time, in microseconds, for transmission of SDUs of all BISes. */
    uint8_t nse; /*!< \brief Number of Sub-Events in each BIS event in the BIG. */
    uint8_t bn; /*!< \brief Number of new payloads in each BIS event. */
    uint8_t pto; /*!< \brief Offset used for pre-transmissions. */
    uint8_t irc; /*!< \brief Number of times a payload is transmitted in a BIS event. */
...
typedef union {
    ...
    hciLeCreateConnCancelCmdCmplEvt_t
        leCreateConnCancelCmdCmpl; /*!< \brief LE create connection cancel command complete. */
    ...
    hciReadTxPwrLvlCmdCmplEvt_t
        readTxPwrLvlCmdCmpl; /*!< \brief Read Tx power level command complete. */
    hciReadRemoteVerInfoCmplEvt_t
        readRemoteVerInfoCmpl; /*!< \brief Read remote version information complete. */
    hciLeReadRemoteFeatCmplEvt_t leReadRemoteFeatCmpl; /*!< \brief LE read remote feature complete. */
    hciLeLtkReqReplCmdCmplEvt_t
        leLtkReqReplCmdCmpl; /*!< \brief LE LTK request reply command complete. */
    hciLeLtkReqNegReplCmdCmplEvt_t
        leLtkReqNegReplCmdCmpl; /*!< \brief LE LT request negative reply command complete. */
    ...
    hciLeReadPeerResAddrCmdCmplEvt_t
        leReadPeerResAddrCmdCmpl; /*!< \brief LE read peer resolvable address command complete. */
    hciLeReadLocalResAddrCmdCmplEvt_t
        leReadLocalResAddrCmdCmpl; /*!< \brief LE read local resolvable address command complete. */
    hciLeSetAddrResEnableCmdCmplEvt_t
        leSetAddrResEnableCmdCmpl; /*!< \brief LE set address resolution enable command complete. */
    hciLeAddDevToResListCmdCmplEvt_t
        leAddDevToResListCmdCmpl; /*!< \brief LE add device to resolving list command complete. */
    hciLeRemDevFromResListCmdCmplEvt_t
        leRemDevFromResListCmdCmpl; /*!< \brief LE remove device from resolving list command complete. */
    hciLeClearResListCmdCmplEvt_t
        leClearResListCmdCmpl; /*!< \brief LE clear resolving list command complete. */
    hciLeRemConnParamRepEvt_t
        leRemConnParamRepCmdCmpl; /*!< \brief LE Remo Connection Parameter Reply Command Complete. */
    hciLeRemConnParamNegRepEvt_t
        leRemConnParamNegRepCmdCmpl; /*!< \brief LE Remote Connection Parameter Negative Reply Command Complete. */
    hciLeReadDefDataLenEvt_t
        leReadDefDataLenCmdCmpl; /*!< \brief LE read default data length command complete. */
    hciLeWriteDefDataLenEvt_t
        leWriteDefDataLenCmdCmpl; /*!< \brief LE write default data length command complete. */
    hciLeSetDataLenEvt_t leSetDataLenCmdCmpl; /*!< \brief LE set data length command complete. */
    hciLeReadMaxDataLenEvt_t
        leReadMaxDataLenCmdCmpl; /*!< \brief LE read max data length command complete. */
    hciLeRemConnParamReqEvt_t
        leRemConnParamReq; /*!< \brief LE remote connection parameter request. */
    ...
    hciWriteAuthPayloadToCmdCmplEvt_t
        writeAuthPayloadToCmdCmpl; /*!< \brief Write authenticated payload to command complete. */
    hciAuthPayloadToExpiredEvt_t
        authPayloadToExpired; /*!< \brief Authenticated payload to expired. */
    ...
    hciLePerAdvSyncEstEvt_t
        lePerAdvSyncEst; /*!< \brief LE periodic advertising synchronization established. */
    hciLePerAdvReportEvt_t lePerAdvReport; /*!< \brief LE periodic advertising report. */
    hciLePerAdvSyncLostEvt_t
        lePerAdvSyncLost; /*!< \brief LE periodic advertising synchronization lost. */
    hciLeChSelAlgoEvt_t leChSelAlgo; /*!< \brief LE channel select algorithm. */
    HciLePerAdvSyncTrsfRcvdEvt_t
        lePerAdvSyncTrsfRcvd; /*!< \brief LE periodic advertising sync transfer received. */
    hciLePerAdvSyncTrsfCmdCmplEvt_t
        lePerAdvSyncTrsfCmdCmpl; /*!< \brief LE periodic advertising sync transfer command complete. */
    hciLePerAdvSetInfoTrsfCmdCmplEvt_t
        lePerAdvSetInfoTrsfCmdCmpl; /*!< \brief LE set periodic advertising set info transfer command complete. */
    ...
    hciLeSetConnCteRxParamsCmdCmplEvt_t
        leSetConnCteRxParamsCmdCmpl; /*!< \brief LE set connection CTE receive parameters command complete. */
    hciLeSetConnCteTxParamsCmdCmplEvt_t
        leSetConnCteTxParamsCmdCmpl; /*!< \brief LE set connection CTE transmit parameters command complete. */
    hciLeConnCteReqEnableCmdCmplEvt_t
        leConnCteReqEnableCmdCmpl; /*!< \brief LE connection CTE request enable command complete. */
    hciLeConnCteRspEnableCmdCmplEvt_t
        leConnCteRspEnableCmdCmpl; /*!< \brief LE connection CTE response enable command complete. */
    hciLeReadAntennaInfoCmdCmplEvt_t
        leReadAntennaInfoCmdCmpl; /*!< \brief LE read antenna information command complete. */
    hciLeSetCigParamsCmdCmplEvt_t
        leSetCigParamsCmdCmpl; /*!< \brief LE set CIG parameters command complete. */
    ...
    hciLeSetupIsoDataPathCmdCmplEvt_t
        leSetupIsoDataPathCmdCmpl; /*!< \brief LE setup ISO data path command complete. */
    hciLeRemoveIsoDataPathCmdCmplEvt_t
        leRemoveIsoDataPathCmdCmpl; /*!< \brief LE remove ISO data path command complete. */
    hciConfigDataPathCmdCmplEvt_t
        configDataPathCmdCmpl; /*!< \brief Config data path command complete. */
    hciReadLocalSupCodecsCmdCmplEvt_t
        readLocalSupCodecsCmdCmpl; /*!< \brief Read local supported codecs command complete. */
    hciReadLocalSupCodecCapCmdCmplEvt_t
        readLocalSupCodecCapCmdCmpl; /*!< \brief Read local supported codec capablitlies command complete. */
    hciReadLocalSupCtrDlyCmdCmplEvt_t
        readLocalSupCtrDlyCmdCmpl; /*!< \brief Read local supported controller delay command complete. */
...
typedef struct {
    ...
    uint8_t
        rteMToS; /*!< \brief Maximum number of times every PDU should be retransmitted from the master to slave. */
    uint8_t
        rteSToM; /*!< \brief Maximum number of times every PDU should be retransmitted from the slave to master. */
} HciCisCisParams_t;
...
typedef struct {
    ...
    uint32_t
        sduIntervalMToS; /*!< \brief The time interval between the start of consecutive SDUs from the master Host. */
    uint32_t
        sduIntervalSToM; /*!< \brief The time interval between the start of consecutive SDUs from the slave Host. */
    ...
    uint16_t
        transLatMToS; /*!< \brief Maximum time, in milliseconds, for an SDU to be transported from the master Controller to slave Controller. */
    uint16_t
        transLatSToM; /*!< \brief Maximum time, in milliseconds, for an SDU to be transported from the slave Controller to master Controller. */
...
typedef struct {
    ...
    uint8_t encrypt; /*!< \brief Unencrypted or Encrypted. */
    uint8_t
        bcstCode[HCI_BC_LEN]; /*!< \brief Session key code for encrypt and decrypt BIS payloads. */
