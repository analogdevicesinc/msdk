...
#define L2C_CONN_FAIL_KEY_SIZE \
    0x0007 /*!< \brief Connection refused insufficient encryption key size */
...
#define L2C_CONN_FAIL_ALLOCATED_SCID \
    0x000A /*!< \brief Connection refused source CID already allocated */
#define L2C_CONN_FAIL_UNACCEPT_PARAM \
    0x000B /*!< \brief Connection refused unacceptable parameters */
 ...
 */
/**@{*/
#define L2C_RECONFIG_FAIL_MTU \
    0x0001 /*!< \brief Enhanced Reconfiguration refuded - cannot reduce MTU. */
#define L2C_RECONFIG_FAIL_MPS \
    0x0002 /*!< \brief Enhanced Reconfiguration refuded - cannot reduce MPS on more than one channel. */
#define L2C_RECONFIG_FAIL_CID 0x0003 /*!< \brief Enhanced Reconfiguration refuded - invalid CID. */
#define L2C_RECONFIG_FAIL_PARAM \
    0x0004 /*!< \brief Enhanced Reconfiguration refuded - unacceptable parameters. */
/**@}*/
