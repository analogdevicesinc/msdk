...
#define ATT_UUID_11073_CERT_DATA \
    0x2A2A /*!< \brief IEEE 11073-20601 Regulatory Certification Data List */
...
#define ATT_UUID_SURFACE_DENS_KG_PER_SQ_M \
    0x2716 /*!< \brief surface density kilogram per square metre */
#define ATT_UUID_SPECIFIC_VOL_CU_M_PER_KG \
    0x2717 /*!< \brief specific volume cubic metre per kilogram */
#define ATT_UUID_CURRENT_DENS_AMP_PER_SQ_M \
    0x2718 /*!< \brief current density ampere per square metre */
#define ATT_UUID_MAG_FIELD_STR_AMP_PER_M \
    0x2719 /*!< \brief magnetic field strength ampere per metre */
#define ATT_UUID_AMOUNT_CONC_MOLE_PER_CU_M \
    0x271A /*!< \brief amount concentration mole per cubic metre */
#define ATT_UUID_MASS_CONC_KG_PER_CU_M \
    0x271B /*!< \brief mass concentration kilogram per cubic metre */
...
#define ATT_UUID_RADIONUCLIDE_BECQUEREL \
    0x2732 /*!< \brief activity referred to a radionuclide becquerel */
...
#define ATT_UUID_ANG_ACCEL_R_PER_SEC_SQD \
    0x2744 /*!< \brief angular acceleration radian per second squared */
#define ATT_UUID_HEAT_FLUX_DEN_W_PER_SQ_M \
    0x2745 /*!< \brief heat flux density watt per square metre */
#define ATT_UUID_HEAT_CAP_J_PER_K 0x2746 /*!< \brief heat capacity joule per kelvin */
#define ATT_UUID_SPEC_HEAT_CAP_J_PER_KG_K \
    0x2747 /*!< \brief specific heat capacity joule per kilogram kelvin */
#define ATT_UUID_SPEC_ENERGY_J_PER_KG 0x2748 /*!< \brief specific energy joule per kilogram */
#define ATT_UUID_THERMAL_COND_W_PER_M_K \
    0x2749 /*!< \brief thermal conductivity watt per metre kelvin */
#define ATT_UUID_ENERGY_DENSITY_J_PER_CU_M \
    0x274A /*!< \brief energy density joule per cubic metre */
#define ATT_UUID_ELEC_FIELD_STR_VOLT_PER_M \
    0x274B /*!< \brief electric field strength volt per metre */
#define ATT_UUID_ELEC_CHG_DENS_C_PER_CU_M \
    0x274C /*!< \brief electric charge density coulomb per cubic metre */
#define ATT_UUID_SURF_CHG_DENS_C_PER_SQ_M \
    0x274D /*!< \brief surface charge density coulomb per square metre */
#define ATT_UUID_ELEC_FLUX_DENS_C_PER_SQ_M \
    0x274E /*!< \brief electric flux density coulomb per square metre */
...
#define ATT_UUID_MOLAR_ENTROPY_J_PER_MOLE_K \
    0x2752 /*!< \brief molar entropy joule per mole kelvin */
...
#define ATT_UUID_RCE_W_PER_SQ_METER_STER \
    0x2756 /*!< \brief radiance watt per square meter steradian */
#define ATT_UUID_CATALYTIC_KATAL_PER_CU_M \
    0x2757 /*!< \brief catalytic activity concentration katal per cubic metre */
...
#define ATT_UUID_ARM_BASE \
    0x2E, 0xC7, 0x8A, 0x0E, 0x73, 0x90, 0xE1, 0x11, 0xC2, 0x08, 0x60, 0x27, 0x26, 0xE0
...
extern const uint8_t
    attChUserDescUuid[ATT_16_UUID_LEN]; /*!< \brief Characteristic User Description */
extern const uint8_t
    attCliChCfgUuid[ATT_16_UUID_LEN]; /*!< \brief Client Characteristic Configuration */
extern const uint8_t
    attSrvChCfgUuid[ATT_16_UUID_LEN]; /*!< \brief Server Characteristic Configuration */
extern const uint8_t
    attChPresFmtUuid[ATT_16_UUID_LEN]; /*!< \brief Characteristic Presentation Format */
...
extern const uint8_t
    attPpcpChUuid[ATT_16_UUID_LEN]; /*!< \brief Peripheral Preferred Connection Parameters */
...
extern const uint8_t
    attIeeeChUuid[ATT_16_UUID_LEN]; /*!< \brief IEEE 11073-20601 Regulatory Certification Data List */
...
extern const uint8_t
    attPlxscmChUuid[ATT_16_UUID_LEN]; /*!< \brief Pulse Oximeter Spot Check Measurement */
extern const uint8_t
    attPlxcmChUuid[ATT_16_UUID_LEN]; /*!< \brief Pulse Oximeter Continuous Measurement */
...
extern const uint8_t
    attCteMinLenChUuid[ATT_16_UUID_LEN]; /*!< \brief Constant Tone Extension minimum length */
extern const uint8_t
    attCteTxCntChUuid[ATT_16_UUID_LEN]; /*!< \brief Constant Tone Extension minimum transmit count */
extern const uint8_t
    attCteTxDurChUuid[ATT_16_UUID_LEN]; /*!< \brief Constant Tone Extension transmit duration */
