...
#define Curve_B_1                                                                                 \
    {                                                                                             \
        0x45, 0xFA, 0x65, 0xC5, 0xAD, 0xD4, 0xD4, 0x81, 0x9F, 0xF8, 0xAC, 0x65, 0x8B, 0x7A, 0xBD, \
            0x54, 0xFC, 0xBE, 0x97, 0x1C                                                          \
    }
#define Curve_B_2                                                                                 \
    {                                                                                             \
        0xB1, 0xB9, 0x46, 0xC1, 0xEC, 0xDE, 0xB8, 0xFE, 0x49, 0x30, 0x24, 0x72, 0xAB, 0xE9, 0xA7, \
            0x0F, 0xE7, 0x80, 0x9C, 0xE5, 0x19, 0x05, 0x21, 0x64                                  \
    }
#define Curve_B_3                                                                                 \
    {                                                                                             \
        0x4B, 0x60, 0xD2, 0x27, 0x3E, 0x3C, 0xCE, 0x3B, 0xF6, 0xB0, 0x53, 0xCC, 0xB0, 0x06, 0x1D, \
            0x65, 0xBC, 0x86, 0x98, 0x76, 0x55, 0xBD, 0xEB, 0xB3, 0xE7, 0x93, 0x3A, 0xAA, 0xD8,   \
            0x35, 0xC6, 0x5A                                                                      \
    }
#define Curve_B_4                                                                                 \
    {                                                                                             \
...
#define Curve_B_5                                                                                 \
    {                                                                                             \
        0xB4, 0xFF, 0x55, 0x23, 0x43, 0x39, 0x0B, 0x27, 0xBA, 0xD8, 0xBF, 0xD7, 0xB7, 0xB0, 0x44, \
            0x50, 0x56, 0x32, 0x41, 0xF5, 0xAB, 0xB3, 0x04, 0x0C, 0x85, 0x0A, 0x05, 0xB4          \
    }
...
#define Curve_G_1                                                                               \
    {                                                                                           \
        ...
        {                                                                                       \
            0x32, 0xFB, 0xC5, 0x7A, 0x37, 0x51, 0x23, 0x04, 0x12, 0xC9, 0xDC, 0x59, 0x7D, 0x94, \
                0x68, 0x31, 0x55, 0x28, 0xA6, 0x23                                              \
        }                                                                                       \
    }
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            0xF5, 0x51, 0xBF, 0x37, 0x68, 0x40, 0xB6, 0xCB, 0xCE, 0x5E, 0x31, 0x6B, 0x57, 0x33, \
                0xCE, 0x2B, 0x16, 0x9E, 0x0F, 0x7C, 0x4A, 0xEB, 0xE7, 0x8E, 0x9B, 0x7F, 0x1A,   \
                0xFE, 0xE2, 0x42, 0xE3, 0x4F                                                    \
        }                                                                                       \
    }
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            0xB8, 0xD4, 0x10, 0xFB, 0x8F, 0xD0, 0x47, 0x9C, 0x19, 0x54, 0x85, 0xA6, 0x48, 0xB4, \
                0x17, 0xFD, 0xA8, 0x08, 0x11, 0x0E, 0xFC, 0xFB, 0xA4, 0x5D, 0x65, 0xC4, 0xA3,   \
                0x26, 0x77, 0xDA, 0x3A, 0x48                                                    \
        }                                                                                       \
    }
...
#define Curve_N_1                                                                                 \
    {                                                                                             \
        0x57, 0x22, 0x75, 0xCA, 0xD3, 0xAE, 0x27, 0xF9, 0xC8, 0xF4, 0x01, 0x00, 0x00, 0x00, 0x00, \
            0x00, 0x00, 0x00, 0x00, 0x00, 0x01                                                    \
    }
#define Curve_N_2                                                                                 \
    {                                                                                             \
        0x31, 0x28, 0xD2, 0xB4, 0xB1, 0xC9, 0x6B, 0x14, 0x36, 0xF8, 0xDE, 0x99, 0xFF, 0xFF, 0xFF, \
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF                                  \
    }
#define Curve_N_3                                                                                 \
    {                                                                                             \
        0x51, 0x25, 0x63, 0xFC, 0xC2, 0xCA, 0xB9, 0xF3, 0x84, 0x9E, 0x17, 0xA7, 0xAD, 0xFA, 0xE6, \
            0xBC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF,   \
            0xFF, 0xFF, 0xFF                                                                      \
    }
#define Curve_N_4                                                                                 \
    {                                                                                             \
        0x41, 0x41, 0x36, 0xD0, 0x8C, 0x5E, 0xD2, 0xBF, 0x3B, 0xA0, 0x48, 0xAF, 0xE6, 0xDC, 0xAE, \
            0xBA, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,   \
            0xFF, 0xFF, 0xFF                                                                      \
    }
#define Curve_N_5                                                                                 \
    {                                                                                             \
        0x3D, 0x2A, 0x5C, 0x5C, 0x45, 0x29, 0xDD, 0x13, 0x3E, 0xF0, 0xB8, 0xE0, 0xA2, 0x16, 0xFF, \
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF          \
    }
...
#define Curve_B_5                                                                                  \
    {                                                                                              \
        0x270B39432355FFB4ull, 0x5044B0B7D7BFD8BAull, 0x0C04B3ABF5413256ull, 0x00000000B4050A85ull \
    }
...
#define Curve_N_5                                                                                  \
    {                                                                                              \
        0x13DD29455C5C2A3Dull, 0xFFFF16A2E0B8F03Eull, 0xFFFFFFFFFFFFFFFFull, 0x00000000FFFFFFFFull \
    }
...
static void vli_modAdd(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *right,
                       const uECC_word_t *mod);
static void vli_modSub(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *right,
                       const uECC_word_t *mod);
...
/* Input P = (x1, y1, Z), Q = (x2, y2, Z)
   ...
   or P => P', Q => P + Q
*/
static void XYcZ_add(uECC_word_t *RESTRICT X1, uECC_word_t *RESTRICT Y1, uECC_word_t *RESTRICT X2,
...
/* Input P = (x1, y1, Z), Q = (x2, y2, Z)
   ...
   or P => P - Q, Q => P + Q
*/
static void XYcZ_addC(uECC_word_t *RESTRICT X1, uECC_word_t *RESTRICT Y1, uECC_word_t *RESTRICT X2,
                      uECC_word_t *RESTRICT Y2)
{
    /* t1 = X1, t2 = Y1, t3 = X2, t4 = Y2 */
    uECC_word_t t5[uECC_WORDS];
...
static void EccPoint_mult(EccPoint *RESTRICT result, const EccPoint *RESTRICT point,
                          const uECC_word_t *RESTRICT scalar, const uECC_word_t *RESTRICT initialZ,
                          bitcount_t numBits)
{
    /* R0 and R1 */
...
static void mod_sqrt_secp224r1_rs(uECC_word_t *d1, uECC_word_t *e1, uECC_word_t *f1,
...
static void mod_sqrt_secp224r1_rss(uECC_word_t *d1, uECC_word_t *e1, uECC_word_t *f1,
                                   const uECC_word_t *d0, const uECC_word_t *e0,
                                   const uECC_word_t *f0, const bitcount_t j)
{
    bitcount_t i;
...
static void mod_sqrt_secp224r1_rm(uECC_word_t *d2, uECC_word_t *e2, uECC_word_t *f2,
                                  const uECC_word_t *c, const uECC_word_t *d0,
                                  const uECC_word_t *e0, const uECC_word_t *d1,
...
static void mod_sqrt_secp224r1_rp(uECC_word_t *d1, uECC_word_t *e1, uECC_word_t *f1,
                                  const uECC_word_t *c, const uECC_word_t *r)
{
    wordcount_t i;
    wordcount_t pow2i = 1;
...
static void vli_modAdd_n(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *right,
                         const uECC_word_t *mod)
{
...
static void vli_modMult_n(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *right)
{
    ...
    for (i = 0; i <= ((((bitcount_t)uECC_N_WORDS) << uECC_WORD_BITS_SHIFT) + (uECC_WORD_BITS - 1));
         ++i) {
...
static int uECC_sign_with_k(const uint8_t private_key[uECC_BYTES],
                            const uint8_t message_hash[uECC_BYTES], uECC_word_t k[uECC_N_WORDS],
...
int uECC_verify(const uint8_t public_key[uECC_BYTES * 2], const uint8_t hash[uECC_BYTES],
