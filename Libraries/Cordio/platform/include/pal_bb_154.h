...
enum {
    PAL_BB_154_FLAG_TX_AUTO_RX_ACK =
        (1 << 0), /*!< Automatically wait for ACK after transmit completes. */
    PAL_BB_154_FLAG_RX_AUTO_TX_ACK =
        (1 << 1), /*!< Automatically send ACK after receive completes. */
...
#define PAL_BB_154_FLAG_TX_RX_AUTO_ACK \
    (PAL_BB_154_FLAG_TX_AUTO_RX_ACK | PAL_BB_154_FLAG_RX_AUTO_TX_ACK)
...
#define PAL_BB_154_FC_FRAME_TYPE_CD_MASK \
    0x0001 /*!< Convenient way of checking if MAC command or data. */
#define PAL_BB_154_FC_FRAME_TYPE_CMD_MASK 0x0003 /*!< Convenient way of checking if MAC command. */
#define PAL_BB_154_FC_FRAME_TYPE(x) \
    (((x)&PAL_BB_154_FC_FRAME_TYPE_MASK) /*>> PAL_BB_154_FC_FRAME_TYPE_SHIFT*/) /*!< Optimized bit 0. */

#define PAL_BB_154_FC_SECURITY_ENABLED_SHIFT 3
#define PAL_BB_154_FC_SECURITY_ENABLED_MASK 0x0008
#define PAL_BB_154_FC_SECURITY_ENABLED(x) \
    (((x)&PAL_BB_154_FC_SECURITY_ENABLED_MASK) >> PAL_BB_154_FC_SECURITY_ENABLED_SHIFT)

#define PAL_BB_154_FC_FRAME_PENDING_SHIFT 4
#define PAL_BB_154_FC_FRAME_PENDING_MASK 0x0010
#define PAL_BB_154_FC_FRAME_PENDING(x) \
    (((x)&PAL_BB_154_FC_FRAME_PENDING_MASK) >> PAL_BB_154_FC_FRAME_PENDING_SHIFT)

#define PAL_BB_154_FC_ACK_REQUEST_SHIFT 5
#define PAL_BB_154_FC_ACK_REQUEST_MASK 0x0020
#define PAL_BB_154_FC_ACK_REQUEST(x) \
    (((x)&PAL_BB_154_FC_ACK_REQUEST_MASK) >> PAL_BB_154_FC_ACK_REQUEST_SHIFT)

#define PAL_BB_154_FC_PAN_ID_COMP_SHIFT 6
#define PAL_BB_154_FC_PAN_ID_COMP_MASK 0x0040
#define PAL_BB_154_FC_PAN_ID_COMP(x) \
    (((x)&PAL_BB_154_FC_PAN_ID_COMP_MASK) >> PAL_BB_154_FC_PAN_ID_COMP_SHIFT)

#define PAL_BB_154_FC_DST_ADDR_MODE_SHIFT 10
#define PAL_BB_154_FC_DST_ADDR_MODE_MASK 0x0C00
#define PAL_BB_154_FC_DST_ADDR_MODE(x) \
    (((x)&PAL_BB_154_FC_DST_ADDR_MODE_MASK) >> PAL_BB_154_FC_DST_ADDR_MODE_SHIFT)

#define PAL_BB_154_FC_FRAME_VERSION_SHIFT 12
#define PAL_BB_154_FC_FRAME_VERSION_MASK 0x3000
#define PAL_BB_154_FC_FRAME_VERSION(x) \
    (((x)&PAL_BB_154_FC_FRAME_VERSION_MASK) >> PAL_BB_154_FC_FRAME_VERSION_SHIFT)

#define PAL_BB_154_FC_SRC_ADDR_MODE_SHIFT 14
#define PAL_BB_154_FC_SRC_ADDR_MODE_MASK 0xC000
#define PAL_BB_154_FC_SRC_ADDR_MODE(x) \
    (((x)&PAL_BB_154_FC_SRC_ADDR_MODE_MASK) >> PAL_BB_154_FC_SRC_ADDR_MODE_SHIFT)

/*! \brief    Mask for checking legacy security */
#define PAL_BB_154_FC_LEGACY_SEC_TEST(x)                                                 \
    (((x) & (PAL_BB_154_FC_SECURITY_ENABLED_MASK | PAL_BB_154_FC_FRAME_VERSION_MASK)) == \
     PAL_BB_154_FC_SECURITY_ENABLED_MASK)

/*! \brief    Mask for checking frame pending processing based on ack. requested and being a MAC command frame */
#define PAL_BB_154_FC_FRAME_TYPE_FP_TEST \
    (PAL_BB_154_FC_ACK_REQUEST_MASK | PAL_BB_154_FC_FRAME_TYPE_CMD_MASK)

/*! \brief    Mask for checking ack. sending based on ack. requested and being a MAC command or data frame */
#define PAL_BB_154_FC_FRAME_TYPE_ACK_TEST \
    (PAL_BB_154_FC_ACK_REQUEST_MASK | PAL_BB_154_FC_FRAME_TYPE_CD_MASK)

#define PAL_BB_154_SCAN_MAX_PD_ENTRIES \
    16 /*!< Note - arbitrary number and could make it easy by sending all beacons using beacon notify indication. */
...
#define PAL_BB_154_aBaseSuperframeDuration \
    (PAL_BB_154_aBaseSlotDuration * PAL_BB_154_aNumSuperframeSlots)
...
#define PAL_BB_154_aMaxBeaconPayloadLength \
    (PAL_BB_154_aMaxPHYPacketSize - PAL_BB_154_aMaxBeaconOverhead)
...
#define PAL_BB_154_RX_ACK_TIMEOUT_SYMB                                                       \
    PAL_BB_154_aUnitBackoffPeriod + PAL_BB_154_aTurnaroundTime + PAL_BB_154_phySHRDuration + \
...
typedef uint8_t (*PalBb154RxIsr_t)(uint8_t *pBuf, uint16_t len, int8_t rssi, uint32_t timestamp,
                                   uint8_t flags);
