...
static const attsCccSet_t hidAppCccSet[HIDAPP_NUM_CCC_IDX] = {
    ...
    { HID_MOUSE_BOOT_IN_CH_CCC_HDL, ATT_CLIENT_CFG_NOTIFY,
      DM_SEC_LEVEL_NONE }, /* HIDAPP_MBI_CCC_HDL */
    { HID_KEYBOARD_BOOT_IN_CH_CCC_HDL, ATT_CLIENT_CFG_NOTIFY,
      DM_SEC_LEVEL_NONE }, /* HIDAPP_KBI_CCC_HDL */
    { HID_INPUT_REPORT_1_CH_CCC_HDL, ATT_CLIENT_CFG_NOTIFY,
      DM_SEC_LEVEL_NONE }, /* HIDAPP_IN_REMOTE_CCC_HDL */
    { HID_INPUT_REPORT_2_CH_CCC_HDL, ATT_CLIENT_CFG_NOTIFY,
      DM_SEC_LEVEL_NONE }, /* HIDAPP_IN_KEYBOARD_CCC_HDL */
    { HID_INPUT_REPORT_3_CH_CCC_HDL, ATT_CLIENT_CFG_NOTIFY,
      DM_SEC_LEVEL_NONE }, /* HIDAPP_IN_MOUSE_CCC_HDL */
...
static const hidReportIdMap_t hidAppReportIdSet[] = {
    /* type                       ID                            handle */
    { HID_REPORT_TYPE_INPUT, HIDAPP_REMOTE_REPORT_ID,
      HID_INPUT_REPORT_1_HDL }, /* Remote Input Report */
    { HID_REPORT_TYPE_INPUT, HIDAPP_KEYBOARD_REPORT_ID,
      HID_INPUT_REPORT_2_HDL }, /* Keyboard Input Report */
    { HID_REPORT_TYPE_OUTPUT, HIDAPP_KEYBOARD_REPORT_ID,
      HID_OUTPUT_REPORT_HDL }, /* Keyboard Output Report */
    { HID_REPORT_TYPE_FEATURE, HIDAPP_KEYBOARD_REPORT_ID,
      HID_FEATURE_REPORT_HDL }, /* Keyboard Feature Report */
    { HID_REPORT_TYPE_INPUT, HIDAPP_MOUSE_REPORT_ID,
      HID_INPUT_REPORT_3_HDL }, /* Mouse Input Report */
    { HID_REPORT_TYPE_INPUT, HID_KEYBOARD_BOOT_ID,
      HID_KEYBOARD_BOOT_IN_HDL }, /* Boot Keyboard Input Report */
    { HID_REPORT_TYPE_OUTPUT, HID_KEYBOARD_BOOT_ID,
      HID_KEYBOARD_BOOT_OUT_HDL }, /* Boot Keyboard Output Report */
    { HID_REPORT_TYPE_INPUT, HID_MOUSE_BOOT_ID,
      HID_MOUSE_BOOT_IN_HDL }, /* Boot Mouse Input Report */
};
...
static const hidConfig_t hidAppHidConfig = {
    ...
    sizeof(hidAppReportIdSet) /
        sizeof(hidReportIdMap_t), /* Size of Report ID to Attribute Handle map */
...
static void hidAppSetup(dmEvt_t *pMsg)
{
    ...
    AppAdvSetData(APP_ADV_DATA_DISCOVERABLE, sizeof(hidAppAdvDataDisc),
                  (uint8_t *)hidAppAdvDataDisc);
    AppAdvSetData(APP_SCAN_DATA_DISCOVERABLE, sizeof(hidAppScanDataDisc),
                  (uint8_t *)hidAppScanDataDisc);

    /* set advertising and scan response data for connectable mode */
    AppAdvSetData(APP_ADV_DATA_CONNECTABLE, sizeof(hidAppAdvDataDisc),
                  (uint8_t *)hidAppAdvDataDisc);
    AppAdvSetData(APP_SCAN_DATA_CONNECTABLE, sizeof(hidAppScanDataDisc),
                  (uint8_t *)hidAppScanDataDisc);
    ...
    if (AttsCccEnabled(connId, HIDAPP_IN_REMOTE_CCC_HDL)) {
        if (hidAppCb.txFlags & HIDAPP_TX_FLAGS_PENDING) {
            if (hidAppCb.txFlags & HIDAPP_TX_FLAGS_READY) {
                ...
                /* Send the message */
                HidSendInputReport(connId, hidAppCb.reportId, HIDAPP_REMOTE_INPUT_REPORT_LEN,
                                   &buffer);
            }
        }
    } else {
