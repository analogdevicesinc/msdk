...
#define BB_BLE_PDU_FILT_FLAG_IS_SET(pFilt, flag) \
 ...
 */
/*************************************************************************************************/
static inline void BbBlePduFiltResultsGetPeerIdAddr(const bbBlePduFiltResults_t *pFiltResults,
                                                    uint64_t *pPeerIdAddr, uint8_t *pPeerIdAddrType)
{
 ...
 */
/*************************************************************************************************/
static inline void BbBlePduFiltResultsGetPeerRpa(const bbBlePduFiltResults_t *pFiltResults,
                                                 uint64_t *pPeerRpa)
{
    *pPeerRpa = 0;
    if ((pFiltResults->peerIdAddrRand != pFiltResults->peerAddrRand) ||
