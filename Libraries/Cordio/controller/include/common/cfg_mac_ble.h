...
#ifndef LL_MAX_CIS
#define LL_MAX_CIS \
    6 /*!< Absolute maximum number of connected isochronous streams, it is shared by CIGs. */
#endif
...
#ifndef LL_MAX_BIS
#define LL_MAX_BIS \
    6 /*!< Absolute maximum number of broadcast isochronous streams, it is shared by BIGs. */
#endif
...
#define SCH_RM_MAX_RSVN                           \
    (LL_MAX_CONN + LL_MAX_ADV_SETS + LL_MAX_CIG + \
     LL_MAX_BIG) /*!< Maximum number of reservations (maximum is 32). */
#endif

/*** Baseband ***/

#ifndef BB_DATA_PLD_MAX_LEN
#define BB_DATA_PLD_MAX_LEN \
    251 /*!< Maximum data channel payload length (valid range 27 to 251, exclude MIC). */
#endif

#ifndef BB_ADV_PLD_MAX_LEN
#define BB_ADV_PLD_MAX_LEN \
    255 /*!< Maximum advertising channel payload length (valid range 95 to 255). */
#endif

#ifndef BB_FIXED_DATA_PKT_LEN
#define BB_FIXED_DATA_PKT_LEN \
    0 /*!< Fixed packet length required for BB data receive buffers (0 to disable). */
#endif

#ifndef BB_FIXED_ADVB_PKT_LEN
#define BB_FIXED_ADVB_PKT_LEN \
    0 /*!< Fixed packet length required for BB advertisement receive buffers (0 to disable). */
#endif
...
#define BB_ENABLE_INLINE_ENC_TX \
    0 /*!< Enable inline encryption mode. Not available for all projects. */
#endif

#ifndef BB_ENABLE_INLINE_DEC_RX
#define BB_ENABLE_INLINE_DEC_RX \
    0 /*!< Enable inline decryption mode. Not available for all projects. */
#endif
