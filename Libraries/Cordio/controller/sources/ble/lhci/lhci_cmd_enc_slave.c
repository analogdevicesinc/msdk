 ...
 */
/*************************************************************************************************/
static uint8_t lhciPackReadAuthPayloadTimeoutEvt(uint8_t *pBuf, uint8_t status, uint16_t handle,
                                                 uint16_t timeout)
{
 ...
 */
/*************************************************************************************************/
static void lhciSlvEncSendCmdCmplEvt(LhciHdr_t *pCmdHdr, uint8_t status, uint8_t paramLen,
                                     uint8_t *pParam, uint16_t handle)
{
    uint8_t *pBuf;
    uint8_t *pEvtBuf;
