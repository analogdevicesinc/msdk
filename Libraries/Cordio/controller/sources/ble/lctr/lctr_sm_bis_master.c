...
static const lctrMstBigActFn_t
    lctrMstBigActionTbl[LCTR_MST_BIG_STATE_TOTAL][LCTR_MST_BIG_MSG_TOTAL] = {
        {
...
{
    LL_TRACE_INFO3("lctrMstBigExecuteSm: bigHandle=%u, state=%u, event=%u", pBigCtx->handle,
                   pBigCtx->state, event);
