...
static const lctrCreateSyncActFn_t
    lctrCreateSyncActionTbl[LCTR_CREATE_SYNC_STATE_TOTAL][LCTR_CREATE_SYNC_MSG_TOTAL] = {
        {
...
static const uint8_t
    lctrCreateSyncNextStateTbl[LCTR_CREATE_SYNC_STATE_TOTAL][LCTR_CREATE_SYNC_MSG_TOTAL] = {
        {
            /* LCTR_CREATE_SYNC_STATE_DISABLED */
...
static const lctrCreateSyncActFn_t
    lctrTransferSyncActionTbl[LCTR_TRANSFER_SYNC_STATE_TOTAL][LCTR_TRANSFER_SYNC_MSG_TOTAL] = {
        {
...
static const uint8_t
    lctrTransferSyncNextStateTbl[LCTR_TRANSFER_SYNC_STATE_TOTAL][LCTR_TRANSFER_SYNC_MSG_TOTAL] = {
        {
            /* LCTR_TRANSFER_SYNC_STATE_DISABLED  */
...
static const lctrPerScanActFn_t
    lctrPerScanActionTbl[LCTR_PER_SCAN_STATE_TOTAL][LCTR_PER_SCAN_MSG_TOTAL] = {
        {
...
{
    LL_TRACE_INFO3("lctrMstExtScanExecuteSm: phy=%u, state=%u, event=%u",
                   LCTR_GET_EXT_SCAN_HANDLE(pExtScanCtx), pExtScanCtx->state, event);
...
{
    LL_TRACE_INFO2("lctrMstCreateSyncExecuteSm: state=%u, event=%u", lctrPerCreateSync.state,
                   event);
...
{
    LL_TRACE_INFO2("lctrMstTransferSyncExecuteSm: state=%u, event=%u", lctrPerTransferSync.state,
                   event);
