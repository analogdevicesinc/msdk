...
static const lctrActFn_t
    lctrMstCisEstActionTbl[LCTR_CIS_MST_EST_STATE_TOTAL][LCTR_CIS_MST_EST_EVENT_TOTAL] = {
        {
            /* LCTR_CIS_MST_EST_STATE_IDLE */
            lctrMstCisLlcpActHostCisReq, /* LCTR_CIS_MST_EST_EVENT_HOST_CIS_REQ */
            lctrMstCisLlcpActRejectCollision,
            /* LCTR_CIS_MST_EST_EVENT_PEER_CIS_RSP */ /* Shall not happen */
            lctrMstCisLlcpActRejectCollision,
            /* LCTR_CIS_MST_EST_EVENT_PEER_REJECT */ /* Shall not happen */
            NULL, /* LCTR_CIS_MST_EST_EVENT_RSP_TIMEOUT */ /* Shall not happen */
            NULL,
            /* LCTR_CIS_MST_EST_EVENT_LOCAL_REJECT */ /* Shall not happen */
        },
        {
...
static const uint8_t
    lctrMstCisEstNextStateTbl[LCTR_CIS_MST_EST_STATE_TOTAL][LCTR_CIS_MST_EST_EVENT_TOTAL] = {
        {
            /* LCTR_CIS_MST_EST_STATE_IDLE */
...
static void lctrResolveCollision(lctrConnCtx_t *pCtx, uint8_t event)
{
    ...
    case LCTR_CIS_MST_EST_EVENT_HOST_CIS_REQ:
        ...
        pCtx->llcpPendMask |= 1 << LCTR_PROC_CIS_EST;
        LL_TRACE_INFO2("Pending CIS_REQ=%u procedure: activeProc=%u", LCTR_PROC_CIS_EST,
                       pCtx->llcpActiveProc);
        break;
...
bool_t lctrMstLlcpExecuteCisEstSm(lctrConnCtx_t *pCtx, uint8_t event)
{
    ...
    case LCTR_LLCP_STATE_IDLE:
        LL_TRACE_INFO3(
            "lctrMstLlcpExecuteCisEstSm: cis_handle=%u, llcpState=IDLE, estState=%u, event=%u",
    ...
    case LCTR_LLCP_STATE_BUSY:
        LL_TRACE_INFO3(
            "lctrMstLlcpExecuteCisEstSm: cis_handle=%u, llcpState=BUSY, estState=%u, event=%u",
            pCisCtx->cisHandle, pCisCtx->estState, event);
