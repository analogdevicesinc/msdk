...
typedef union mmdl_events_tag {
    ...
    mmdlGenBatteryClStatusEvent_t
        mmdlGenBatteryClStatusEvent; /*!< MMDL_GEN_BATTERY_CL_STATUS_EVENT */
    mmdlGenBatterySrCurrentState_t
        mmdlGenBatterySrCurrentState; /*!< MMDL_GEN_BATTERY_SR_CURRENT_STATE_EVENT */
    mmdlGenBatterySrStateUpdate_t
        mmdlGenBatterySrStateUpdate; /*!< MMDL_GEN_BATTERY_SR_STATE_UPDATE_EVENT */
    mmdlGenDefaultTransClStatusEvent_t
        mmdlGenDefaultTransClStatusEvent; /*!< MMDL_GEN_DEFAULT_TRANS_CL_STATUS_EVENT */
    mmdlGenDefaultTransSrCurrentState_t
        mmdlGenDefaultTransSrCurrentState; /*!< MMDL_GEN_DEFAULT_TRANS_SR_CURRENT_STATE_EVENT */
    mmdlGenDefaultTransSrStateUpdate_t
        mmdlGenDefaultTransSrStateUpdate; /*!< MMDL_GEN_DEFAULT_TRANS_SR_STATE_UPDATE_EVENT */
    mmdlGenLevelClStatusEvent_t mmdlGenLevelClStatusEvent; /*!< MMDL_GEN_LEVEL_CL_STATUS_EVENT */
    mmdlGenLevelSrCurrentState_t
        mmdlGenLevelSrCurrentState; /*!< MMDL_GEN_LEVEL_SR_CURRENT_STATE_EVENT */
    mmdlGenLevelSrStateUpdate_t
        mmdlGenLevelSrStateUpdate; /*!< MMDL_GEN_LEVEL_SR_STATE_UPDATE_EVENT */
    mmdlGenOnOffClStatusEvent_t mmdlGenOnOffClStatusEvent; /*!< MMDL_GEN_ONOFF_CL_STATUS_EVENT */
    mmdlGenOnOffSrCurrentState_t
        mmdlGenOnOffSrCurrentState; /*!< MMDL_GEN_ONOFF_SR_CURRENT_STATE_EVENT */
    mmdlGenOnOffSrStateUpdate_t
        mmdlGenOnOffSrStateUpdate; /*!< MMDL_GEN_ONOFF_SR_STATE_UPDATE_EVENT */
    mmdlGenPowOnOffClStatusEvent_t
        mmdlGenPowOnOffClStatusEvent; /*!< MMDL_GEN_POWER_ONOFF_CL_STATUS_EVENT */
    mmdlGenPowOnOffSrCurrentState_t
        mmdlGenPowOnOffSrCurrentState; /*!< MMDL_GEN_POWER_ONOFF_SR_CURRENT_STATE_EVENT */
    mmdlGenPowOnOffSrStateUpdate_t
        mmdlGenPowOnOffSrStateUpdate; /*!< MMDL_GEN_POWER_ONOFF_SR_STATE_UPDATE_EVENT */
    mmdlGenPowerDefaultClStatusEvent_t
        mmdlGenPowerDefaultClStatusEvent; /*!< MMDL_GEN_POWER_DEFAULT_CL_STATUS_EVENT */
    mmdlGenPowerLastClStatusEvent_t
        mmdlGenPowerLastClStatusEvent; /*!< MMDL_GEN_POWER_LAST_CL_STATUS_EVENT */
    mmdlGenPowerLevelClStatusEvent_t
        mmdlGenPowerLevelClStatusEvent; /*!< MMDL_GEN_POWER_LEVEL_CL_STATUS_EVENT */
    mmdlGenPowerRangeClStatusEvent_t
        mmdlGenPowerRangeClStatusEvent; /*!< MMDL_GEN_POWER_RANGE_CL_STATUS_EVENT */
    mmdlGenPowerLevelSrCurrentState_t
        mmdlGenPowerLevelSrCurrentState; /*!< MMDL_GEN_POWER_DEFAULT_SR_CURRENT_STATE_EVENT
    ...
    mmdlGenPowerLevelSrStateUpdate_t
        mmdlGenPowerLevelSrStateUpdate; /*!< MMDL_GEN_POWER_DEFAULT_SR_STATE_UPDATE_EVENT
    ...
    mmdlLightLightnessSrCurrentState_t
        mmdlLightLightnessSrCurrentState; /*!< MMDL_LIGHT_LIGHTNESS_SR_CURRENT_STATE_EVENT
    ...
    mmdlLightLightnessSrStateUpdate_t
        mmdlLightLightnessSrStateUpdate; /*!< MMDL_LIGHT_LIGHTNESS_SR_STATE_UPDATE_EVENT
    ...
    mmdlLightHslClDefStatusEvent_t
        mmdlLightHslClDefStatusEvent; /*!< MMDL_LIGHT_HSL_CL_DEF_STATUS_EVENT */
    mmdlLightHslClHueStatusEvent_t
        mmdlLightHslClHueStatusEvent; /*!< MMDL_LIGHT_HSL_CL_HUE_STATUS_EVENT */
    mmdlLightHslClRangeStatusEvent_t
        mmdlLightHslClRangeStatusEvent; /*!< MMDL_LIGHT_HSL_CL_RANGE_STATUS_EVENT */
    mmdlLightHslClSatStatusEvent_t
        mmdlLightHslClSatStatusEvent; /*!< MMDL_LIGHT_HSL_CL_SAT_STATUS_EVENT */
    mmdlLightHslClStatusEvent_t mmdlLightHslClStatusEvent; /*!< MMDL_LIGHT_HSL_CL_STATUS_EVENT */
    mmdlLightHslClStatusEvent_t
        mmdlLightHslClTargetStatusEvent; /*!< MMDL_LIGHT_HSL_CL_TARGET_STATUS_EVENT */
    mmdlLightHslHueSrStateUpdate_t
        mmdlLightHslHueSrStateUpdate; /*!< MMDL_LIGHT_HSL_HUE_SR_STATE_UPDATE_EVENT */
    mmdlLightHslSatSrStateUpdate_t
        mmdlLightHslSatSrStateUpdate; /*!< MMDL_LIGHT_HSL_SAT_SR_STATE_UPDATE_EVENT */
    mmdlLightHslSrStateUpdate_t
        mmdlLightHslSrStateUpdate; /*!< MMDL_LIGHT_HSL_SR_STATE_UPDATE_EVENT */
    ...
    mmdlSchedulerClActionStatusEvent_t
        mmdlSchedulerClActionStatusEvent; /*!< MMDL_SCHEDULER_CL_ACTION_STATUS_EVENT */
    ...
    mmdlSchedulerSrStartScheduleEvent_t
        mmdlSchedulerSrStartScheduleEvent; /*!< MMDL_SCHEDULER_SR_START_SCHEDULE_EVENT */
    mmdlSchedulerSrStopScheduleEvent_t
        mmdlSchedulerSrStopScheduleEvent; /*!< MMDL_SCHEDULER_SR_STOP_SCHEDULE_EVENT*/
