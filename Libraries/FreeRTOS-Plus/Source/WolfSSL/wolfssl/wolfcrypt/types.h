...
#if (defined(__alpha__) || defined(__ia64__) || defined(_ARCH_PPC64) || defined(__mips64) || \
     defined(__x86_64__))
...
#elif !defined(MICRIUM_MALLOC) && !defined(EBSNET) && !defined(WOLFSSL_SAFERTOS) && \
    !defined(FREESCALE_MQX) && !defined(WOLFSSL_LEANPSK)
