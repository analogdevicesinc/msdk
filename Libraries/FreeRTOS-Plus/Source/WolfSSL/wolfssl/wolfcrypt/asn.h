...
enum ASN_Flags { ASN_CONSTRUCTED = 0x20, ASN_CONTEXT_SPECIFIC = 0x80 };
...
enum ENCRYPTION_TYPES { DES_TYPE = 0, DES3_TYPE = 1, RC4_TYPE = 2 };
...
enum Oid_Types { hashType = 0, sigType = 1, keyType = 2, curveType = 3, blkType = 4 };

enum Hash_Sum { MD2h = 646, MD5h = 649, SHAh = 88, SHA256h = 414, SHA384h = 415, SHA512h = 416 };

enum Block_Sum { DESb = 69, DES3b = 652 };

enum Key_Sum { DSAk = 515, RSAk = 645, NTRUk = 274, ECDSAk = 518 };
...
enum VerifyType { NO_VERIFY = 0, VERIFY = 1 };
