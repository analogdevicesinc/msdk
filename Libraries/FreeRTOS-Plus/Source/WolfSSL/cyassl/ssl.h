...
#define CyaSSL_CTX_set_psk_client_callback wolfSSL_CTX_set_psk_client_callback /**/
#define CyaSSL_CTX_set_psk_server_callback wolfSSL_CTX_set_psk_server_callback /**/
