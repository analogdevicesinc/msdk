...
#if defined(_WIN32) && !defined(MICRIUM) && !defined(FREERTOS) && !defined(EBSNET) && \
    !defined(CYASSL_EROAD)
#define USE_WINDOWS_API
#endif
...
#define XSTRNCPY(pstr_dest, pstr_src, len_max) \
    ((CPU_CHAR *)Str_Copy_N((CPU_CHAR *)(pstr_dest), (CPU_CHAR *)(pstr_src), (CPU_SIZE_T)(len_max)))
#define XSTRNCMP(pstr_1, pstr_2, len_max) \
    ((CPU_INT16S)Str_Cmp_N((CPU_CHAR *)(pstr_1), (CPU_CHAR *)(pstr_2), (CPU_SIZE_T)(len_max)))
#define XSTRSTR(pstr, pstr_srch) ((CPU_CHAR *)Str_Str((CPU_CHAR *)(pstr), (CPU_CHAR *)(pstr_srch)))
...
#define XMEMCMP(pmem_1, pmem_2, size)                                                          \
    (((CPU_BOOLEAN)Mem_Cmp((void *)(pmem_1), (void *)(pmem_2), (CPU_SIZE_T)(size))) ? DEF_NO : \
                                                                                      DEF_YES)
...
#define XMALLOC(s, h, type) \
    ((void *)NetSecure_BlkGet((CPU_INT08U)(type), (CPU_SIZE_T)(s), (void *)0))
#define XFREE(p, h, type) (NetSecure_BlkFree((CPU_INT08U)(type), (p), (void *)0))
#define XREALLOC(p, n, h, t) realloc((p), (n))
#endif
...
#if !defined(XMALLOC_USER) && !defined(MICRIUM_MALLOC) && !defined(CYASSL_LEANPSK) && \
    !defined(NO_CYASSL_MEMORY)
