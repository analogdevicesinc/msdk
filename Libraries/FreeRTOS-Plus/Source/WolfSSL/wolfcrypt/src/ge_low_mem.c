...
static const byte ed25519_order[F25519_SIZE] = { 0xed, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58,
...
static const word32 m[32] = { 0xED, 0xD3, 0xF5, 0x5C, 0x1A, 0x63, 0x12, 0x58, 0xD6, 0x9C, 0xF7,
                              0xA2, 0xDE, 0xF9, 0xDE, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                              0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10 };

static const word32 mu[33] = { 0x1B, 0x13, 0x2C, 0x0A, 0xA3, 0xE5, 0x9C, 0xED, 0xA7, 0x29, 0x63,
...
static void reduce_add_sub(word32 *r)
{
    ...
    mask = b - 1;
    for (i = 0; i < 32; i++) r[i] ^= mask & (r[i] ^ t[i]);
}
...
const ge_p3 ed25519_neutral = { .X = { 0 }, .Y = { 1, 0 }, .T = { 0 }, .Z = { 1, 0 } };

static const byte ed25519_d[F25519_SIZE] = { 0xa3, 0x78, 0x59, 0x13, 0xca, 0x4d, 0xeb, 0x75,
                                             0xab, 0xd8, 0x41, 0x41, 0x4d, 0x0a, 0x70, 0x00,
                                             0x98, 0xe8, 0x79, 0x77, 0x79, 0x40, 0xc7, 0x8c,
                                             0x73, 0xfe, 0x6f, 0x2b, 0xee, 0x6c, 0x03, 0x52 };

/* k = 2d */
static const byte ed25519_k[F25519_SIZE] = { 0x59, 0xf1, 0xb2, 0x26, 0x94, 0x9b, 0xd6, 0xeb,
...
int ge_double_scalarmult_vartime(ge_p2 *R, const unsigned char *h, const ge_p3 *inA,
