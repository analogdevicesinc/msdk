...
#define MULX_INIT(a0, c0, cy)                                    \
    __asm__ volatile("xorq  %%r10, %%r10\n\t"                    \
                     ...
                     : "+m"(c0)                                  \
                     : "r"(a0), "r"(cy)                          \
                     : "%r8", "%r9", "%r10", "%r11", "%r12", "%rdx");

#define MULX_INNERMUL_R1(c0, c1, pre, rdx)                                \
    {                                                                     \
        __asm__ volatile("movq  %3, %%rdx\n\t"                            \
                         "mulx  %%r11,%%r9, %%r8 \n\t"                    \
                         "movq  %2, %%r12\n\t"                            \
                         "adoxq  %%r9,%0     \n\t"                        \
                         "adcxq  %%r8,%1     \n\t"                        \
...
#define INNERMUL                                                                   \
    do {                                                                           \
        fp_word t;                                                                 \
        t = ((fp_word)_c[0] + (fp_word)cy) + (((fp_word)mu) * ((fp_word)*tmpm++)); \
        _c[0] = (fp_digit)t;                                                       \
