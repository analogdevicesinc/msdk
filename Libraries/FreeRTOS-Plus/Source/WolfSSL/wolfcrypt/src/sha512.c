...
{
    if (set_cpuid_flags(CHECK_SHA512))
        return;
...
static INLINE ROTR(rotrFixed64_28, 28, x) static INLINE ROTR(rotrFixed64_34, 34, x) static INLINE
    ROTR(rotrFixed64_39, 39, x) static INLINE ROTR(rotrFixed64_14, 14, x) static INLINE
    ROTR(rotrFixed64_18, 18, x) static INLINE ROTR(rotrFixed64_41, 41, x)
...
static const word64 K512[80] = {
    W64LIT(0x428a2f98d728ae22), W64LIT(0x7137449123ef65cd), W64LIT(0xb5c0fbcfec4d3b2f),
    W64LIT(0xe9b5dba58189dbbc), W64LIT(0x3956c25bf348b538), W64LIT(0x59f111f1b605d019),
    W64LIT(0x923f82a4af194f9b), W64LIT(0xab1c5ed5da6d8118), W64LIT(0xd807aa98a3030242),
    W64LIT(0x12835b0145706fbe), W64LIT(0x243185be4ee4b28c), W64LIT(0x550c7dc3d5ffb4e2),
    W64LIT(0x72be5d74f27b896f), W64LIT(0x80deb1fe3b1696b1), W64LIT(0x9bdc06a725c71235),
    W64LIT(0xc19bf174cf692694), W64LIT(0xe49b69c19ef14ad2), W64LIT(0xefbe4786384f25e3),
    W64LIT(0x0fc19dc68b8cd5b5), W64LIT(0x240ca1cc77ac9c65), W64LIT(0x2de92c6f592b0275),
    W64LIT(0x4a7484aa6ea6e483), W64LIT(0x5cb0a9dcbd41fbd4), W64LIT(0x76f988da831153b5),
    W64LIT(0x983e5152ee66dfab), W64LIT(0xa831c66d2db43210), W64LIT(0xb00327c898fb213f),
    W64LIT(0xbf597fc7beef0ee4), W64LIT(0xc6e00bf33da88fc2), W64LIT(0xd5a79147930aa725),
    W64LIT(0x06ca6351e003826f), W64LIT(0x142929670a0e6e70), W64LIT(0x27b70a8546d22ffc),
    W64LIT(0x2e1b21385c26c926), W64LIT(0x4d2c6dfc5ac42aed), W64LIT(0x53380d139d95b3df),
    W64LIT(0x650a73548baf63de), W64LIT(0x766a0abb3c77b2a8), W64LIT(0x81c2c92e47edaee6),
    W64LIT(0x92722c851482353b), W64LIT(0xa2bfe8a14cf10364), W64LIT(0xa81a664bbc423001),
    W64LIT(0xc24b8b70d0f89791), W64LIT(0xc76c51a30654be30), W64LIT(0xd192e819d6ef5218),
    W64LIT(0xd69906245565a910), W64LIT(0xf40e35855771202a), W64LIT(0x106aa07032bbd1b8),
    W64LIT(0x19a4c116b8d2d0c8), W64LIT(0x1e376c085141ab53), W64LIT(0x2748774cdf8eeb99),
    W64LIT(0x34b0bcb5e19b48a8), W64LIT(0x391c0cb3c5c95a63), W64LIT(0x4ed8aa4ae3418acb),
    W64LIT(0x5b9cca4f7763e373), W64LIT(0x682e6ff3d6b2b8a3), W64LIT(0x748f82ee5defb2fc),
    W64LIT(0x78a5636f43172f60), W64LIT(0x84c87814a1f0ab72), W64LIT(0x8cc702081a6439ec),
    W64LIT(0x90befffa23631e28), W64LIT(0xa4506cebde82bde9), W64LIT(0xbef9a3f7b2c67915),
    W64LIT(0xc67178f2e372532b), W64LIT(0xca273eceea26619c), W64LIT(0xd186b8c721c0c207),
    W64LIT(0xeada7dd6cde0eb1e), W64LIT(0xf57d4f7fee6ed178), W64LIT(0x06f067aa72176fba),
    W64LIT(0x0a637dc5a2c898a6), W64LIT(0x113f9804bef90dae), W64LIT(0x1b710b35131c471b),
    W64LIT(0x28db77f523047d84), W64LIT(0x32caab7b40c72493), W64LIT(0x3c9ebe0a15c9bebc),
    W64LIT(0x431d67c49c100d4c), W64LIT(0x4cc5d4becb3e42b6), W64LIT(0x597f299cfc657e2a),
...
#define R2(i)                                                                       \
    h(i) += S1(e(i)) + Ch(e(i), f(i), g(i)) + K[i + j] + (j ? blk2(i) : blk384(i)); \
    d(i) += h(i);                                                                   \
    h(i) += S0(a(i)) + Maj(a(i), b(i), c(i))
...
int wc_Sha512Final(Sha512 *sha512, byte *hash)
{
    ...
    /* put lengths in bits */
    sha512->hiLen = (sha512->loLen >> (8 * sizeof(sha512->loLen) - 3)) + (sha512->hiLen << 3);
...
#define _DUMP_REG(REG, name)                                                      \
    {                                                                             \
        ...
        printf(" " #name ":\t");                                                  \
        for (k = 0; k < 2; k++) printf("%016lx.", (word64)(buf[k]));              \
        printf("\n");                                                             \
        RECV_REG(0);                                                              \
        RECV_REG(1);                                                              \
        RECV_REG(2);                                                              \
...
#define _MOVE_to_MEM(mem, i, xymm)                                       \
    __asm__ volatile("vmovdqu %%" #xymm ", %0"                           \
                     : "=m"(mem[i]), "=m"(mem[i + 1]), "=m"(mem[i + 2]), \
                       "=m"(mem[i + 3])::XMM_REGs);
...
#define _S_TEMP(dest, src, bits, temp)                                                            \
    __asm__ volatile("vpsrlq  $" #bits ", %%" #src ", %%" #dest "\n\tvpsllq  $64-" #bits          \
                     ", %%" #src ", %%" #temp "\n\tvpor %%" #temp ",%%" #dest ", %%" #dest " " :: \
                         : XMM_REGs);
#define _AVX1_R(dest, src, bits) \
    __asm__ volatile("vpsrlq  $" #bits ", %%" #src ", %%" #dest " " ::: XMM_REGs);
#define _XOR(dest, src1, src2) \
    __asm__ volatile("vpxor   %%" #src1 ", %%" #src2 ", %%" #dest " " ::: XMM_REGs);
#define _OR(dest, src1, src2) \
    __asm__ volatile("vpor    %%" #src1 ", %%" #src2 ", %%" #dest " " ::: XMM_REGs);
#define _ADD(dest, src1, src2) \
    __asm__ volatile("vpaddq   %%" #src1 ", %%" #src2 ", %%" #dest " " ::: XMM_REGs);
#define _ADD_MEM(dest, src1, mem) \
    __asm__ volatile("vpaddq   %0, %%" #src1 ", %%" #dest " " ::"m"(mem) : XMM_REGs);
...
#define Init_Mask(mask) __asm__ volatile("vmovdqu %0, %%xmm1\n\t" ::"m"(mask) : "%xmm1");
...
#define s0_2(dest, src)     \
    AVX1_S(G_TEMP, src, 8); \
    XOR(dest, G_TEMP, dest);
#define s0_3(dest, src)     \
    AVX1_R(G_TEMP, src, 7); \
    XOR(dest, G_TEMP, dest);

#define s1_1(dest, src) AVX1_S(dest, src, 19);
#define s1_2(dest, src)      \
    AVX1_S(G_TEMP, src, 61); \
    XOR(dest, G_TEMP, dest);
#define s1_3(dest, src)     \
    AVX1_R(G_TEMP, src, 6); \
    XOR(dest, G_TEMP, dest);
...
#define Block_xx_3(i) s0_(XMM_TEMP0, W_I_15);

#define Block_xx_4(i)         \
    ADD(W_I, W_I, XMM_TEMP0); \
    ADD(W_I, W_I, W_I_7);

#define Block_xx_5(i) s1_(XMM_TEMP0, W_I_2);
...
#define Block_xx_9(i) s0_(XMM_TEMP0, W_I_15);

#define Block_xx_10(i)        \
    ADD(W_I, W_I, XMM_TEMP0); \
    ADD(W_I, W_I, W_I_7);

#define Block_xx_11(i) s1_(XMM_TEMP0, W_I_2);
...
#if defined(HAVE_INTEL_AVX2)
static const unsigned long mBYTE_FLIP_MASK_Y[] = { 0x0001020304050607, 0x08090a0b0c0d0e0f,
...
#define SAVE_REG_Y(i) \
    __asm__ volatile("vmovdqu %%ymm" #i ", %0 \n\t" : "=m"(reg[i - 4][0])::YMM_REGs);
#define RECV_REG_Y(i) \
    __asm__ volatile("vmovdqu %0, %%ymm" #i " \n\t" ::"m"(reg[i - 4][0]) : YMM_REGs);
...
#define _DUMP_REG_Y(REG, name)                                                    \
    {                                                                             \
        ...
        __asm__ volatile("vmovdqu %%" #REG ", %0 \n\t" : "=m"(buf[0])::YMM_REGs); \
        printf(" " #name ":\t");                                                  \
        for (k = 0; k < 4; k++) printf("%016lx.", (word64)buf[k]);                \
        printf("\n");                                                             \
        RECV_REG_Y(4);                                                            \
        RECV_REG_Y(5);                                                            \
        RECV_REG_Y(6);                                                            \
...
#define _MOVE_to_MEMy(mem, i, ymm)                                       \
    __asm__ volatile("vmovdqu %%" #ymm ", %0"                            \
                     : "=m"(mem[i]), "=m"(mem[i + 1]), "=m"(mem[i + 2]), \
                       "=m"(mem[i + 3])::YMM_REGs);
#define _MOVE_128y(ymm0, ymm1, ymm2, map) \
...
#define _AVX2_R(dest, src, bits) \
    __asm__ volatile("vpsrlq  $" #bits ", %%" #src ", %%" #dest " " ::: YMM_REGs);
#define _XORy(dest, src1, src2) \
    __asm__ volatile("vpxor   %%" #src1 ", %%" #src2 ", %%" #dest " " ::: YMM_REGs);
#define _ADDy(dest, src1, src2) \
    __asm__ volatile("vpaddq   %%" #src1 ", %%" #src2 ", %%" #dest " " ::: YMM_REGs);
#define _BLENDy(map, dest, src1, src2)                                                    \
    __asm__ volatile("vpblendd    $" #map ", %%" #src1 ",   %%" #src2 ", %%" #dest " " :: \
                         : YMM_REGs);
#define _BLENDQy(map, dest, src1, src2) \
    __asm__ volatile("vblendpd   $" #map ", %%" #src1 ",   %%" #src2 ", %%" #dest " " ::: YMM_REGs);
#define _PERMQy(map, dest, src) \
    __asm__ volatile("vpermq  $" #map ", %%" #src ", %%" #dest " " ::: YMM_REGs);
...
#define FEEDBACK1_to_W_I_2(w_i_2, w_i)    \
    MOVE_128y(YMM_TEMP0, w_i, w_i, 0x08); \
    BLENDy(0xf0, w_i_2, YMM_TEMP0, w_i_2);

#define MOVE_W_to_W_I_15(w_i_15, w_0, w_4) \
    BLENDQy(0x1, w_i_15, w_4, w_0);        \
    PERMQy(0x39, w_i_15, w_i_15);
#define MOVE_W_to_W_I_7(w_i_7, w_8, w_12) \
    BLENDQy(0x1, w_i_7, w_12, w_8);       \
    PERMQy(0x39, w_i_7, w_i_7);
#define MOVE_W_to_W_I_2(w_i_2, w_12)  \
    BLENDQy(0xc, w_i_2, w_12, w_i_2); \
...
#define s0_2y(dest, src)     \
    AVX2_S(G_TEMPy, src, 8); \
    XORy(dest, G_TEMPy, dest);
#define s0_3y(dest, src)     \
    AVX2_R(G_TEMPy, src, 7); \
    XORy(dest, G_TEMPy, dest);

#define s1_1y(dest, src) AVX2_S(dest, src, 19);
#define s1_2y(dest, src)      \
    AVX2_S(G_TEMPy, src, 61); \
    XORy(dest, G_TEMPy, dest);
#define s1_3y(dest, src)     \
    AVX2_R(G_TEMPy, src, 6); \
    XORy(dest, G_TEMPy, dest);

#define s0_y(dest, src) \
    s0_1y(dest, src);   \
    s0_2y(dest, src);   \
    s0_3y(dest, src)
#define s1_y(dest, src) \
    s1_1y(dest, src);   \
    s1_2y(dest, src);   \
    s1_3y(dest, src)
...
#define Block_Y_xx_2(i, w_0, w_4, w_8, w_12) s0_1y(YMM_TEMP0, W_I_15y);

#define Block_Y_xx_3(i, w_0, w_4, w_8, w_12) s0_2y(YMM_TEMP0, W_I_15y);

#define Block_Y_xx_4(i, w_0, w_4, w_8, w_12) s0_3y(YMM_TEMP0, W_I_15y);

#define Block_Y_xx_5(i, w_0, w_4, w_8, w_12) ADDy(W_I_TEMPy, w_0, YMM_TEMP0);

#define Block_Y_xx_6(i, w_0, w_4, w_8, w_12) \
    ADDy(W_I_TEMPy, W_I_TEMPy, W_I_7y);      \
    s1_1y(YMM_TEMP0, W_I_2y);

#define Block_Y_xx_7(i, w_0, w_4, w_8, w_12) s1_2y(YMM_TEMP0, W_I_2y);

#define Block_Y_xx_8(i, w_0, w_4, w_8, w_12) \
    s1_3y(YMM_TEMP0, W_I_2y);                \
    ADDy(w_0, W_I_TEMPy, YMM_TEMP0);

#define Block_Y_xx_9(i, w_0, w_4, w_8, w_12) FEEDBACK1_to_W_I_2(W_I_2y, w_0);

#define Block_Y_xx_10(i, w_0, w_4, w_8, w_12) s1_1y(YMM_TEMP0, W_I_2y);

#define Block_Y_xx_11(i, w_0, w_4, w_8, w_12) s1_2y(YMM_TEMP0, W_I_2y);
...
{
    if (set_cpuid_flags(CHECK_SHA384))
        return;
...
int wc_Sha384Final(Sha384 *sha384, byte *hash)
{
    ...
    /* put lengths in bits */
    sha384->hiLen = (sha384->loLen >> (8 * sizeof(sha384->loLen) - 3)) + (sha384->hiLen << 3);
