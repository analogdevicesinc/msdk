...
typedef BaseType_t (*xApplicationPhyReadHook_t)(BaseType_t xAddress, BaseType_t xRegister,
                                                uint32_t *pulValue);
...
/* A generic user-provided function that writes 'usValue' to the
   ...
   Return non-zero in case the action failed. */
typedef BaseType_t (*xApplicationPhyWriteHook_t)(BaseType_t xAddress, BaseType_t xRegister,
                                                 uint32_t ulValue);
