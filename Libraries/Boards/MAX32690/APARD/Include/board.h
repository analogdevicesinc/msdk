...
#ifndef LIBRARIES_BOARDS_MAX32690_APARD_INCLUDE_BOARD_H_
#define LIBRARIES_BOARDS_MAX32690_APARD_INCLUDE_BOARD_H_

#ifdef __cplusplus
extern "C" {
#endif

#define BOARD_APARD /// Used in examples to control program flow
...
/**
 *  A reference to LED3 (BLUE LED in the RGB LED) of the board.
 *  Can be used with the LED_On, LED_Off, and LED_Toggle functions.
 */
#define LED3 2
#define LED_RED LED3
...
#endif // LIBRARIES_BOARDS_MAX32690_APARD_INCLUDE_BOARD_H_
