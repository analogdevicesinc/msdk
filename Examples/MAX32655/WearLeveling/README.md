...
Demonstrates Flash Wear Leveling usage on MAX32655 MCU.
...
MCU internal flash is partitioned as follows:
 ...
 The application code area should be defined in the linker script file *"max32655.ld"*:
