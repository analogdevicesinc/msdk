...
void Graphics_SetTime(uint32_t total_seconds)
{
    ...
    if (prev_timer_digit1 != digit1) {
        MXC_TFT_DrawRect(TIME_DIGIT1_OFFSET_X(TIME_DIGIT_WIDTH), TIME_OFFSET_Y, TIME_DIGIT_WIDTH, GAME_TEXT_DIGITS_HEIGHT, F_BACKGROUND_COLOR);
    ...
    if (prev_timer_digit2 != digit2) {
        MXC_TFT_DrawRect(TIME_DIGIT2_OFFSET_X(TIME_DIGIT_WIDTH), TIME_OFFSET_Y, TIME_DIGIT_WIDTH, GAME_TEXT_DIGITS_HEIGHT, F_BACKGROUND_COLOR);
    ...
    if (prev_timer_digit3 != digit3) {
        MXC_TFT_DrawRect(TIME_DIGIT3_OFFSET_X(TIME_DIGIT_WIDTH), TIME_OFFSET_Y, TIME_DIGIT_WIDTH, GAME_TEXT_DIGITS_HEIGHT, F_BACKGROUND_COLOR);
...
void Graphics_UpdateMovesCount(uint32_t moves_count)
{
    ...
    if (prev_moves_digit1 != digit1) {
        MXC_TFT_DrawRect(MOVES_DIGIT1_OFFSET_X(MOVES_DIGIT_WIDTH), MOVES_DIGITS_OFFSET_Y, MOVES_DIGIT_WIDTH, GAME_TEXT_DIGITS_HEIGHT, F_BACKGROUND_COLOR);
    ...
    if (prev_moves_digit2 != digit2) {
        MXC_TFT_DrawRect(MOVES_DIGIT2_OFFSET_X(MOVES_DIGIT_WIDTH), MOVES_DIGITS_OFFSET_Y, MOVES_DIGIT_WIDTH, GAME_TEXT_DIGITS_HEIGHT, F_BACKGROUND_COLOR);
    ...
    if (prev_moves_digit3 != digit3) {
        MXC_TFT_DrawRect(MOVES_DIGIT3_OFFSET_X(MOVES_DIGIT_WIDTH), MOVES_DIGITS_OFFSET_Y, MOVES_DIGIT_WIDTH, GAME_TEXT_DIGITS_HEIGHT, F_BACKGROUND_COLOR);
