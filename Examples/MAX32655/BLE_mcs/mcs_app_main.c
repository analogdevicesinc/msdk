...
static void mcsAppSetup(dmEvt_t* pMsg)
{
    ...
    AppAdvSetData(
        APP_ADV_DATA_DISCOVERABLE, sizeof(mcsAppAdvDataDisc), (uint8_t*)mcsAppAdvDataDisc);
    AppAdvSetData(
        APP_SCAN_DATA_DISCOVERABLE, sizeof(mcsAppScanDataDisc), (uint8_t*)mcsAppScanDataDisc);

    /* set advertising and scan response data for connectable mode */
    AppAdvSetData(APP_ADV_DATA_CONNECTABLE, sizeof(mcsAppAdvDataDisc), (uint8_t*)mcsAppAdvDataDisc);
    AppAdvSetData(
        APP_SCAN_DATA_CONNECTABLE, sizeof(mcsAppScanDataDisc), (uint8_t*)mcsAppScanDataDisc);
