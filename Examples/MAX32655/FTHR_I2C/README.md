...
* NOTE: This project is only compatible with the MAX32655FTHR!  See [Board Support Packages](https://analog-devices-msdk.github.io/msdk/USERGUIDE/#board-support-packages) in the UG for instructions on changing the target board to the featherboard.
