...
This simple application demonstrates the use of the MAX32572 as a temperature monitor. **NOTE: A MAX31889EVSYS is required to run the example.**
...
-   Make the following connections between the MAX32572 and MAX31889 EV Kits: P0.6-->SCL(J2.11), P0.7-->SDA(J2.12), VDD(JH3.7)-->VDD(J1.2), GND(JH3.8)-->GND(J1.4)
...
This simple example demonstrates the use of the MAX32572 as a temperature
monitor.
