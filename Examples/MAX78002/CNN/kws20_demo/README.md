...
```bash
$ cd /Examples/MAX78002/CNN/kws20_demo
$ make -r
```
...
Connect the DC 5V supply to MAX78002 evkit. Connect PICO adapter to JH8 SWD header. Turn the power switch SW1 to on position.

To see debug messages, you can optionally connect a USB cable to CN2.
