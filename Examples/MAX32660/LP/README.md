...
This example demonstrates the various low-power modes on the MAX32660.

The device is capable of entering the Sleep, Deep Sleep, and Backup modes. The user may select which low power modes to enter in this example by setting the DO_SLEEP, DO_DEEPSLEEP, and DO_BACKUP that can be set to 1 or 0.

To move to the next power state, push the button (SW2).
