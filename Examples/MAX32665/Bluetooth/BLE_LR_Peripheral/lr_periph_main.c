...
/**************************************************************************************************
  Macros
**************************************************************************************************/
#define USER_SPEC_ADV_DATA_LEN (50)
#define ADV_DATA_DISC_LEN (9 + USER_SPEC_ADV_DATA_LEN)
...
uint8_t fitAdvDataDisc[ADV_DATA_DISC_LEN] = {
    /*! flags */
    2, /*! length */
    ...
    DEFAULT_TX_POWER, /*! tx power */

    1 + USER_SPEC_ADV_DATA_LEN, /*! length */
    0
    /* 50-byte data */
};
