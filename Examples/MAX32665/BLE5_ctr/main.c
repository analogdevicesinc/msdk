...
void setInterruptPriority(void)
{
    ...
    NVIC_SetPriority(UART0_IRQn, (MAX_PRIORITY - 0));
    ...
    NVIC_SetPriority(DMA4_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA5_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA6_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA7_IRQn, (MAX_PRIORITY - 0));

    NVIC_SetPriority(DMA8_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA9_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA10_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA11_IRQn, (MAX_PRIORITY - 0));

    NVIC_SetPriority(DMA12_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA13_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA14_IRQn, (MAX_PRIORITY - 0));
    NVIC_SetPriority(DMA15_IRQn, (MAX_PRIORITY - 0));
