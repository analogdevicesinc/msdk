...
* This project supports output to a TFT display, which is **enabled** by default. To disable it, undefine `TFT_ENABLE` by commenting out the line in [tft_config.h](tft_config.h). The compatible 2.4'' TFT FeatherWing is an optional display that does not come with the MAX7800FTHR.  It can be ordered [here](https://learn.adafruit.com/adafruit-2-4-tft-touch-screen-featherwing)
