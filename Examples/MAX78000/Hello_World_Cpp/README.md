...
This version of Hello_World prints an incrementing count to the console UART and toggles an LED once every 500 ms.  It also demonstrates basic class creation, instancing, and class methods available in C++.
