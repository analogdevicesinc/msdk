...
During build process maxim_bitmap_converter tool will be called and 
it will convert bitmap and font files to maxim specific file format (.mpi maxim picture information)
