...
Demonstrates flash wear leveling usage on MAX32680 MCU.
...
MCU internal flash is partitioned as follows:
 ...
 The application code area should be defined in the linker script file *"max32680.ld"*:
