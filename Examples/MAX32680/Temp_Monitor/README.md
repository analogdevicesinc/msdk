...
This simple application demonstrates the use of the MAX32680 as a temperature monitor. **NOTE: A MAX31889EVSYS is required to run the example.**
...
Additionally, pressing push button SW1 will print the last 12 temperature readings in the terminal.
...
-   Select "VDDIOH" on the I2C0 pullup level select jumper (JP8).
-   Make the following connections between the MAX32680 and MAX31889 EV Kits: P0.10-->SCL(J2.11), P0.11-->SDA(J2.12), VDDIOH(JP9.3)-->VDD(J1.2), GND-->GND(J1.4)
...
This simple example demonstrates the use of the MAX32680 as a temperature
monitor.
...
Press SW1 to print the last 12 temperature readings taken.
```
