...
This example demonstrates the various low-power modes on the MAX32680.

The device is capable of entering the Sleep, Backup, and Standby modes. The user may select which low power modes to enter in this example by setting the DO_SLEEP, DO_STANDBY, and DO_BACKUP that can be set to 1 or 0.

To move to the next power state, push the button (PB1).
