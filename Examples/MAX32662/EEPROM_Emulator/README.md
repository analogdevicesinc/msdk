...
-   Connect pins SCL - P0.6 and SDA - P0.9 to the I2C Bus
-   Enable the I2C pullup resistors by installing JP2 and JP4 (select the voltage with JP11).
-   Connect Ready Signal (P0.7) to the pin used for ready signal on your micro.
