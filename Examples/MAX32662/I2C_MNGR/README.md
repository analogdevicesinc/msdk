...
-   Connect P0.6 on header J1 to the SCL line of the I2C Bus.
-   Connect P0.9 on header J7 to the SDA line of the I2C Bus.
...
LED0 is toggled each time the read from EEPROM0 is executed.
