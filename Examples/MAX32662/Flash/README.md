...
This example demonstrates various functions of the MAX32662's flash controller, including flash mass erase, flash page erase and wiriting data to flash.

Note: The size of test data can't fit in RAM, so the size had to be halved from 32768 to 16384.
