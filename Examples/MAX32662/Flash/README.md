...
Once complete, the example will prompt the user to reset or power cycle the board. This demonstrates that the written data is non-volatile and can survive a power cycle.
