...
This simple application demonstrates the use of the MAX32650 as a temperature monitor. **NOTE: A MAX31889EVSYS is required to run the example.**
...
-   Make the following connections between the MAX32650 and MAX31889 EV Kits: P2.8-->SCL(J2.11), P2.7-->SDA(J2.12), VDD("1V8" or "3V3")-->VDD(J1.2), GND-->GND(J1.4)
-   Ensure jumpers JP3 and JP5 are set to the same level as VDD.
...
This simple example demonstrates the use of the MAX32650 as a temperature
monitor.
