...
This example uses the I2C Master (I2C0) to read/write from/to the I2C Slave (I2C1). The master may conduct the transaction by either using a blocking transaction or a DMA transaction, the user may select which type is used by either commenting or uncommenting the "MASTERDMA" macro. 
...
-   You must connect P2.7 to P2.17 (SDA) and P2.8 to P2.18 (SCL).
