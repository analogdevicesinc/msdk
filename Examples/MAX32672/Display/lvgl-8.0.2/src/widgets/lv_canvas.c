...
void lv_canvas_transform(lv_obj_t* obj, lv_img_dsc_t* img, int16_t angle, uint16_t zoom,
        ...
        for (x = -offset_x; x < dest_width - offset_x; x++) {
            ...
            if (x + offset_x >= 0 && x + offset_x < dest_width && y + offset_y >= 0 &&
                ...
                if (lv_img_cf_has_alpha(img->header.cf) == false) {
                    ...
                    lv_color_t bg_color = lv_img_buf_get_px_color(&canvas->dsc, x + offset_x,
                                                                  y + offset_y, dsc.cfg.color);
                    ...
                    /*Both the image and canvas has alpha channel. Some extra calculation is
                       required*/
                        ...
                        lv_opa_t bg_opa =
                            lv_img_buf_get_px_alpha(&canvas->dsc, x + offset_x, y + offset_y);
                        ...
                        /*Both colors have alpha. Expensive calculation need to be applied*/
                            ...
                            lv_opa_t opa_res_2 =
                                255 -
                                ((uint16_t)((uint16_t)(255 - dsc.res.opa) * (255 - bg_opa)) >> 8);
                            if (opa_res_2 == 0) {
