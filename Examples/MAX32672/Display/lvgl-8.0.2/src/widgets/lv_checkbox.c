 ...
 *  STATIC VARIABLES
 **********************/
const lv_obj_class_t lv_checkbox_class = {.constructor_cb = lv_checkbox_constructor,
...
static void lv_checkbox_event(const lv_obj_class_t* class_p, lv_event_t* e)
{
    ...
    if (code == LV_EVENT_PRESSED || code == LV_EVENT_RELEASED) {
        ...
        lv_point_t txt_size;
        lv_txt_get_size(&txt_size, cb->txt, font, letter_space, line_space, LV_COORD_MAX,
                        LV_TEXT_FLAG_NONE);
