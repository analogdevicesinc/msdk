...
void lv_bar_set_value(lv_obj_t* obj, int32_t value, lv_anim_enable_t anim)
{
    ...
    value = value < bar->start_value ? bar->start_value :
                                       value; /*Can't be smaller then the left value*/
...
void lv_bar_set_start_value(lv_obj_t* obj, int32_t value, lv_anim_enable_t anim)
{
    ...
    value = LV_CLAMP(bar->min_value, value, bar->max_value);
    value =
        value > bar->cur_value ? bar->cur_value : value; /*Can't be greater then the right value*/
...
static void draw_indic(lv_event_t* e)
{
    ...
    if (LV_BAR_IS_ANIMATING(bar->start_value_anim)) {
        lv_coord_t anim_start_value_start_x =
            (int32_t)((int32_t)anim_length * (bar->start_value_anim.anim_start - bar->min_value)) /
            range;
        lv_coord_t anim_start_value_end_x =
            (int32_t)((int32_t)anim_length * (bar->start_value_anim.anim_end - bar->min_value)) /
            range;
        ...
        anim_start_value_x =
            (int32_t)((int32_t)anim_length * (bar->start_value - bar->min_value)) / range;
    }

    if (LV_BAR_IS_ANIMATING(bar->cur_value_anim)) {
        lv_coord_t anim_cur_value_start_x =
            (int32_t)((int32_t)anim_length * (bar->cur_value_anim.anim_start - bar->min_value)) /
            range;
        lv_coord_t anim_cur_value_end_x =
            (int32_t)((int32_t)anim_length * (bar->cur_value_anim.anim_end - bar->min_value)) /
            range;
        ...
        anim_cur_value_x =
            (int32_t)((int32_t)anim_length * (bar->cur_value - bar->min_value)) / range;
    }
