...
static lv_coord_t grid_align(lv_coord_t cont_size, bool auto_size, uint8_t align, lv_coord_t gap,
                             uint32_t track_num, lv_coord_t* size_array, lv_coord_t* pos_array,
                             bool reverse);
...
static void calc(lv_obj_t* cont, _lv_grid_calc_t* calc_out)
{
    ...
    calc_out->grid_w  = grid_align(cont_w, auto_w, get_grid_col_align(cont), col_gap,
    ...
    calc_out->grid_h  = grid_align(cont_h, auto_h, get_grid_row_align(cont), row_gap,
