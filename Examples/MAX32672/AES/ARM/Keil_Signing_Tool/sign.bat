...
::Update sla header of image with correct size, output header and app after removing dummy signature (.nosig .sla and .hdr  and .deadcode are all binary files)
echo ------------------------------- STEP 2 ---------------------------------------
