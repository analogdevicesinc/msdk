...
int ucl_x931_ssa_sha256_sign(u8 *signature, u8 *message, u32 message_length,
                             ucl_rsa_private_key_t *keyPr);
int ucl_x931_ssa_sha256_crt_sign(u8 *signature, u8 *message, u32 message_length,
                                 ucl_rsa_crt_private_key_t *keyPr);
int ucl_x931_ssa_sha256_verify(u8 *signature, u8 *message, u32 message_length,
