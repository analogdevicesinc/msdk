...
int ucl_x931_ssa_sha1_sign(u8 *signature, u8 *message, u32 message_length,
                           ucl_rsa_private_key_t *keyPr);
int ucl_x931_ssa_sha1_crt_sign(u8 *signature, u8 *message, u32 message_length,
                               ucl_rsa_crt_private_key_t *keyPr);
int ucl_x931_ssa_sha1_verify(u8 *signature, u8 *message, u32 message_length,
