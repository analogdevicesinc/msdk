...
#ifdef P128
#ifdef WORD32
static const DIGIT local_inv2_p128r1[SECP128R1_WORDSIZE]
    = { 0xffffffff, 0xffffffff, 0xffffffff, 0x7fffffff };
static const DIGIT local_xg_p128r1[SECP128R1_WORDSIZE]
    = { 0xA52C5B86, 0x0C28607C, 0x8B899B2D, 0x161FF752 };
static const DIGIT local_yg_p128r1[SECP128R1_WORDSIZE]
    = { 0xDDED7A83, 0xC02DA292, 0x5BAFEB13, 0xCF5AC839 };
static const DIGIT local_a_p128r1[SECP128R1_WORDSIZE]
    = { 0xfffffffc, 0xffffffff, 0xffffffff, 0xfffffffd };
static const DIGIT local_b_p128r1[SECP128R1_WORDSIZE]
    = { 0x2CEE5ED3, 0xD824993C, 0x1079F43D, 0xE87579C1 };
static const DIGIT local_p_p128r1[SECP128R1_WORDSIZE]
    = { 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
static const DIGIT local_n_p128r1[SECP128R1_WORDSIZE]
...
static const DIGIT local_b_p160r1[SECP160R1_WORDSIZE] = { 0xc565fa45, 0x81d4d4ad, 0x65acf89f,
    0x54bd7a8b, 0x1c97befc, 0x00000000, 0x00000000, 0x00000000 };
...
static const DIGIT local_p1x_p160r1[SECP160R1_WORDSIZE] = { 0x5be78f90, 0x20ebda7b, 0x0f40d239,
    0xe86da218, 0x12efb435, 0x00000000, 0x00000000, 0x00000000 };
static const DIGIT local_p1y_p160r1[SECP160R1_WORDSIZE] = { 0x1849ebf3, 0x2de58ff4, 0x5808adcd,
    0xe98f76ae, 0xe08ba9b4, 0x00000000, 0x00000000, 0x00000000 };
#endif // WORD32
#ifdef WORD16
static const DIGIT local_inv2_p160r1[SECP160R1_WORDSIZE] = { 0x0000, 0xc000, 0xffff, 0xffff, 0xffff,
    0xffff, 0xffff, 0xffff, 0xffff, 0x7fff, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000 };
#endif // WORD16
...
static const DIGIT local_psquare_p192r1[]
    = { 0x00000001, 0x00000000, 0x00000002, 0x00000000, 0x00000001, 0x00000000, 0xfffffffe,
          0xffffffff, 0xfffffffd, 0xffffffff, 0xffffffff, 0x0fffffff, 0x00000000, 0x00000000 };
...
static const DIGIT local_p1x_p192r1[SECP192R1_WORDSIZE] = { 0xca9d10c7, 0x21264bec, 0xec063368,
    0xf95e1b37, 0x1e7ab415, 0x05e228e2, 0x00000000, 0x00000000 };
static const DIGIT local_p1y_p192r1[SECP192R1_WORDSIZE] = { 0x1e4c1e3a, 0x85bb1c70, 0xd7c66b13,
    0xbbc56839, 0x333fa2c0, 0x2d4d66cb, 0x00000000, 0x00000000 };
#endif // WORD32
#ifdef WORD16
static const DIGIT local_inv2_p192r1[SECP192R1_WORDSIZE] = { 0x0000, 0x0000, 0x0000, 0x8000, 0xffff,
    0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0x7fff, 0x0000, 0x0000, 0x0000, 0x0000 };
static const DIGIT local_psquare_p192r1[]
...
static const DIGIT local_psquare_p256r1[] = { 0x00000001, 0x00000000, 0x00000000, 0xfffffffe,
    0xffffffff, 0xffffffff, 0xfffffffe, 0x00000001, 0xfffffffe, 0x00000001, 0xfffffffe, 0x00000001,
...
static const DIGIT local_p1x_p256r1[SECP256R1_WORDSIZE] = { 0xc420924a, 0x39912513, 0x487cab57,
    0x00b60867, 0x48adde64, 0x5afb62de, 0x1e67a44b, 0x0b197a2e };
static const DIGIT local_p1y_p256r1[SECP256R1_WORDSIZE] = { 0x2efba5a0, 0x461ac4c7, 0x47404cbf,
    0xf0a0ab11, 0x9839be03, 0xa990c7a2, 0x0c6bac1e, 0x5b5fc4ce };
#endif // WORD32
#ifdef WORD16
static const DIGIT local_inv2_p256r1[SECP256R1_WORDSIZE] = { 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x8000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x8000, 0x0000, 0x8000, 0xffff, 0x7fff };
...
static const DIGIT local_psquare_p256k1[SECP256K1_WORDSIZE * 2] = { 0x000e90a1, 0x000007a2,
    0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0xfffff85e, 0xfffffffd,
...
static const DIGIT local_p1x_p256k1[SECP256R1_WORDSIZE] = { 0xeb9a9787, 0x92f76cc4, 0x59599680,
    0x89bdde81, 0xbbd3788d, 0x74669716, 0xef5ba060, 0xdd3625fa };
static const DIGIT local_p1y_p256k1[SECP256R1_WORDSIZE] = { 0x39bb56bc, 0xc80972fe, 0xd77cc6a6,
    0x6beb9e67, 0xfba8ce35, 0x9e25dafe, 0xadf1cf2b, 0x85e7705c };
#endif // WORD32
#ifdef WORD16
...
#ifdef BP384
#ifdef WORD32
static const DIGIT local_inv2_bp384r1[BP384R1_WORDSIZE]
    = { 0x9883f62a, 0xc3a38009, 0xc80e8d38, 0xd669d394, 0xbfdb8891, 0x0958ed0c, 0xf6aa2b5a,
          0x8a97b884, 0x287320ef, 0x07aeb7bf, 0x519c3694, 0x465c8f41 };
static const DIGIT local_xg_bp384r1[BP384R1_WORDSIZE]
    = { 0x47d4af1e, 0xef87b2e2, 0x36d646aa, 0xe826e034, 0x0cbd10e8, 0xdb7fcafe, 0x7ef14fe3,
          0x8847a3e7, 0xb7c13f6b, 0xa2a63a81, 0x68cf45ff, 0x1d1c64f0 };
static const DIGIT local_yg_bp384r1[BP384R1_WORDSIZE]
    = { 0x263c5315, 0x42820341, 0x77918111, 0x0e464621, 0xf9912928, 0xe19c054f, 0xfeec5864,
          0x62b70b29, 0x95cfd552, 0x5cb1eb8e, 0x20f9c2a4, 0x8abe1d75 };
static const DIGIT local_a_bp384r1[BP384R1_WORDSIZE]
    = { 0x22ce2826, 0x04a8c7dd, 0x503ad4eb, 0x8aa5814a, 0xba91f90f, 0x139165ef, 0x4fb22787,
          0xc2bea28e, 0xce05afa0, 0x3c72080a, 0x3d8c150c, 0x7bc382c6 };
static const DIGIT local_b_bp384r1[BP384R1_WORDSIZE]
    = { 0xfa504c11, 0x3ab78696, 0x95dbc994, 0x7cb43902, 0x3eeb62d5, 0x2e880ea5, 0x07dcd2a6,
          0x2fb77de1, 0x16f0447c, 0x8b39b554, 0x22ce2826, 0x04a8c7dd };
static const DIGIT local_p_bp384r1[BP384R1_WORDSIZE]
    = { 0x3107ec53, 0x87470013, 0x901d1a71, 0xacd3a729, 0x7fb71123, 0x12b1da19, 0xed5456b4,
          0x152f7109, 0x50e641df, 0x0f5d6f7e, 0xa3386d28, 0x8cb91e82 };
static const DIGIT local_n_bp384r1[BP384R1_WORDSIZE]
    = { 0xe9046565, 0x3b883202, 0x6b7fc310, 0xcf3ab6af, 0xac0425a7, 0x1f166e6c, 0xed5456b3,
          0x152f7109, 0x50e641df, 0x0f5d6f7e, 0xa3386d28, 0x8cb91e82 };
static const DIGIT local_p1x_bp384r1[]
    = { 0x75a63e99, 0xac10f79e, 0xb09b811a, 0x2d3695fe, 0x0aa7c2a9, 0xf1d81e69, 0x4f8bc8c4,
          0x6f583fe1, 0xd194fab9, 0x1c630948, 0xda6be62a, 0x5ad00e2f };
static const DIGIT local_p1y_bp384r1[]
    = { 0x6bd7f655, 0xf919af00, 0x9983e49e, 0x7b9d90e3, 0xfec72afc, 0x9f2601b2, 0x7592b7dd,
          0x5e3a861a, 0x94137b47, 0xec0f4f90, 0x1c5182a2, 0x33b63ca5 };
#endif // WORD32
...
#endif // PRECOMPUT
static const DIGIT local_inv2_p384r1[SECP384R1_WORDSIZE]
    = { 0x80000000, 0x00000000, 0x80000000, 0x7fffffff, 0xffffffff, 0xffffffff, 0xffffffff,
          0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x7fffffff };
static const DIGIT local_xg_p384r1[SECP384R1_WORDSIZE]
    = { 0x72760ab7, 0x3a545e38, 0xbf55296c, 0x5502f25d, 0x82542a38, 0x59f741e0, 0x8ba79b98,
          0x6e1d3b62, 0xf320ad74, 0x8eb1c71e, 0xbe8b0537, 0xaa87ca22 };
static const DIGIT local_yg_p384r1[SECP384R1_WORDSIZE]
    = { 0x90ea0e5f, 0x7a431d7c, 0x1d7e819d, 0x0a60b1ce, 0xb5f0b8c0, 0xe9da3113, 0x289a147c,
          0xf8f41dbd, 0x9292dc29, 0x5d9e98bf, 0x96262c6f, 0x3617de4a };
static const DIGIT local_a_p384r1[SECP384R1_WORDSIZE]
    = { 0xfffffffc, 0x00000000, 0x00000000, 0xffffffff, 0xfffffffe, 0xffffffff, 0xffffffff,
          0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
static const DIGIT local_b_p384r1[SECP384R1_WORDSIZE]
...
static const DIGIT local_p_p384r1[SECP384R1_WORDSIZE]
    = { 0xffffffff, 0x00000000, 0x00000000, 0xffffffff, 0xfffffffe, 0xffffffff, 0xffffffff,
          0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
static const DIGIT local_n_p384r1[SECP384R1_WORDSIZE]
    = { 0xccc52973, 0xecec196a, 0x48b0a77a, 0x581a0db2, 0xf4372ddf, 0xc7634d81, 0xffffffff,
          0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
static const DIGIT local_p1x_p384r1[SECP384R1_WORDSIZE]
    = { 0xa7dc885c, 0xd8ed2ff2, 0x12f8e1fa, 0xb499e34b, 0x37d205ce, 0x7eb2ff39, 0xa5127bf6,
          0x9f1383e8, 0xd6c96f1b, 0x09e7ad61, 0xf514dae5, 0x7fbbe67c };
static const DIGIT local_p1y_p384r1[SECP384R1_WORDSIZE]
    = { 0xb0437ac0, 0x840182e0, 0xde9d6cba, 0xdf52f874, 0x6fee5e30, 0xc8efc7be, 0xd33df9bd,
          0xd59af65a, 0x87f4a1b5, 0xd5141a5d, 0xf5ca9b9d, 0xf38aabe5 };
#endif // WORD32
...
#endif // PRECOMPUT
static const DIGIT local_inv2_p521r1[SECP521R1_WORDSIZE] = { 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000100 };
static const DIGIT local_xg_p521r1[SECP521R1_WORDSIZE] = { 0xc2e5bd66, 0xf97e7e31, 0x856a429b,
    0x3348b3c1, 0xa2ffa8de, 0xfe1dc127, 0xefe75928, 0xa14b5e77, 0x6b4d3dba, 0xf828af60, 0x053fb521,
    0x9c648139, 0x2395b442, 0x9e3ecb66, 0x0404e9cd, 0x858e06b7, 0x000000c6 };
static const DIGIT local_yg_p521r1[SECP521R1_WORDSIZE] = { 0x9fd16650, 0x88be9476, 0xa272c240,
    0x353c7086, 0x3fad0761, 0xc550b901, 0x5ef42640, 0x97ee7299, 0x273e662c, 0x17afbd17, 0x579b4468,
    0x98f54449, 0x2c7d1bd9, 0x5c8a5fb4, 0x9a3bc004, 0x39296a78, 0x00000118 };
static const DIGIT local_a_p521r1[SECP521R1_WORDSIZE] = { 0xfffffffc, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x000001ff };
static const DIGIT local_b_p521r1[SECP521R1_WORDSIZE] = { 0x6b503f00, 0xef451fd4, 0x3d2c34f1,
    0x3573df88, 0x3bb1bf07, 0x1652c0bd, 0xec7e937b, 0x56193951, 0x8ef109e1, 0xb8b48991, 0x99b315f3,
    0xa2da725b, 0xb68540ee, 0x929a21a0, 0x8e1c9a1f, 0x953eb961, 0x00000051 };
static const DIGIT local_p_p521r1[SECP521R1_WORDSIZE] = { 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x000001ff };
static const DIGIT local_n_p521r1[SECP521R1_WORDSIZE] = { 0x91386409, 0xbb6fb71e, 0x899c47ae,
    0x3bb5c9b8, 0xf709a5d0, 0x7fcc0148, 0xbf2f966b, 0x51868783, 0xfffffffa, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x000001ff };
static const DIGIT local_p1x_p521r1[] = { 0x6b4c3f67, 0x82e05142, 0x3fc34315, 0x83049259,
    0x972d1c60, 0x2b17027d, 0x06941699, 0x650bd0df, 0xbf06dea4, 0xc960bca9, 0xf6bf6453, 0xc9b131ee,
...
static const DIGIT local_p1y_p521r1[] = { 0x16056e76, 0xcd247a09, 0x4aabbfce, 0xc0f214f1,
    0x8fb1cf42, 0x7b7ba942, 0x79dfcd33, 0x521e44f1, 0x030cfa52, 0x72151cc5, 0x3f763269, 0x6e731597,
...
#ifdef BP512
#ifdef WORD32
static const DIGIT local_inv2_bp512r1[BP512R1_WORDSIZE] = { 0x2c1d247a, 0x9455302b, 0x96c16342,
    0x1440ff97, 0x7351c073, 0x5766d095, 0x4de33421, 0xbea6cd80, 0x38198438, 0x6b31ce65, 0xd9e4e907,
    0xe59846d9, 0x19e4fe03, 0x9fea7357, 0x6df4e245, 0x556ecedc };
static const DIGIT local_xg_bp512r1[BP512R1_WORDSIZE] = { 0xbcb9f822, 0x8b352209, 0x406a5e68,
    0x7c6d5047, 0x93b97d5f, 0x50d1687b, 0xe2d0d48d, 0xff3b1f78, 0xf4d0098e, 0xb43b62ee, 0xb5d916c1,
    0x85ed9f70, 0x9c4c6a93, 0x5a21322e, 0xd82ed964, 0x81aee4bd };
static const DIGIT local_yg_bp512r1[BP512R1_WORDSIZE] = { 0x3ad80892, 0x78cd1e0f, 0xa8f05406,
    0xd1ca2b2f, 0x8a2763ae, 0x5bca4bd8, 0x4a5f485e, 0xb2dcde49, 0x881f8111, 0xa000c55b, 0x24a57b1a,
    0xf209f700, 0xcf7822fd, 0xc0eabfa9, 0x566332ec, 0x7dde385d };
static const DIGIT local_a_bp512r1[BP512R1_WORDSIZE] = { 0x77fc94ca, 0xe7c1ac4d, 0x2bf2c7b9,
    0x7f1117a7, 0x8b9ac8b5, 0x0a2ef1c9, 0xa8253aa1, 0x2ded5d5a, 0xea9863bc, 0xa83441ca, 0x3df91610,
    0x94cbdd8d, 0xac234cc5, 0xe2327145, 0x8b603b89, 0x7830a331 };
static const DIGIT local_b_bp512r1[BP512R1_WORDSIZE] = { 0x8016f723, 0x2809bd63, 0x5ebae5dd,
    0x984050b7, 0xdc083e67, 0x77fc94ca, 0xe7c1ac4d, 0x2bf2c7b9, 0x7f1117a7, 0x8b9ac8b5, 0x0a2ef1c9,
    0xa8253aa1, 0x2ded5d5a, 0xea9863bc, 0xa83441ca, 0x3df91610 };
static const DIGIT local_p_bp512r1[BP512R1_WORDSIZE] = { 0x583a48f3, 0x28aa6056, 0x2d82c685,
    0x2881ff2f, 0xe6a380e6, 0xaecda12a, 0x9bc66842, 0x7d4d9b00, 0x70330871, 0xd6639cca, 0xb3c9d20e,
    0xcb308db3, 0x33c9fc07, 0x3fd4e6ae, 0xdbe9c48b, 0xaadd9db8 };
static const DIGIT local_n_bp512r1[BP512R1_WORDSIZE] = { 0x9ca90069, 0xb5879682, 0x085ddadd,
    0x1db1d381, 0x7fac1047, 0x41866119, 0x4ca92619, 0x553e5c41, 0x70330870, 0xd6639cca, 0xb3c9d20e,
    0xcb308db3, 0x33c9fc07, 0x3fd4e6ae, 0xdbe9c48b, 0xaadd9db8 };
static const DIGIT local_p1x_bp512r1[] = { 0xd417e2e3, 0xc5cff507, 0x2b548eaa, 0x066cc526,
    0x5e1c93fb, 0x705ff956, 0x92e44ac2, 0x2f0c64e8, 0xe9f2d580, 0xe5068698, 0x1834d6b0, 0x4917a380,
...
static const DIGIT local_p1y_bp512r1[] = { 0xefe89ad4, 0x77d67f46, 0x90b9ccc0, 0xe9983393,
    0xe74c256c, 0x50098aa6, 0x5141bf13, 0x0844cde6, 0x0bd3d553, 0xe0c07ef6, 0x354bb2d8, 0xeb15faa0,
 ...
 *
* @param[out] signature: pointer to a ucl_type_ecdsa_signature structure, containing the signature
(r,s) values
* @param[in] *d: input, the secret key
* @param[in] *ucl_hash: input, the pointer to the hash function (see hash functions documentation
for already available ones)
* @param[in] *input: input, the message or the hash digest to be signed,
* @param[in] inputlength: input, the input length, in bytes
* @param[in] *curve_params: the pointer to a ucl_type_curve structure, containing the curve domain
parameters (already existing ones are described in the documentation)
* @param[in] configuration (combination of any of these lines)
     ...
     - Examples are:
       ...
       - UCL_R_PRECOMP<<UCL_PRECOMP_SHIFT+ UCL_MSG_INPUT<<UCL_INPUT_SHIFT:signing a message, using
pre-computed r

 * @return Error code
 *
 * @retval #UCL_OK in case of correct computation
 * @retval #UCL_INVALID_INPUT or #UCL_INVALID OUTPUT in case of wrong parameters configuration (e.g.
NULL pointers, secret key greater than curve order)
 *
 * @ingroup UCL_ECDSA */
...
int ucl_ecdsa_signature_without_protection(ucl_type_ecdsa_signature signature, u8* d,
    int (*ucl_hash)(u8*, u8*, u32), u8* input, u32 inputlength, ucl_type_curve* curve_params,
    u32 configuration);

/** <b>ECDSA signature</b>.
 * Verify a ECDSA signature, using curve domain structure, introduced in 2.4.9
*
* @param[in] public key: pointer to a ucl_type_ecc_u8_affine_point structure, containing the ECC
public key, used for signature verification
* @param[in] signature: pointer to a ucl_type_ecdsa_signature structure, containing the signature
(r,s) values
* @param[in] *ucl_hash: input, the pointer to the hash function (see hash functions documentation
for already available ones)
* @param[in] *input: input, the message or the hash digest to be signed,
 ...
 * compute a SM2 P256 DSA signature, using the SM2 curve as defined in SM2 Digital Signature
Algorithm draft-shen-sm2-ecdsa-00, with SM3 hash function defined in draft-shen-sm3-hash-00
*
* @param[out] signature: pointer to a ucl_type_ecdsa_signature structure, containing the signature
(r,s) values
* @param[in] *d: input, the secret key
* @param[in] *A: input, a pointer to a ucl_type_ecc_u8_affine_point structure, representing the
public key
...
/** <b>SM2 DSA signature</b>.
 * compute a SM2 DSA signature, using the curve domain parameters provided in the curve domain
structure, with SM3 hash function
...
* @param[in] *entla: input, the ENTLA (entlenA bits) parameter
* @param[in] *curve_params: the pointer to a ucl_type_curve structure, containing the curve domain
parameters (already existing one is sm2fp256, described in the documentation)
* @param[in] configuration (combination of any of these lines)
     - UCL_R_PRECOMP or UCL_PRECOMP_R:
     - UCL_R_PRECOMP: using precomputed r to finish the signature computation,
     - UCL_PRECOMP_R: to only pre-compute the r value,
...
int ucl_sm2dsa_signature_curve(ucl_type_ecdsa_signature signature, u8* d,
    ucl_type_ecc_u8_affine_point A, u8* input, u32 inputlength, u8* ida, u8* entla,
    ucl_type_curve* curve_params, u32 configuration);

/** <b>ECC SM2 DSA signature</b>.
 * Verify a SM2 P256 DSA signature, using the SM2 curve as defined in SM2 Digital Signature
Algorithm draft-shen-sm2-ecdsa-00, with SM3 hash function defined in draft-shen-sm3-hash-00
*
* @param[in] signature: pointer to a ucl_type_ecdsa_signature structure, containing the signature
(r,s) values
...
/** <b>ECC SM2 DSA signature</b>.
 * Verify a SM2 DSA signature, using the SM2 curve given as a parameter, with the SM3 hash function
defined in draft-shen-sm3-hash-00
*
* @param[in] signature: pointer to a ucl_type_ecdsa_signature structure, containing the signature
(r,s) values
* @param[in] public key: pointer to a ucl_type_ecc_u8_affine_point structure, containing the ECC
...
* @param[in] *entla: input, the ENTLA (entlenA bits) parameter
* @param[in] *curve_params: the pointer to a ucl_type_curve structure, containing the curve domain
parameters (already existing one, sm2fp256, is described in the documentation)
* @param[in] configuration (combination of any of these lines)
     - UCL_R_PRECOMP or UCL_PRECOMP_R:
     - UCL_R_PRECOMP: using precomputed r to finish the signature computation,
     - UCL_PRECOMP_R: to only pre-compute the r value,
 ...
 * encrypt data, using the SM2 public key encryption scheme, as defined in the draf-shen-ecdsa-01
section 7, using a KDF based on SM3 hash function as defined in draft-shen-sm3-hash-00
*
...
* @retval #UCL_INVALID_OUPUT if the output pointer parameters are NULL or if the cryptotext length
is too long
...
*
* @ingroup UCL_ECDSA */
int ucl_sm2_encryption_curve(
    u8* c, ucl_type_ecc_u8_affine_point A, u8* m, u32 klen, ucl_type_curve* curve_params);

/** <b>SM2 public key encryption</b>.
 * decrypt data, using the SM2 public key encryption scheme, as defined in the draf-shen-ecdsa-01
section 7, using a KDF based on SM3 hash function as defined in draft-shen-sm3-hash-00
*
...
* @retval #UCL_INVALID_INPUT in case of NULL input parameters pointers or if the cryptotext length
is too long
* @retval #UCL_STACK_ERROR in case of too small available stack space
*
* @ingroup UCL_ECDSA */
int ucl_sm2_decryption_curve(
    u8* m, u8* d, ucl_type_ecc_u8_affine_point A, u8* c, u32 klen, ucl_type_curve* curve_params);

/** <b>ECDSA signature</b>.
 * Compute a ECDSA signature
 *
* @param[out] *r_and_others: input/output, the r value for the computed signature (may have been
pre-computed, with UCL_R_PRECOMP configuration) if UCL_R_PRECOMP or UCL_PRECOMP_R are used, the
array is a double curve array as containing the r and the k-1.
...
* @param[in] configuration (combination of any of these lines)
     ...
     - UCL_R_PRECOMP: using precomputed r to finish the signature computation,
     - UCL_PRECOMP_R: to only pre-compute the r value,
     - SECP160R1 or SECP192R1  or SECP224R1 or  SECP256R1 or SECP384R1 or SECP521R1 or BP256R1 or
BP384R1 or BP512R1
     - UCL_MSG_INPUT or UCL_HASH_INPUT or UCL_NO_INPUT
     - UCL_MSG_INPUT: the message will be hashed first,
     - UCL_HASH_INPUT: the message is already the hash digest,
     - UCL_NO_INPUT: for r precomputation (UCL_PRECOMP_R)
     - UCL_SHA256 or UCL_SHA224 or UCL_SHA384 or UCL_SHA512 or UCL_SHA1: hash function, if
UCL_MSG_INPUT is used.
     - Examples are:
       - SECP192R1<<UCL_CURVE_SHIFT+UCL_HASH_INPUT<<UCL_INPUT_SHIFT: signing a hash digest on P192
curve, r not precomputed
       - SECP256R1<<UCL_CURVE_SHIFT+UCL_HASH_INPUT<<UCL_INPUT_SHIFT: signing a hash digest on P256
curve, r not precomputed
       - SECP256R1<<UCL_CURVE_SHIFT+UCL_PRECOMP_R<<UCL_PRECOMP_SHIFT+UCL_NO_INPUT<<UCL_INPUT_SHIFT:
pre-compute r on P-256.
       - UCL_R_PRECOMP<<UCL_PRECOMP_SHIFT+SECP192R1<<UCL_CURVE_SHIFT+
UCL_MSG_INPUT<<UCL_INPUT_SHIFT+ UCL_SHA256<<UCL_HASH_SHIFT:signing a message, to be hashed with
SHA-256, using pre-computed r
...
int ucl_ecdsa_r_precomp_sign_p160r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
int ucl_ecdsa_sign_p160r1_r_precomp(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r,
    u8* kminus1, u8* s, u8* a, u8* n, u8* p, u8* d, u8* m, u32 MsgLng);
...
int ucl_ecdsa_sign_p160r1_sha256(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a,
    u8* n, u8* p, u8* d, u8* m, u32 MsgLng);
void precomputation_p160_Q(
    DIGIT qx[40][8], DIGIT qy[40][8], DIGIT* x, DIGIT* y, DIGIT* p, unsigned int digits);
...
int ucl_ecdsa_sign_p192r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a, u8* n,
    u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_p192r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
int ucl_ecies_decrypt_p192r1_aes_hmac_sha256(u8* m, u32 keylength, u8* xG, u8* yG, u8* a, u8* n,
    u8* p, u8* d, u8* rx, u8* ry, u8* crypto, int crypto_len, u8* t);
int ucl_ecies_encrypt_p192r1_aes_hmac_sha256(u8* rx, u8* ry, u8* crypto, u8* t, u32 keylength,
    u8* xG, u8* yG, u8* xQ, u8* yQ, u8* a, u8* n, u8* p, u8* m, u32 MsgLng);
...
int ucl_ecdsa_sign_p192r1_sia256(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a,
    u8* n, u8* p, u8* d, u8* m, u32 MsgLng);
void precomputation_p192_Q(
    DIGIT qx[48][8], DIGIT qy[48][8], DIGIT* x, DIGIT* y, DIGIT* p, unsigned int digits);
...
int ucl_ecdsa_sign_p224r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a, u8* n,
    u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_p224r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
int ucl_ecdsa_sign_p224r1_sha224(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a,
    u8* n, u8* p, u8* d, u8* m, u32 MsgLng);
void precomputation_p224_Q(
    DIGIT qx[56][8], DIGIT qy[56][8], DIGIT* x, DIGIT* y, DIGIT* p, unsigned int digits);
...
int ucl_ecdsa_sign_p256r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a, u8* n,
    u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_p256r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
void precomputation_bp256_Q(
    DIGIT qx[64][8], DIGIT qy[64][8], DIGIT* x, DIGIT* y, DIGIT* p, DIGIT digits);
...
int ucl_ecdsa_sign_p384r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a, u8* n,
    u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_p384r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
int ucl_ecdsa_sign_p384r1_sha384(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a,
    u8* n, u8* p, u8* d, u8* m, u32 MsgLng);
void precomputation_p384_Q(
    DIGIT qx[96][8], DIGIT qy[96][8], DIGIT* x, DIGIT* y, DIGIT* p, unsigned int digits);
...
int ucl_ecdsa_sign_bp384r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a,
    u8* n, u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_bp384r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
int ucl_ecdsa_sign_p521r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a, u8* n,
    u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_p521r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
int ucl_ecdsa_sign_bp512r1(u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* s, u8* a,
    u8* n, u8* p, u8* d, u8* hash, u32 hashlength);
int ucl_ecdsa_r_precomp_sign_bp512r1(
    u32 keylength, u8* xG, u8* yG, u8* xQ, u8* yQ, u8* r, u8* kminus1, u8* a, u8* n, u8* p, u8* d);
...
UCL_MSG_INPUT is used.
     ...
     -	Examples are:
       -	SECP192R1<<UCL_CURVE_SHIFT+ UCL_MSG_INPUT<<UCL_INPUT_SHIFT+
UCL_SHA256<<UCL_HASH_INPUT:verifying a signed message, hashed with SHA-256, -
...
int ucl_ecdsa_verify_new(ucl_type_ecc_u8_affine_point Q, ucl_type_ecdsa_signature signature,
    int (*hash)(u8*, u8*, u32), u8* input, u32 inputlength, ucl_type_curve* curve_params,
    u32 configuration);
...
int __API__ ecc_modsub_new(
    DIGIT* p_result, DIGIT* p_left, DIGIT* p_right, ucl_type_curve* curve_params);
...
int ecc_mult_affine(DIGIT* xq, DIGIT* yq, DIGIT* m, DIGIT* a, DIGIT* x, DIGIT* y, DIGIT* p,
    unsigned digits, int curve);
int ecc_mult_affine_new(
    ucl_type_ecc_digit_affine_point Q, DIGIT* m, DIGIT* x, DIGIT* y, ucl_type_curve* curve_params);
...
int ecc_double_jacobian_new(
    ucl_type_ecc_jacobian_point Q3, ucl_type_ecc_jacobian_point Q1, ucl_type_curve* curve_params);
...
int ecc_convert_affine_to_jacobian(
    DIGIT* xq, DIGIT* yq, DIGIT* zq, DIGIT* x, DIGIT* y, int digits, int curve);
int ecc_convert_jacobian_to_affine_new(
    DIGIT* x, DIGIT* y, DIGIT* xq, DIGIT* yq, DIGIT* zq, ucl_type_curve* curve_params);
...
int ecc_convert_jacobian_to_affine(
    DIGIT* x, DIGIT* y, DIGIT* xq, DIGIT* yq, DIGIT* zq, DIGIT* p, int digits, int curve);
...
int ecc_mult_jacobian_new(ucl_type_ecc_digit_affine_point Q, DIGIT* m,
    ucl_type_ecc_digit_affine_point X1, ucl_type_curve* curve_params);
int ecc_equal_jacobian_new(
    ucl_type_ecc_jacobian_point Q1, ucl_type_ecc_jacobian_point Q2, ucl_type_curve* curve_params);
...
int ecc_mult_jacobian_window4_new(
    ucl_type_ecc_digit_affine_point Q, DIGIT* m, ucl_type_curve* curve_params);
 ...
 * @param[out] np: pointer to the real number of bits of p, i.e. the largest position with a bit set
 * to 1
 * @param[out] digits_tmp: pointer to the real number of words (DIGIT) of p, i.e. the largest
 * position with a word non null
 * @param[in] *curve_params: the pointer to a ucl_type_curve structure, containing the curve domain
 * parameters (already existing ones are described in the documentation)
 *
 * @ingroup UCL_ECC */
 ...
 * @param[in,out] KEXT: the pointer to the extended scalar array, with a bit equal to 1 appended
 * after the msb equal to 1
 ...
 * @param[int] digits_tmp: the real number of words (DIGIT) of p, i.e. the largest position with a
 * word non null
 * @param[in] *curve_params: the pointer to a ucl_type_curve structure, containing the curve domain
 * parameters (already existing ones are described in the documentation)
 *
 * @ingroup UCL_ECC */
void set_msbit_curve(
    DIGIT* KEXT, DIGIT* digits_ext, int np, int digits_tmp, ucl_type_curve* curve_params);
...
* @param[in] configuration (combination of any of these lines)
     ...
     - Examples are:
       - SM2FP256<<UCL_CURVE_SHIFT+UCL_HASH_INPUT<<UCL_INPUT_SHIFT: signing a hash digest on SM2
P256 curve, r not precomputed
       - SM2FP256<<UCL_CURVE_SHIFT+UCL_PRECOMP_R<<UCL_PRECOMP_SHIFT+UCL_NO_INPUT<<UCL_INPUT_SHIFT:
pre-compute r on SM2 P256.
       - UCL_R_PRECOMP<<UCL_PRECOMP_SHIFT+SM2FP256<<UCL_CURVE_SHIFT+ UCL_MSG_INPUT<<UCL_INPUT_SHIFT+
UCL_SM3<<UCL_HASH_SHIFT:signing a message, to be hashed with SM3, using pre-computed r
...
/** <b>SM2 DSA signature</b>.
 * compute a SM2 P256 DSA signature, for SM2 P256 only (as defined in SM2 Digital Signature
Algorithm draft-shen-sm2-ecdsa-00)
*
* @param[out] *r: output, the r value of the computed signature
* @param[out] *s: output, the s value of the computed signature
* @param[in] *d: input, the private key value
...
* @param[in] configuration (combination of any of these lines)
     ...
     - UCL_SM3: hash function, if UCL_MSG_INPUT is used.
     - Examples are:
       - SM2FP256<<UCL_CURVE_SHIFT+UCL_HASH_INPUT<<UCL_INPUT_SHIFT: signing a hash digest on a SM2
P256 curve, using the given curve parameters
       -
SM2VP256<<UCL_CURVE_SHIFT)^(UCL_MSG_INPUT<<UCL_INPUT_SHIFT)^(UCL_SM3<<UCL_HASH_SHIFT)^(UCL_NO_PRECOMP_TRICK<<UCL_PRECOMP_TRICK_SHIFT):
signing a message on a SM2 P256 curve, using the given curve parameters
* @param[in] *a: input, the a parameter of the curve
* @param[in] *b: input, the b parameter of the curve
* @param[in] *p: input, the p parameter of the curve
* @param[in] *xG: input, the x affine coordinate of the base point
...
/** <b>ECDSA signature</b>.
 * Verify a SM2 P256 DSA signature, directly from the message hash, using the SM2 curve as defined
in SM2 Digital Signature Algorithm draft-shen-sm2-ecdsa-00
*
* @param[in] *r: input, the r value of the signature to be verified
* @param[in] *s: input, the s value of the signature to be verified
* @param[in] *xA: input, the x affine coordinate of the public key
...
int ucl_sm2dsa_verify(u8* r, u8* s, u8* xA, u8* yA, u8* input, u32 inputlength, u8* ida, u8* entla,
    u32 configuration);
int ucl_sm2dsa_sign_sm2fp256_sm3(
    u8* r, u8* s, u8* d, u8* xQ, u8* yQ, u8* m, u32 MsgLng, u8* ida, u8* entla);
int ucl_sm2dsa_verify_sm2fp256_sm3(
    u8* r, u8* s, u8* xQ, u8* yQ, u8* m, u32 MsgLng, u8* ida, u8* entla);
