...
bash /home/$USER/Workspace/BLE-examples-test/Examples_tests/verify_local_testLauncher.sh | tee /home/$USER/Workspace/BLE-examples-test/Examples_tests/test.log
